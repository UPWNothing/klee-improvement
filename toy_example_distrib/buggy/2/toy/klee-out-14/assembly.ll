...
define internal fastcc void @consume_record(%struct.file_entry* %ent) #0 {
  ...
  br i1 %5, label %6, label %31, !dbg !2227
...
; <label>:6                                       ; preds = %0
  ...
  %25 = zext i32 %24 to i64, !dbg !2234
  %26 = getelementptr inbounds [12 x i8]* @.str1, i64 0, i64 %25, !dbg !2234
  %27 = getelementptr inbounds %struct.file_entry* %ent, i64 0, i32 2, i32 0, !dbg !2234
  %28 = load float* %27, align 1, !dbg !2234
  %29 = fpext float %28 to double, !dbg !2234
  %30 = tail call i32 (i8*, ...)* @printf(i8* %26, double %29) #11, !dbg !2234
  br label %42, !dbg !2235

; <label>:31                                      ; preds = %0
  %32 = load i32* %3, align 1, !dbg !2236
  %33 = icmp eq i32 %32, 2, !dbg !2236
  br i1 %33, label %34, label %39, !dbg !2236

; <label>:34                                      ; preds = %31
  %35 = getelementptr inbounds %struct.file_entry* %ent, i64 0, i32 2, !dbg !2238
  %36 = bitcast %union.anon* %35 to i32*, !dbg !2238
  %37 = load i32* %36, align 1, !dbg !2238
  %38 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i64 0, i64 0), i32 %37) #11, !dbg !2238
  br label %42

; <label>:39                                      ; preds = %31
  %40 = load i32* %3, align 1, !dbg !2240
  %41 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str3, i64 0, i64 0), i32 %40) #11, !dbg !2240
