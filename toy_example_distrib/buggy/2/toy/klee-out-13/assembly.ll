...
define internal fastcc void @parse_header(%struct._IO_FILE* nocapture %f, %struct.file_header* %hdr) #0 {
  %1 = bitcast %struct.file_header* %hdr to i8*, !dbg !2212
  %2 = bitcast %struct._IO_FILE* %f to %struct.__STDIO_FILE_STRUCT.195*, !dbg !2212
  %3 = tail call i64 @fread_unlocked(i8* %1, i64 16, i64 1, %struct.__STDIO_FILE_STRUCT.195* %2) #10, !dbg !2212
  %4 = icmp eq i64 %3, 1, !dbg !2212
  br i1 %4, label %6, label %5, !dbg !2212

; <label>:5                                       ; preds = %0
  tail call void @exit(i32 1) #6, !dbg !2214
  unreachable, !dbg !2214

; <label>:6                                       ; preds = %0
  %7 = getelementptr inbounds %struct.file_header* %hdr, i64 0, i32 0, !dbg !2215
  %8 = load i32* %7, align 1, !dbg !2215
  %9 = icmp eq i32 %8, 1279350337, !dbg !2215
  br i1 %9, label %11, label %10, !dbg !2215

; <label>:10                                      ; preds = %6
  tail call void @exit(i32 1) #6, !dbg !2217
...
define internal fastcc %struct.file_entry* @parse_record(%struct._IO_FILE* nocapture %f) #0 {
  %1 = tail call noalias i8* @malloc(i64 24) #10, !dbg !2219
  %2 = bitcast %struct._IO_FILE* %f to %struct.__STDIO_FILE_STRUCT.195*, !dbg !2220
  %3 = tail call i64 @fread_unlocked(i8* %1, i64 24, i64 1, %struct.__STDIO_FILE_STRUCT.195* %2) #10, !dbg !2220
  %4 = icmp eq i64 %3, 1, !dbg !2220
  br i1 %4, label %6, label %5, !dbg !2220

; <label>:5                                       ; preds = %0
  tail call void @exit(i32 1) #6, !dbg !2222
  unreachable, !dbg !2222

; <label>:6                                       ; preds = %0
  %7 = bitcast i8* %1 to %struct.file_entry*, !dbg !2219
  ret %struct.file_entry* %7, !dbg !2223
}
...
define internal fastcc void @consume_record(%struct.file_entry* %ent) #0 {
  %1 = getelementptr inbounds %struct.file_entry* %ent, i64 0, i32 0, i64 0, !dbg !2224
  %2 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([18 x i8]* @.str, i64 0, i64 0), i8* %1) #10, !dbg !2224
  %3 = getelementptr inbounds %struct.file_entry* %ent, i64 0, i32 1, !dbg !2225
  %4 = load i32* %3, align 1, !dbg !2225
  %5 = icmp eq i32 %4, 1, !dbg !2225
  br i1 %5, label %6, label %11, !dbg !2225

; <label>:6                                       ; preds = %0
  tail call void @klee_overshift_check(i64 32, i64 0) #10, !dbg !2227
  tail call void @klee_overshift_check(i64 32, i64 8) #10, !dbg !2227
  tail call void @klee_overshift_check(i64 32, i64 16) #10, !dbg !2227
  tail call void @klee_overshift_check(i64 32, i64 24) #10, !dbg !2227
  %7 = getelementptr inbounds %struct.file_entry* %ent, i64 0, i32 2, i32 0, !dbg !2232
  %8 = load float* %7, align 1, !dbg !2232
  %9 = fpext float %8 to double, !dbg !2232
  %10 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str1, i64 0, i64 0), double %9) #10, !dbg !2232
  br label %22, !dbg !2233

; <label>:11                                      ; preds = %0
  %12 = load i32* %3, align 1, !dbg !2234
  %13 = icmp eq i32 %12, 2, !dbg !2234
  br i1 %13, label %14, label %19, !dbg !2234

; <label>:14                                      ; preds = %11
  %15 = getelementptr inbounds %struct.file_entry* %ent, i64 0, i32 2, !dbg !2236
  %16 = bitcast %union.anon* %15 to i32*, !dbg !2236
  %17 = load i32* %16, align 1, !dbg !2236
  %18 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i64 0, i64 0), i32 %17) #10, !dbg !2236
  br label %22

; <label>:19                                      ; preds = %11
  %20 = load i32* %3, align 1, !dbg !2238
  %21 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str3, i64 0, i64 0), i32 %20) #10, !dbg !2238
  tail call void @exit(i32 1) #6, !dbg !2240
  unreachable, !dbg !2240

; <label>:22                                      ; preds = %14, %6
  tail call void @free(i8* %1) #10, !dbg !2241
  ret void, !dbg !2242
}
...
define internal fastcc i32 @__user_main(i32 %argc, i8** %argv) #0 {
  ...
  %1 = getelementptr inbounds i8** %newArgv, i64 1, !dbg !2243
  %2 = load i8** %1, align 8, !dbg !2243
  %3 = call fastcc %struct.__STDIO_FILE_STRUCT.195* @fopen(i8* %2) #10, !dbg !2243
  %4 = bitcast %struct.__STDIO_FILE_STRUCT.195* %3 to %struct._IO_FILE*, !dbg !2243
  call fastcc void @parse_header(%struct._IO_FILE* %4, %struct.file_header* %head), !dbg !2244
  %5 = getelementptr inbounds %struct.file_header* %head, i64 0, i32 4, !dbg !2245
  %6 = load i32* %5, align 1, !dbg !2245
  %7 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([20 x i8]* @.str5, i64 0, i64 0), i32 %6) #10, !dbg !2245
  %8 = getelementptr inbounds %struct.file_header* %head, i64 0, i32 2, !dbg !2246
  %9 = load i16* %8, align 1, !dbg !2246
  %10 = icmp eq i16 %9, 0, !dbg !2246
  br i1 %10, label %._crit_edge, label %.lr.ph, !dbg !2246

.lr.ph:                                           ; preds = %0, %.lr.ph
  %i.01 = phi i32 [ %12, %.lr.ph ], [ 0, %0 ]
  %11 = call fastcc %struct.file_entry* @parse_record(%struct._IO_FILE* %4), !dbg !2248
  call fastcc void @consume_record(%struct.file_entry* %11), !dbg !2250
  %12 = add i32 %i.01, 1, !dbg !2246
  %13 = load i16* %8, align 1, !dbg !2246
  %14 = zext i16 %13 to i32, !dbg !2246
  %15 = icmp ult i32 %12, %14, !dbg !2246
  br i1 %15, label %.lr.ph, label %._crit_edge, !dbg !2246
...
define internal fastcc %struct.__STDIO_FILE_STRUCT.195* @fopen(i8* noalias %filename) #0 {
  %1 = ptrtoint i8* %filename to i64, !dbg !2252
  %2 = tail call fastcc %struct.__STDIO_FILE_STRUCT.195* @_stdio_fopen(i64 %1) #15, !dbg !2252
  ret %struct.__STDIO_FILE_STRUCT.195* %2, !dbg !2252
}

; Function Attrs: nounwind uwtable
define internal hidden fastcc %struct.__STDIO_FILE_STRUCT.195* @_stdio_fopen(i64 %fname_or_mode) #0 {
  %1 = tail call noalias i8* @malloc(i64 80) #16, !dbg !2253
  %2 = bitcast i8* %1 to %struct.__STDIO_FILE_STRUCT.195*, !dbg !2253
  %3 = icmp eq i8* %1, null, !dbg !2253
  br i1 %3, label %63, label %7, !dbg !2253

; <label>:4                                       ; preds = %7
  %5 = icmp eq i16 %18, 0, !dbg !2257
  br i1 %5, label %63, label %6, !dbg !2257

; <label>:6                                       ; preds = %4
  tail call void @free(i8* %1) #16, !dbg !2257
  br label %63, !dbg !2257

; <label>:7                                       ; preds = %0
  %8 = bitcast i8* %1 to i16*, !dbg !2268
  store i16 8192, i16* %8, align 2, !dbg !2268
  %9 = getelementptr inbounds i8* %1, i64 8, !dbg !2269
  %10 = bitcast i8* %9 to i8**, !dbg !2269
  store i8* null, i8** %10, align 8, !dbg !2269
  %11 = inttoptr i64 %fname_or_mode to i8*, !dbg !2270
  %12 = tail call i32 (i8*, i32, ...)* @open(i8* %11, i32 0, i32 438) #15, !dbg !2270
  %13 = getelementptr inbounds i8* %1, i64 4, !dbg !2270
  %14 = bitcast i8* %13 to i32*, !dbg !2270
  store i32 %12, i32* %14, align 4, !dbg !2270
  %15 = icmp slt i32 %12, 0, !dbg !2270
  %16 = bitcast i8* %1 to i16*, !dbg !2257
  %17 = load i16* %16, align 2, !dbg !2257
  %18 = and i16 %17, 8192, !dbg !2257
  br i1 %15, label %4, label %19, !dbg !2270

; <label>:19                                      ; preds = %7
  %20 = or i16 %18, 32, !dbg !2274
  store i16 %20, i16* %16, align 2, !dbg !2274
  %21 = load i32* @errno, align 4, !dbg !2275
  %22 = load i32* %14, align 4, !dbg !2276
  %23 = tail call fastcc i32 @isatty(i32 %22) #16, !dbg !2276
  %24 = shl i32 %23, 8, !dbg !2276
  %25 = load i16* %16, align 2, !dbg !2276
  %26 = zext i16 %25 to i32, !dbg !2276
  %27 = or i32 %26, %24, !dbg !2276
  %28 = trunc i32 %27 to i16, !dbg !2276
  store i16 %28, i16* %16, align 2, !dbg !2276
  store i32 %21, i32* @errno, align 4, !dbg !2277
  %29 = getelementptr inbounds i8* %1, i64 8, !dbg !2278
  %30 = bitcast i8* %29 to i8**, !dbg !2278
  %31 = load i8** %30, align 8, !dbg !2278
  %32 = icmp eq i8* %31, null, !dbg !2278
  br i1 %32, label %33, label %45, !dbg !2278

; <label>:33                                      ; preds = %19
  %34 = tail call noalias i8* @malloc(i64 4096) #16, !dbg !2280
  store i8* %34, i8** %30, align 8, !dbg !2280
  %35 = icmp eq i8* %34, null, !dbg !2280
  br i1 %35, label %42, label %36, !dbg !2280

; <label>:36                                      ; preds = %33
  %37 = getelementptr inbounds i8* %34, i64 4096, !dbg !2283
  %38 = getelementptr inbounds i8* %1, i64 16, !dbg !2283
  %39 = bitcast i8* %38 to i8**, !dbg !2283
  store i8* %37, i8** %39, align 8, !dbg !2283
  %40 = load i16* %16, align 2, !dbg !2285
  %41 = or i16 %40, 16384, !dbg !2285
  store i16 %41, i16* %16, align 2, !dbg !2285
  br label %45, !dbg !2286

; <label>:42                                      ; preds = %33
  %43 = getelementptr inbounds i8* %1, i64 16, !dbg !2287
  %44 = bitcast i8* %43 to i8**, !dbg !2287
  store i8* null, i8** %44, align 8, !dbg !2287
  br label %45

; <label>:45                                      ; preds = %19, %36, %42
  %46 = load i8** %30, align 8, !dbg !2289
  %47 = getelementptr inbounds i8* %1, i64 40, !dbg !2289
  %48 = bitcast i8* %47 to i8**, !dbg !2289
  store i8* %46, i8** %48, align 8, !dbg !2289
  %49 = load i8** %30, align 8, !dbg !2290
  %50 = getelementptr inbounds i8* %1, i64 48, !dbg !2290
  %51 = bitcast i8* %50 to i8**, !dbg !2290
  store i8* %49, i8** %51, align 8, !dbg !2290
  %52 = load i8** %30, align 8, !dbg !2291
  %53 = getelementptr inbounds i8* %1, i64 24, !dbg !2291
  %54 = bitcast i8* %53 to i8**, !dbg !2291
  store i8* %52, i8** %54, align 8, !dbg !2291
  %55 = getelementptr inbounds i8* %1, i64 32, !dbg !2291
  %56 = bitcast i8* %55 to i8**, !dbg !2291
  store i8* %52, i8** %56, align 8, !dbg !2291
  %57 = getelementptr inbounds i8* %1, i64 2, !dbg !2292
  store i8 0, i8* %57, align 1, !dbg !2292
  %58 = getelementptr inbounds i8* %1, i64 72, !dbg !2293
  %59 = bitcast i8* %58 to i32*, !dbg !2293
  store i32 0, i32* %59, align 4, !dbg !2293
  %60 = load %struct.__STDIO_FILE_STRUCT.195** @_stdio_openlist, align 8, !dbg !2294
  %61 = getelementptr inbounds i8* %1, i64 56, !dbg !2294
  %62 = bitcast i8* %61 to %struct.__STDIO_FILE_STRUCT.195**, !dbg !2294
  store %struct.__STDIO_FILE_STRUCT.195* %60, %struct.__STDIO_FILE_STRUCT.195** %62, align 8, !dbg !2294
  store %struct.__STDIO_FILE_STRUCT.195* %2, %struct.__STDIO_FILE_STRUCT.195** @_stdio_openlist, align 8, !dbg !2296
  br label %63, !dbg !2297

; <label>:63                                      ; preds = %0, %6, %4, %45
  %.0 = phi %struct.__STDIO_FILE_STRUCT.195* [ %2, %45 ], [ null, %4 ], [ null, %6 ], [ %2, %0 ]
  ret %struct.__STDIO_FILE_STRUCT.195* %.0, !dbg !2298
}

; Function Attrs: nounwind uwtable
define internal hidden fastcc void @_stdio_init() #0 {
  %1 = load i32* @errno, align 4, !dbg !2299
  %2 = tail call fastcc i32 @isatty(i32 0) #16, !dbg !2300
  %3 = sub nsw i32 1, %2, !dbg !2300
  %4 = shl i32 %3, 8, !dbg !2300
  %5 = load i16* getelementptr inbounds ([3 x %struct.__STDIO_FILE_STRUCT.195]* @_stdio_streams, i64 0, i64 0, i32 0), align 16, !dbg !2300
  %6 = zext i16 %5 to i32, !dbg !2300
  %7 = xor i32 %6, %4, !dbg !2300
  %8 = trunc i32 %7 to i16, !dbg !2300
  store i16 %8, i16* getelementptr inbounds ([3 x %struct.__STDIO_FILE_STRUCT.195]* @_stdio_streams, i64 0, i64 0, i32 0), align 16, !dbg !2300
  %9 = tail call fastcc i32 @isatty(i32 1) #16, !dbg !2301
  %10 = sub nsw i32 1, %9, !dbg !2301
  %11 = shl i32 %10, 8, !dbg !2301
  %12 = load i16* getelementptr inbounds ([3 x %struct.__STDIO_FILE_STRUCT.195]* @_stdio_streams, i64 0, i64 1, i32 0), align 16, !dbg !2301
  %13 = zext i16 %12 to i32, !dbg !2301
  %14 = xor i32 %13, %11, !dbg !2301
  %15 = trunc i32 %14 to i16, !dbg !2301
  store i16 %15, i16* getelementptr inbounds ([3 x %struct.__STDIO_FILE_STRUCT.195]* @_stdio_streams, i64 0, i64 1, i32 0), align 16, !dbg !2301
  store i32 %1, i32* @errno, align 4, !dbg !2302
  ret void, !dbg !2303
}

; Function Attrs: nounwind uwtable
define internal hidden fastcc i64 @__stdio_wcommit(%struct.__STDIO_FILE_STRUCT.195* noalias nocapture %stream) #0 {
  %1 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 5, !dbg !2304
  %2 = load i8** %1, align 8, !dbg !2304
  %3 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 3, !dbg !2304
  %4 = load i8** %3, align 8, !dbg !2304
  %5 = icmp eq i8* %2, %4, !dbg !2304
  br i1 %5, label %13, label %6, !dbg !2304

; <label>:6                                       ; preds = %0
  %7 = ptrtoint i8* %2 to i64, !dbg !2304
  %8 = ptrtoint i8* %4 to i64, !dbg !2304
  %9 = sub i64 %7, %8, !dbg !2304
  %10 = load i8** %3, align 8, !dbg !2306
  store i8* %10, i8** %1, align 8, !dbg !2306
  %11 = load i8** %3, align 8, !dbg !2308
  %12 = tail call fastcc i64 @__stdio_WRITE(%struct.__STDIO_FILE_STRUCT.195* %stream, i8* %11, i64 %9) #15, !dbg !2308
  br label %13, !dbg !2309

; <label>:13                                      ; preds = %0, %6
  %14 = load i8** %1, align 8, !dbg !2310
  %15 = load i8** %3, align 8, !dbg !2310
  %16 = ptrtoint i8* %14 to i64, !dbg !2310
  %17 = ptrtoint i8* %15 to i64, !dbg !2310
  %18 = sub i64 %16, %17, !dbg !2310
  ret i64 %18, !dbg !2310
}
...
define internal i64 @fread_unlocked(i8* noalias %ptr, i64 %size, i64 %nmemb, %struct.__STDIO_FILE_STRUCT.195* noalias nocapture %stream) #0 {
  %1 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 0, !dbg !2311
  %2 = load i16* %1, align 2, !dbg !2311
  %3 = zext i16 %2 to i32, !dbg !2311
  %4 = and i32 %3, 131, !dbg !2311
  %5 = icmp ugt i32 %4, 128, !dbg !2311
  br i1 %5, label %11, label %6, !dbg !2311

; <label>:6                                       ; preds = %0
  %7 = tail call fastcc i32 @__stdio_trans2r_o(%struct.__STDIO_FILE_STRUCT.195* %stream) #15, !dbg !2313
  %8 = icmp eq i32 %7, 0, !dbg !2313
  %9 = icmp ne i64 %size, 0, !dbg !2313
  %or.cond = and i1 %8, %9, !dbg !2313
  %10 = icmp ne i64 %nmemb, 0, !dbg !2313
  %or.cond5 = and i1 %or.cond, %10, !dbg !2313
  br i1 %or.cond5, label %12, label %67, !dbg !2313

; <label>:11                                      ; preds = %0
  %.old2 = icmp ne i64 %size, 0, !dbg !2313
  %.old4 = icmp ne i64 %nmemb, 0, !dbg !2313
  %or.cond7 = and i1 %.old2, %.old4, !dbg !2313
  br i1 %or.cond7, label %12, label %67, !dbg !2313

; <label>:12                                      ; preds = %11, %6
  tail call void @klee_div_zero_check(i64 %size) #10, !dbg !2314
  %13 = udiv i64 -1, %size, !dbg !2314
  %14 = icmp ult i64 %13, %nmemb, !dbg !2314
  br i1 %14, label %64, label %15, !dbg !2314

; <label>:15                                      ; preds = %12
  %16 = mul i64 %nmemb, %size, !dbg !2317
  %17 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 10, i64 1, !dbg !2319
  br label %18, !dbg !2321

; <label>:18                                      ; preds = %22, %15
  %buffer.0 = phi i8* [ %ptr, %15 ], [ %30, %22 ]
  %todo.0 = phi i64 [ %16, %15 ], [ %31, %22 ]
  %19 = load i16* %1, align 2, !dbg !2321
  %20 = and i16 %19, 2, !dbg !2321
  %21 = icmp eq i16 %20, 0, !dbg !2321
  br i1 %21, label %33, label %22, !dbg !2321

; <label>:22                                      ; preds = %18
  %23 = load i16* %1, align 2, !dbg !2322
  %24 = add i16 %23, -1, !dbg !2322
  store i16 %24, i16* %1, align 2, !dbg !2322
  %25 = zext i16 %23 to i64, !dbg !2322
  %26 = and i64 %25, 1, !dbg !2322
  %27 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 10, i64 %26, !dbg !2322
  %28 = load i32* %27, align 4, !dbg !2322
  %29 = trunc i32 %28 to i8, !dbg !2322
  %30 = getelementptr inbounds i8* %buffer.0, i64 1, !dbg !2322
  store i8 %29, i8* %buffer.0, align 1, !dbg !2322
  store i32 0, i32* %17, align 4, !dbg !2319
  %31 = add i64 %todo.0, -1, !dbg !2323
  %32 = icmp eq i64 %31, 0, !dbg !2323
  br i1 %32, label %.loopexit, label %18, !dbg !2323

; <label>:33                                      ; preds = %18
  %34 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 6, !dbg !2325
  %35 = load i8** %34, align 8, !dbg !2325
  %36 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 5, !dbg !2325
  %37 = load i8** %36, align 8, !dbg !2325
  %38 = ptrtoint i8* %35 to i64, !dbg !2325
  %39 = ptrtoint i8* %37 to i64, !dbg !2325
  %40 = sub i64 %38, %39, !dbg !2325
  %41 = icmp eq i8* %35, %37, !dbg !2325
  br i1 %41, label %50, label %42, !dbg !2325

; <label>:42                                      ; preds = %33
  %43 = icmp ugt i64 %40, %todo.0, !dbg !2327
  %todo.0. = select i1 %43, i64 %todo.0, i64 %40, !dbg !2327
  %44 = load i8** %36, align 8, !dbg !2330
  tail call fastcc void @memcpy156(i8* %buffer.0, i8* %44, i64 %todo.0.) #16, !dbg !2330
  %45 = getelementptr inbounds i8* %buffer.0, i64 %todo.0., !dbg !2331
  %46 = load i8** %36, align 8, !dbg !2332
  %47 = getelementptr inbounds i8* %46, i64 %todo.0., !dbg !2332
  store i8* %47, i8** %36, align 8, !dbg !2332
  %48 = sub i64 %todo.0, %todo.0., !dbg !2333
  %49 = icmp eq i64 %todo.0, %todo.0., !dbg !2333
  br i1 %49, label %.loopexit, label %50, !dbg !2333

; <label>:50                                      ; preds = %42, %33
  %buffer.1 = phi i8* [ %45, %42 ], [ %buffer.0, %33 ]
  %todo.1 = phi i64 [ %48, %42 ], [ %todo.0, %33 ]
  %51 = load i16* %1, align 2, !dbg !2335
  %52 = and i16 %51, 768, !dbg !2335
  %53 = icmp eq i16 %52, 0, !dbg !2335
  br i1 %53, label %.preheader, label %54, !dbg !2335

; <label>:54                                      ; preds = %50
  %55 = tail call i32 @fflush_unlocked(%struct.__STDIO_FILE_STRUCT.195* bitcast (%struct.__STDIO_FILE_STRUCT.195** @_stdio_openlist to %struct.__STDIO_FILE_STRUCT.195*)) #15, !dbg !2337
...
.preheader:                                       ; preds = %50, %54, %58
  ...
  %56 = tail call fastcc i64 @__stdio_READ(%struct.__STDIO_FILE_STRUCT.195* %stream, i8* %buffer.2, i64 %todo.2) #15, !dbg !2340
  %57 = icmp eq i64 %56, 0, !dbg !2340
  br i1 %57, label %.loopexit, label %58, !dbg !2340

; <label>:58                                      ; preds = %.preheader
  %59 = getelementptr inbounds i8* %buffer.2, i64 %56, !dbg !2341
  %60 = sub i64 %todo.2, %56, !dbg !2343
  %61 = icmp eq i64 %todo.2, %56, !dbg !2343
  br i1 %61, label %.loopexit, label %.preheader, !dbg !2343

.loopexit:                                        ; preds = %22, %58, %.preheader, %42
  %todo.3 = phi i64 [ %48, %42 ], [ %60, %58 ], [ %todo.2, %.preheader ], [ 0, %22 ]
  %62 = sub i64 %16, %todo.3, !dbg !2345
  tail call void @klee_div_zero_check(i64 %size) #10, !dbg !2345
  %63 = udiv i64 %62, %size, !dbg !2345
  br label %67, !dbg !2345

; <label>:64                                      ; preds = %12
  %65 = load i16* %1, align 2, !dbg !2346
  %66 = or i16 %65, 8, !dbg !2346
  store i16 %66, i16* %1, align 2, !dbg !2346
  store i32 22, i32* @errno, align 4, !dbg !2347
  br label %67, !dbg !2348
...
define internal fastcc void @memcpy156(i8* noalias nocapture %s1, i8* noalias nocapture readonly %s2, i64 %n) #0 {
  %1 = icmp eq i64 %n, 0, !dbg !2350
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !2350

.lr.ph:                                           ; preds = %0, %.lr.ph
  %r2.03 = phi i8* [ %2, %.lr.ph ], [ %s2, %0 ]
  %r1.02 = phi i8* [ %4, %.lr.ph ], [ %s1, %0 ]
  %.01 = phi i64 [ %5, %.lr.ph ], [ %n, %0 ]
  %2 = getelementptr inbounds i8* %r2.03, i64 1, !dbg !2351
  %3 = load i8* %r2.03, align 1, !dbg !2351
  %4 = getelementptr inbounds i8* %r1.02, i64 1, !dbg !2351
  store i8 %3, i8* %r1.02, align 1, !dbg !2351
  %5 = add i64 %.01, -1, !dbg !2353
  %6 = icmp eq i64 %5, 0, !dbg !2350
  br i1 %6, label %._crit_edge, label %.lr.ph, !dbg !2350
...
define internal fastcc i32 @isatty(i32 %fd) #0 {
  ...
  %1 = call fastcc i32 @tcgetattr(i32 %fd, %struct.termios.443* %term) #16, !dbg !2354
  %2 = icmp eq i32 %1, 0, !dbg !2354
  %3 = zext i1 %2 to i32, !dbg !2354
  ret i32 %3, !dbg !2354
}
...
define internal fastcc i32 @tcgetattr(i32 %fd, %struct.termios.443* %termios_p) #0 {
  ...
  %1 = call i32 (i32, i64, ...)* @ioctl(i32 %fd, i64 undef, %struct.__kernel_termios* %k_termios) #16, !dbg !2355
  %2 = getelementptr inbounds %struct.__kernel_termios* %k_termios, i64 0, i32 0, !dbg !2356
  %3 = load i32* %2, align 4, !dbg !2356
  %4 = getelementptr inbounds %struct.termios.443* %termios_p, i64 0, i32 0, !dbg !2356
  store i32 %3, i32* %4, align 4, !dbg !2356
  %5 = getelementptr inbounds %struct.__kernel_termios* %k_termios, i64 0, i32 1, !dbg !2357
  %6 = load i32* %5, align 4, !dbg !2357
  %7 = getelementptr inbounds %struct.termios.443* %termios_p, i64 0, i32 1, !dbg !2357
  store i32 %6, i32* %7, align 4, !dbg !2357
  %8 = getelementptr inbounds %struct.__kernel_termios* %k_termios, i64 0, i32 2, !dbg !2358
  %9 = load i32* %8, align 4, !dbg !2358
  %10 = getelementptr inbounds %struct.termios.443* %termios_p, i64 0, i32 2, !dbg !2358
  store i32 %9, i32* %10, align 4, !dbg !2358
  %11 = getelementptr inbounds %struct.__kernel_termios* %k_termios, i64 0, i32 3, !dbg !2359
  %12 = load i32* %11, align 4, !dbg !2359
  %13 = getelementptr inbounds %struct.termios.443* %termios_p, i64 0, i32 3, !dbg !2359
  store i32 %12, i32* %13, align 4, !dbg !2359
  %14 = getelementptr inbounds %struct.__kernel_termios* %k_termios, i64 0, i32 4, !dbg !2360
  %15 = load i8* %14, align 4, !dbg !2360
  %16 = getelementptr inbounds %struct.termios.443* %termios_p, i64 0, i32 4, !dbg !2360
  store i8 %15, i8* %16, align 1, !dbg !2360
  %17 = getelementptr inbounds %struct.termios.443* %termios_p, i64 0, i32 5, i64 0, !dbg !2361
  %18 = getelementptr inbounds %struct.__kernel_termios* %k_termios, i64 0, i32 5, i64 0, !dbg !2361
  %19 = call fastcc i8* @mempcpy158(i8* %17, i8* %18) #16, !dbg !2361
  call fastcc void @memset160(i8* %19, i64 13) #16, !dbg !2361
  ret i32 %1, !dbg !2364
}

; Function Attrs: nounwind uwtable
define internal fastcc void @__uClibc_init() #0 {
  %1 = load i32* @__uClibc_init.been_there_done_that, align 4, !dbg !2365
  %2 = icmp eq i32 %1, 0, !dbg !2365
  br i1 %2, label %3, label %8, !dbg !2365

; <label>:3                                       ; preds = %0
  %4 = load i32* @__uClibc_init.been_there_done_that, align 4, !dbg !2367
  %5 = add nsw i32 %4, 1, !dbg !2367
  store i32 %5, i32* @__uClibc_init.been_there_done_that, align 4, !dbg !2367
  %6 = icmp eq i64 1, 0, !dbg !2368
  br i1 %6, label %8, label %7, !dbg !2368

; <label>:7                                       ; preds = %3
  tail call fastcc void @_stdio_init() #15, !dbg !2370
  br label %8, !dbg !2370
...
define internal fastcc void @__uClibc_main(i32 %argc, i8** %argv) #4 {
  %auxvt = alloca [15 x %struct.Elf64_auxv_t], align 16
  %1 = add nsw i32 %argc, 1, !dbg !2372
  %2 = sext i32 %1 to i64, !dbg !2372
  %3 = getelementptr inbounds i8** %argv, i64 %2, !dbg !2372
  store i8** %3, i8*** @__environ, align 8, !dbg !2372
  %4 = bitcast i8** %3 to i8*, !dbg !2373
  %5 = load i8** %argv, align 8, !dbg !2373
  %6 = icmp eq i8* %4, %5, !dbg !2373
  br i1 %6, label %7, label %10, !dbg !2373

; <label>:7                                       ; preds = %0
  %8 = sext i32 %argc to i64, !dbg !2375
  %9 = getelementptr inbounds i8** %argv, i64 %8, !dbg !2375
  store i8** %9, i8*** @__environ, align 8, !dbg !2375
  br label %10, !dbg !2377

; <label>:10                                      ; preds = %7, %0
  %11 = phi i8** [ %9, %7 ], [ %3, %0 ]
  %12 = bitcast [15 x %struct.Elf64_auxv_t]* %auxvt to i8*, !dbg !2378
  call fastcc void @memset160(i8* %12, i64 240) #16, !dbg !2378
  %13 = bitcast i8** %11 to i64*, !dbg !2379
  br label %14, !dbg !2380

; <label>:14                                      ; preds = %14, %10
  %aux_dat.0 = phi i64* [ %13, %10 ], [ %17, %14 ]
  %15 = load i64* %aux_dat.0, align 8, !dbg !2380
  %16 = icmp eq i64 %15, 0, !dbg !2380
  %17 = getelementptr inbounds i64* %aux_dat.0, i64 1, !dbg !2381
  br i1 %16, label %.preheader, label %14, !dbg !2380

.preheader:                                       ; preds = %14
  %18 = load i64* %17, align 8, !dbg !2383
  %19 = icmp eq i64 %18, 0, !dbg !2383
  br i1 %19, label %._crit_edge, label %.lr.ph, !dbg !2383

.lr.ph:                                           ; preds = %.preheader, %27
  %aux_dat.11 = phi i64* [ %28, %27 ], [ %17, %.preheader ]
  %20 = load i64* %aux_dat.11, align 8, !dbg !2384
  %21 = icmp ult i64 %20, 15, !dbg !2384
  br i1 %21, label %22, label %27, !dbg !2384

; <label>:22                                      ; preds = %.lr.ph
  %23 = load i64* %aux_dat.11, align 8, !dbg !2387
  %24 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt, i64 0, i64 %23, !dbg !2387
  %25 = bitcast %struct.Elf64_auxv_t* %24 to i8*, !dbg !2387
  %26 = bitcast i64* %aux_dat.11 to i8*, !dbg !2387
  call fastcc void @memcpy156(i8* %25, i8* %26, i64 16) #16, !dbg !2387
  br label %27, !dbg !2389

; <label>:27                                      ; preds = %22, %.lr.ph
  %28 = getelementptr inbounds i64* %aux_dat.11, i64 2, !dbg !2390
  %29 = load i64* %28, align 8, !dbg !2383
  %30 = icmp eq i64 %29, 0, !dbg !2383
  br i1 %30, label %._crit_edge, label %.lr.ph, !dbg !2383

._crit_edge:                                      ; preds = %27, %.preheader
  call fastcc void @__uClibc_init() #15, !dbg !2391
  %31 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt, i64 0, i64 11, i32 1, i32 0, !dbg !2392
  %32 = load i64* %31, align 8, !dbg !2392
  %33 = icmp eq i64 %32, -1, !dbg !2392
  br i1 %33, label %34, label %.thread, !dbg !2392

; <label>:34                                      ; preds = %._crit_edge
  %35 = call fastcc i32 @__check_suid() #15, !dbg !2392
  %36 = icmp eq i32 %35, 0, !dbg !2392
  br i1 %36, label %37, label %49, !dbg !2392

; <label>:37                                      ; preds = %34
  %.pr = load i64* %31, align 8, !dbg !2392
  %38 = icmp eq i64 %.pr, -1, !dbg !2392
  br i1 %38, label %50, label %.thread, !dbg !2392

.thread:                                          ; preds = %._crit_edge, %37
  %39 = load i64* %31, align 8, !dbg !2392
  %40 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt, i64 0, i64 12, i32 1, i32 0, !dbg !2392
  %41 = load i64* %40, align 8, !dbg !2392
  %42 = icmp eq i64 %39, %41, !dbg !2392
  br i1 %42, label %43, label %49, !dbg !2392

; <label>:43                                      ; preds = %.thread
  %44 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt, i64 0, i64 13, i32 1, i32 0, !dbg !2392
  %45 = load i64* %44, align 8, !dbg !2392
  %46 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt, i64 0, i64 14, i32 1, i32 0, !dbg !2392
  %47 = load i64* %46, align 8, !dbg !2392
  %48 = icmp eq i64 %45, %47, !dbg !2392
  br i1 %48, label %50, label %49, !dbg !2392

; <label>:49                                      ; preds = %34, %43, %.thread
  call fastcc void @__check_one_fd(i32 0, i32 131072) #15, !dbg !2394
  call fastcc void @__check_one_fd(i32 1, i32 131074) #15, !dbg !2396
  call fastcc void @__check_one_fd(i32 2, i32 131074) #15, !dbg !2397
  br label %50, !dbg !2398

; <label>:50                                      ; preds = %49, %37, %43
  %51 = load i8** %argv, align 8, !dbg !2399
  store i8* %51, i8** @__uclibc_progname, align 8, !dbg !2399
  %52 = icmp eq i64 1, 0, !dbg !2400
  br i1 %52, label %54, label %53, !dbg !2400

; <label>:53                                      ; preds = %50
  store i32 0, i32* @errno, align 4, !dbg !2402
  br label %54, !dbg !2402

; <label>:54                                      ; preds = %50, %53
  %55 = call fastcc i32 @__user_main(i32 %argc, i8** %argv) #16, !dbg !2403
  call void @exit(i32 %55) #17, !dbg !2403
...
define internal fastcc i32 @__check_suid() #0 {
  %1 = tail call i32 @getuid() #16, !dbg !2404
  %2 = tail call i32 @geteuid() #16, !dbg !2406
  %3 = tail call i32 @getgid() #16, !dbg !2407
  %4 = tail call i32 @getegid() #16, !dbg !2408
  %5 = icmp eq i32 %1, %2, !dbg !2409
  %6 = icmp eq i32 %3, %4, !dbg !2409
  %or.cond = and i1 %5, %6, !dbg !2409
  %7 = zext i1 %or.cond to i32, !dbg !2409
  %.0 = xor i32 %7, 1, !dbg !2409
  ret i32 %.0, !dbg !2411
}
...
define internal fastcc void @__check_one_fd(i32 %fd, i32 %mode) #0 {
  ...
  %1 = tail call fastcc i32 @fcntl(i32 %fd) #15, !dbg !2412
  %2 = icmp eq i32 %1, -1, !dbg !2412
  br i1 %2, label %3, label %5, !dbg !2412

; <label>:3                                       ; preds = %0
  %4 = load i32* @errno, align 4, !dbg !2412
...
; <label>:9                                       ; preds = %5
  %10 = tail call i32 (i8*, i32, ...)* @open(i8* getelementptr inbounds ([10 x i8]* @.str134, i64 0, i64 0), i32 %mode) #15, !dbg !2414
  %11 = icmp eq i32 %10, %fd, !dbg !2416
  br i1 %11, label %12, label %25, !dbg !2416

; <label>:12                                      ; preds = %9
  %13 = bitcast %struct.stat.645* %st to %struct.stat.657*, !dbg !2416
  %14 = call fastcc i32 @fstat(i32 %fd, %struct.stat.657* %13) #16, !dbg !2416
  %15 = icmp eq i32 %14, 0, !dbg !2416
  br i1 %15, label %16, label %25, !dbg !2416

; <label>:16                                      ; preds = %12
  %17 = getelementptr inbounds %struct.stat.645* %st, i64 0, i32 3, !dbg !2416
  %18 = load i32* %17, align 8, !dbg !2416
  %19 = and i32 %18, 61440, !dbg !2416
  %20 = icmp eq i32 %19, 8192, !dbg !2416
  br i1 %20, label %21, label %25, !dbg !2416

; <label>:21                                      ; preds = %16
  %22 = getelementptr inbounds %struct.stat.645* %st, i64 0, i32 7, !dbg !2416
  %23 = load i64* %22, align 8, !dbg !2416
  tail call fastcc void @gnu_dev_makedev() #16, !dbg !2418
  %24 = icmp eq i64 %23, 259, !dbg !2418
  br i1 %24, label %26, label %25, !dbg !2418

; <label>:25                                      ; preds = %21, %12, %9, %16
  tail call void @abort() #17, !dbg !2419
...
define internal fastcc void @gnu_dev_makedev() #5 {
  tail call void @klee_overshift_check(i64 32, i64 8) #10, !dbg !2422
  tail call void @klee_overshift_check(i64 64, i64 12) #10, !dbg !2422
  tail call void @klee_overshift_check(i64 64, i64 32) #10, !dbg !2422
  ret void
}

; Function Attrs: nounwind uwtable
define internal hidden fastcc i64 @__stdio_READ(%struct.__STDIO_FILE_STRUCT.195* nocapture %stream, i8* %buf, i64 %bufsize) #0 {
  %1 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 0, !dbg !2424
  %2 = load i16* %1, align 2, !dbg !2424
  %3 = and i16 %2, 4, !dbg !2424
  %4 = icmp eq i16 %3, 0, !dbg !2424
  br i1 %4, label %5, label %18, !dbg !2424

; <label>:5                                       ; preds = %0
  %6 = icmp slt i64 %bufsize, 0, !dbg !2426
  %.bufsize = select i1 %6, i64 9223372036854775807, i64 %bufsize, !dbg !2426
  %7 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 2, !dbg !2429
  %8 = load i32* %7, align 4, !dbg !2429
  %9 = tail call fastcc i64 @read(i32 %8, i8* %buf, i64 %.bufsize) #15, !dbg !2429
  %10 = icmp slt i64 %9, 1, !dbg !2429
  br i1 %10, label %11, label %18, !dbg !2429

; <label>:11                                      ; preds = %5
  %12 = icmp eq i64 %9, 0, !dbg !2431
  %13 = load i16* %1, align 2, !dbg !2434
  br i1 %12, label %14, label %16, !dbg !2431

; <label>:14                                      ; preds = %11
  %15 = or i16 %13, 4, !dbg !2434
  store i16 %15, i16* %1, align 2, !dbg !2434
  br label %18, !dbg !2436

; <label>:16                                      ; preds = %11
  %17 = or i16 %13, 8, !dbg !2437
  store i16 %17, i16* %1, align 2, !dbg !2437
  br label %18

; <label>:18                                      ; preds = %0, %5, %16, %14
  %rv.0 = phi i64 [ 0, %0 ], [ 0, %14 ], [ 0, %16 ], [ %9, %5 ]
  ret i64 %rv.0, !dbg !2439
}

; Function Attrs: nounwind uwtable
define internal hidden fastcc i64 @__stdio_WRITE(%struct.__STDIO_FILE_STRUCT.195* nocapture %stream, i8* %buf, i64 %bufsize) #0 {
  %1 = icmp eq i64 %bufsize, 0, !dbg !2440
  br i1 %1, label %.loopexit, label %.lr.ph, !dbg !2440

.lr.ph:                                           ; preds = %0
  %2 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 2, !dbg !2443
  br label %3, !dbg !2440

; <label>:3                                       ; preds = %.lr.ph, %9
  %.015 = phi i8* [ %buf, %.lr.ph ], [ %11, %9 ]
  %todo.04 = phi i64 [ %bufsize, %.lr.ph ], [ %10, %9 ]
  %4 = icmp sgt i64 %todo.04, -1, !dbg !2445
  %5 = select i1 %4, i64 %todo.04, i64 9223372036854775807, !dbg !2445
  %6 = load i32* %2, align 4, !dbg !2443
  %7 = tail call fastcc i64 @write(i32 %6, i8* %.015, i64 %5) #15, !dbg !2443
  %8 = icmp sgt i64 %7, -1, !dbg !2443
  br i1 %8, label %9, label %13, !dbg !2443

; <label>:9                                       ; preds = %3
  %10 = sub i64 %todo.04, %7, !dbg !2446
  %11 = getelementptr inbounds i8* %.015, i64 %7, !dbg !2448
  %12 = icmp eq i64 %todo.04, %7, !dbg !2440
  br i1 %12, label %.loopexit, label %3, !dbg !2440

; <label>:13                                      ; preds = %3
  %14 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 0, !dbg !2449
  %15 = load i16* %14, align 2, !dbg !2449
  %16 = or i16 %15, 8, !dbg !2449
  store i16 %16, i16* %14, align 2, !dbg !2449
  %17 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 4, !dbg !2451
  %18 = load i8** %17, align 8, !dbg !2451
  %19 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 3, !dbg !2451
  %20 = load i8** %19, align 8, !dbg !2451
  %21 = ptrtoint i8* %18 to i64, !dbg !2451
  %22 = ptrtoint i8* %20 to i64, !dbg !2451
  %23 = sub i64 %21, %22, !dbg !2451
  %24 = icmp eq i8* %18, %20, !dbg !2451
  br i1 %24, label %47, label %25, !dbg !2451

; <label>:25                                      ; preds = %13
  %26 = icmp ugt i64 %23, %todo.04, !dbg !2453
  %todo.0. = select i1 %26, i64 %todo.04, i64 %23, !dbg !2453
  %27 = load i8** %19, align 8, !dbg !2456
  br label %28, !dbg !2457

; <label>:28                                      ; preds = %35, %25
  %stodo.1 = phi i64 [ %todo.0., %25 ], [ %38, %35 ]
  %.1 = phi i8* [ %.015, %25 ], [ %37, %35 ]
  %s.0 = phi i8* [ %27, %25 ], [ %36, %35 ]
  %29 = load i8* %.1, align 1, !dbg !2458
  store i8 %29, i8* %s.0, align 1, !dbg !2458
  %30 = icmp eq i8 %29, 10, !dbg !2458
  br i1 %30, label %31, label %35, !dbg !2458

; <label>:31                                      ; preds = %28
  %32 = load i16* %14, align 2, !dbg !2458
  %33 = and i16 %32, 256, !dbg !2458
  %34 = icmp eq i16 %33, 0, !dbg !2458
  br i1 %34, label %35, label %40, !dbg !2458

; <label>:35                                      ; preds = %31, %28
  %36 = getelementptr inbounds i8* %s.0, i64 1, !dbg !2461
  %37 = getelementptr inbounds i8* %.1, i64 1, !dbg !2462
  %38 = add nsw i64 %stodo.1, -1, !dbg !2463
  %39 = icmp eq i64 %38, 0, !dbg !2463
  br i1 %39, label %40, label %28, !dbg !2463

; <label>:40                                      ; preds = %31, %35
  %s.1 = phi i8* [ %s.0, %31 ], [ %36, %35 ]
  %41 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 5, !dbg !2464
  store i8* %s.1, i8** %41, align 8, !dbg !2464
  %42 = load i8** %19, align 8, !dbg !2465
  %43 = ptrtoint i8* %s.1 to i64, !dbg !2465
  %44 = ptrtoint i8* %42 to i64, !dbg !2465
  %45 = sub i64 %todo.04, %43, !dbg !2465
  %46 = add i64 %45, %44, !dbg !2465
  br label %47, !dbg !2466

; <label>:47                                      ; preds = %13, %40
  %todo.1 = phi i64 [ %46, %40 ], [ %todo.04, %13 ]
  %48 = sub i64 %bufsize, %todo.1, !dbg !2467
  br label %.loopexit, !dbg !2467
...
define internal hidden fastcc i32 @__stdio_trans2r_o(%struct.__STDIO_FILE_STRUCT.195* noalias nocapture %stream) #0 {
  %1 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 0, !dbg !2469
  %2 = load i16* %1, align 2, !dbg !2469
  %3 = and i16 %2, 128, !dbg !2469
  %4 = icmp eq i16 %3, 0, !dbg !2469
  br i1 %4, label %5, label %._crit_edge, !dbg !2469

; <label>:5                                       ; preds = %0
  %6 = and i16 %2, 2176, !dbg !2471
  %7 = icmp eq i16 %6, 0, !dbg !2471
  br i1 %7, label %8, label %14, !dbg !2471

; <label>:8                                       ; preds = %5
  %9 = load i16* %1, align 2, !dbg !2474
  %10 = or i16 %9, 128, !dbg !2474
  store i16 %10, i16* %1, align 2, !dbg !2474
  br label %._crit_edge, !dbg !2475

._crit_edge:                                      ; preds = %0, %8
  %11 = phi i16 [ %10, %8 ], [ %2, %0 ]
  %12 = and i16 %11, 16, !dbg !2476
  %13 = icmp eq i16 %12, 0, !dbg !2476
  br i1 %13, label %18, label %14, !dbg !2476

; <label>:14                                      ; preds = %._crit_edge, %5
  store i32 9, i32* @errno, align 4, !dbg !2478
  br label %15, !dbg !2478

; <label>:15                                      ; preds = %22, %14
  %16 = load i16* %1, align 2, !dbg !2480
  %17 = or i16 %16, 8, !dbg !2480
  br label %34, !dbg !2481

; <label>:18                                      ; preds = %._crit_edge
  %19 = load i16* %1, align 2, !dbg !2482
  %20 = and i16 %19, 64, !dbg !2482
  %21 = icmp eq i16 %20, 0, !dbg !2482
  br i1 %21, label %._crit_edge1, label %22, !dbg !2482

._crit_edge1:                                     ; preds = %18
  %.pre2 = load i16* %1, align 2, !dbg !2484
  br label %31, !dbg !2482

; <label>:22                                      ; preds = %18
  %23 = tail call fastcc i64 @__stdio_wcommit(%struct.__STDIO_FILE_STRUCT.195* %stream) #15, !dbg !2485
  %24 = icmp eq i64 %23, 0, !dbg !2485
  br i1 %24, label %25, label %15, !dbg !2485

; <label>:25                                      ; preds = %22
  %26 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 3, !dbg !2488
  %27 = load i8** %26, align 8, !dbg !2488
  %28 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %stream, i64 0, i32 8, !dbg !2488
  store i8* %27, i8** %28, align 8, !dbg !2488
  %29 = load i16* %1, align 2, !dbg !2489
  %30 = and i16 %29, -65, !dbg !2489
  store i16 %30, i16* %1, align 2, !dbg !2489
  br label %31, !dbg !2490

; <label>:31                                      ; preds = %._crit_edge1, %25
  %32 = phi i16 [ %.pre2, %._crit_edge1 ], [ %30, %25 ]
  %33 = or i16 %32, 1, !dbg !2484
  br label %34, !dbg !2491

; <label>:34                                      ; preds = %31, %15
  %storemerge = phi i16 [ %17, %15 ], [ %33, %31 ]
  %.0 = phi i32 [ -1, %15 ], [ 0, %31 ]
  store i16 %storemerge, i16* %1, align 2, !dbg !2484
  ret i32 %.0, !dbg !2492
}

; Function Attrs: nounwind uwtable
define internal i32 @fflush_unlocked(%struct.__STDIO_FILE_STRUCT.195* %stream) #0 {
  %1 = icmp eq %struct.__STDIO_FILE_STRUCT.195* %stream, bitcast (%struct.__STDIO_FILE_STRUCT.195** @_stdio_openlist to %struct.__STDIO_FILE_STRUCT.195*), !dbg !2493
  %. = select i1 %1, i32 0, i32 256, !dbg !2493
  %.stream = select i1 %1, %struct.__STDIO_FILE_STRUCT.195* null, %struct.__STDIO_FILE_STRUCT.195* %stream, !dbg !2493
  %2 = icmp eq %struct.__STDIO_FILE_STRUCT.195* %.stream, null, !dbg !2495
  br i1 %2, label %.preheader, label %25, !dbg !2495

.preheader:                                       ; preds = %0
  %.11 = load %struct.__STDIO_FILE_STRUCT.195** @_stdio_openlist, align 8, !dbg !2497
  %3 = icmp eq %struct.__STDIO_FILE_STRUCT.195* %.11, null, !dbg !2499
  br i1 %3, label %.loopexit, label %.lr.ph, !dbg !2499

.lr.ph:                                           ; preds = %.preheader, %22
  %.13 = phi %struct.__STDIO_FILE_STRUCT.195* [ %.1, %22 ], [ %.11, %.preheader ]
  %retval.02 = phi i32 [ %retval.1, %22 ], [ 0, %.preheader ]
  %4 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %.13, i64 0, i32 0, !dbg !2500
  %5 = load i16* %4, align 2, !dbg !2500
  %6 = and i16 %5, 64, !dbg !2500
  %7 = icmp eq i16 %6, 0, !dbg !2500
  br i1 %7, label %22, label %8, !dbg !2500

; <label>:8                                       ; preds = %.lr.ph
  %9 = load i16* %4, align 2, !dbg !2503
  %10 = zext i16 %9 to i32, !dbg !2503
  %.masked = and i32 %10, 832, !dbg !2503
  %11 = or i32 %.masked, %., !dbg !2503
  %12 = icmp eq i32 %11, 320, !dbg !2503
  br i1 %12, label %13, label %22, !dbg !2503

; <label>:13                                      ; preds = %8
  %14 = tail call fastcc i64 @__stdio_wcommit(%struct.__STDIO_FILE_STRUCT.195* %.13) #15, !dbg !2506
  %15 = icmp eq i64 %14, 0, !dbg !2506
  br i1 %15, label %16, label %22, !dbg !2506

; <label>:16                                      ; preds = %13
  %17 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %.13, i64 0, i32 3, !dbg !2509
  %18 = load i8** %17, align 8, !dbg !2509
  %19 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %.13, i64 0, i32 8, !dbg !2509
  store i8* %18, i8** %19, align 8, !dbg !2509
  %20 = load i16* %4, align 2, !dbg !2511
  %21 = and i16 %20, -65, !dbg !2511
  store i16 %21, i16* %4, align 2, !dbg !2511
  br label %22, !dbg !2512

; <label>:22                                      ; preds = %13, %8, %.lr.ph, %16
  %retval.1 = phi i32 [ %retval.02, %8 ], [ %retval.02, %16 ], [ %retval.02, %.lr.ph ], [ -1, %13 ]
  %23 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %.13, i64 0, i32 9, !dbg !2513
  %.1 = load %struct.__STDIO_FILE_STRUCT.195** %23, align 8, !dbg !2497
  %24 = icmp eq %struct.__STDIO_FILE_STRUCT.195* %.1, null, !dbg !2499
  br i1 %24, label %.loopexit, label %.lr.ph, !dbg !2499

; <label>:25                                      ; preds = %0
  %26 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %.stream, i64 0, i32 0, !dbg !2514
  %27 = load i16* %26, align 2, !dbg !2514
  %28 = and i16 %27, 64, !dbg !2514
  %29 = icmp eq i16 %28, 0, !dbg !2514
  br i1 %29, label %.loopexit, label %30, !dbg !2514

; <label>:30                                      ; preds = %25
  %31 = tail call fastcc i64 @__stdio_wcommit(%struct.__STDIO_FILE_STRUCT.195* %.stream) #15, !dbg !2516
  %32 = icmp eq i64 %31, 0, !dbg !2516
  br i1 %32, label %33, label %.loopexit, !dbg !2516

; <label>:33                                      ; preds = %30
  %34 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %.stream, i64 0, i32 3, !dbg !2519
  %35 = load i8** %34, align 8, !dbg !2519
  %36 = getelementptr inbounds %struct.__STDIO_FILE_STRUCT.195* %.stream, i64 0, i32 8, !dbg !2519
  store i8* %35, i8** %36, align 8, !dbg !2519
  %37 = load i16* %26, align 2, !dbg !2521
  %38 = and i16 %37, -65, !dbg !2521
  store i16 %38, i16* %26, align 2, !dbg !2521
  br label %.loopexit, !dbg !2522

.loopexit:                                        ; preds = %22, %.preheader, %30, %25, %33
  %retval.2 = phi i32 [ 0, %33 ], [ 0, %25 ], [ -1, %30 ], [ 0, %.preheader ], [ %retval.1, %22 ]
  ret i32 %retval.2, !dbg !2523
}

; Function Attrs: nounwind uwtable
define internal fastcc i8* @mempcpy158(i8* noalias %s1, i8* noalias nocapture readonly %s2) #0 {
  br label %.lr.ph, !dbg !2524

.lr.ph:                                           ; preds = %0, %.lr.ph
  %r2.03 = phi i8* [ %1, %.lr.ph ], [ %s2, %0 ]
  %r1.02 = phi i8* [ %3, %.lr.ph ], [ %s1, %0 ]
  %.01 = phi i64 [ %4, %.lr.ph ], [ 19, %0 ]
  %1 = getelementptr inbounds i8* %r2.03, i64 1, !dbg !2525
  %2 = load i8* %r2.03, align 1, !dbg !2525
  %3 = getelementptr inbounds i8* %r1.02, i64 1, !dbg !2525
  store i8 %2, i8* %r1.02, align 1, !dbg !2525
  %4 = add i64 %.01, -1, !dbg !2527
  %5 = icmp eq i64 %4, 0, !dbg !2524
  br i1 %5, label %6, label %.lr.ph, !dbg !2524

; <label>:6                                       ; preds = %.lr.ph
  %scevgep = getelementptr i8* %s1, i64 19
  ret i8* %scevgep, !dbg !2528
}

; Function Attrs: nounwind uwtable
define internal fastcc void @memset160(i8* nocapture %s, i64 %n) #0 {
  %1 = icmp eq i64 %n, 0, !dbg !2529
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !2529

.lr.ph:                                           ; preds = %0, %.lr.ph
  %p.02 = phi i8* [ %2, %.lr.ph ], [ %s, %0 ]
  %.01 = phi i64 [ %3, %.lr.ph ], [ %n, %0 ]
  %2 = getelementptr inbounds i8* %p.02, i64 1, !dbg !2530
  store i8 0, i8* %p.02, align 1, !dbg !2530
  %3 = add i64 %.01, -1, !dbg !2532
  %4 = icmp eq i64 %3, 0, !dbg !2529
  br i1 %4, label %._crit_edge, label %.lr.ph, !dbg !2529
...
; Function Attrs: nounwind uwtable
define internal fastcc i32 @__fd_open(i8* %pathname, i32 %flags, i32 %mode) #9 {
  br label %4, !dbg !2533

; <label>:1                                       ; preds = %4
  %2 = trunc i64 %indvars.iv.next to i32, !dbg !2533
  %3 = icmp slt i32 %2, 32, !dbg !2533
  br i1 %3, label %4, label %10, !dbg !2533

; <label>:4                                       ; preds = %1, %0
  %indvars.iv = phi i64 [ 0, %0 ], [ %indvars.iv.next, %1 ]
  %fd.04 = phi i32 [ 0, %0 ], [ %9, %1 ]
  %5 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %indvars.iv, i32 1, !dbg !2535
  %6 = load i32* %5, align 4, !dbg !2535, !tbaa !2537
  %7 = and i32 %6, 1, !dbg !2535
  %8 = icmp eq i32 %7, 0, !dbg !2535
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !2533
  %9 = add nsw i32 %fd.04, 1, !dbg !2533
  br i1 %8, label %10, label %1, !dbg !2535

; <label>:10                                      ; preds = %4, %1
  %fd.0.lcssa = phi i32 [ %fd.04, %4 ], [ %9, %1 ]
  %11 = icmp eq i32 %fd.0.lcssa, 32, !dbg !2544
  br i1 %11, label %12, label %13, !dbg !2544

; <label>:12                                      ; preds = %10
  store i32 24, i32* @errno, align 4, !dbg !2546, !tbaa !2548
  br label %100, !dbg !2549

; <label>:13                                      ; preds = %10
  %14 = sext i32 %fd.0.lcssa to i64, !dbg !2550
  %15 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %14, !dbg !2550
  %16 = bitcast %struct.exe_file_t* %15 to i8*, !dbg !2551
  %17 = call i8* @memset(i8* %16, i32 0, i64 24)
  %18 = load i8* %pathname, align 1, !dbg !2552, !tbaa !2554
  %19 = sext i8 %18 to i32, !dbg !2555
  %20 = icmp eq i8 %18, 0, !dbg !2555
  br i1 %20, label %__get_sym_file.exit.thread, label %21, !dbg !2555

; <label>:21                                      ; preds = %13
  %22 = getelementptr inbounds i8* %pathname, i64 1, !dbg !2555
  %23 = load i8* %22, align 1, !dbg !2555, !tbaa !2554
  %24 = icmp eq i8 %23, 0, !dbg !2555
  br i1 %24, label %.preheader.i, label %__get_sym_file.exit.thread, !dbg !2555

.preheader.i:                                     ; preds = %21
  %25 = load i32* @__exe_fs.0, align 8, !dbg !2557, !tbaa !2558
  %26 = icmp eq i32 %25, 0, !dbg !2557
  br i1 %26, label %__get_sym_file.exit.thread, label %.lr.ph.i, !dbg !2557

; <label>:27                                      ; preds = %.lr.ph.i
  %28 = icmp ult i32 %32, %25, !dbg !2557
  br i1 %28, label %.lr.ph.i, label %__get_sym_file.exit.thread, !dbg !2557

.lr.ph.i:                                         ; preds = %.preheader.i, %27
  %i.02.i = phi i32 [ %32, %27 ], [ 0, %.preheader.i ]
  tail call void @klee_overshift_check(i64 32, i64 24) #10, !dbg !2560
  %sext.i = shl i32 %i.02.i, 24, !dbg !2560
  tail call void @klee_overshift_check(i64 32, i64 24) #10, !dbg !2560
  %29 = ashr exact i32 %sext.i, 24, !dbg !2560
  %30 = add nsw i32 %29, 65, !dbg !2560
  %31 = icmp eq i32 %19, %30, !dbg !2560
  %32 = add i32 %i.02.i, 1, !dbg !2557
  br i1 %31, label %33, label %27, !dbg !2560

; <label>:33                                      ; preds = %.lr.ph.i
  %34 = zext i32 %i.02.i to i64, !dbg !2561
  %35 = load %struct.exe_disk_file_t** @__exe_fs.4, align 8, !dbg !2561, !tbaa !2562
  %36 = getelementptr inbounds %struct.exe_disk_file_t* %35, i64 %34, i32 2, !dbg !2563
  %37 = load %struct.stat64.648** %36, align 8, !dbg !2563, !tbaa !2565
  %38 = getelementptr inbounds %struct.stat64.648* %37, i64 0, i32 1, !dbg !2563
  %39 = load i64* %38, align 8, !dbg !2563, !tbaa !2567
  %40 = icmp eq i64 %39, 0, !dbg !2563
  br i1 %40, label %__get_sym_file.exit.thread, label %__get_sym_file.exit, !dbg !2563

__get_sym_file.exit:                              ; preds = %33
  %41 = getelementptr inbounds %struct.exe_disk_file_t* %35, i64 %34, !dbg !2561
  %42 = icmp eq %struct.exe_disk_file_t* %41, null, !dbg !2570
  br i1 %42, label %__get_sym_file.exit.thread, label %43, !dbg !2570

; <label>:43                                      ; preds = %__get_sym_file.exit
  %44 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %14, i32 3, !dbg !2571
  store %struct.exe_disk_file_t* %41, %struct.exe_disk_file_t** %44, align 8, !dbg !2571, !tbaa !2573
  %45 = and i32 %flags, 192, !dbg !2574
...
; <label>:46                                      ; preds = %43
  store i32 17, i32* @errno, align 4, !dbg !2576, !tbaa !2548
  br label %100, !dbg !2578

; <label>:47                                      ; preds = %43
  tail call void @klee_warning(i8* getelementptr inbounds ([47 x i8]* @.str171, i64 0, i64 0)) #10, !dbg !2579
  store i32 13, i32* @errno, align 4, !dbg !2582, !tbaa !2548
  br label %100, !dbg !2583

; <label>:48                                      ; preds = %43
  %49 = getelementptr inbounds %struct.stat64.648* %37, i64 0, i32 3, !dbg !2584
  %50 = load i32* %49, align 4, !dbg !2584, !tbaa !2587
  %51 = and i32 %flags, 2, !dbg !2588
  %52 = icmp eq i32 %51, 0, !dbg !2588
  %53 = and i32 %50, 292, !dbg !2590
  %54 = icmp eq i32 %53, 0, !dbg !2590
  %or.cond3.i = or i1 %52, %54, !dbg !2590
  br i1 %or.cond3.i, label %has_permission.exit, label %has_permission.exit.thread, !dbg !2590

has_permission.exit:                              ; preds = %48
  %55 = and i32 %flags, 3, !dbg !2592
  %not..i = icmp ne i32 %55, 0, !dbg !2592
  %56 = and i32 %50, 146, !dbg !2594
  %57 = icmp eq i32 %56, 0, !dbg !2594
  %or.cond5.i = and i1 %not..i, %57, !dbg !2594
  br i1 %or.cond5.i, label %has_permission.exit.thread, label %58, !dbg !2585

has_permission.exit.thread:                       ; preds = %has_permission.exit, %48
  store i32 13, i32* @errno, align 4, !dbg !2596, !tbaa !2548
  br label %100, !dbg !2598

; <label>:58                                      ; preds = %has_permission.exit
  %59 = and i32 %50, -512, !dbg !2599
  %60 = load i32* getelementptr inbounds ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env, i64 0, i32 1), align 8, !dbg !2599, !tbaa !2600
  %61 = xor i32 %60, -1, !dbg !2599
  %62 = and i32 %61, %mode, !dbg !2599
  %63 = or i32 %62, %59, !dbg !2599
  store i32 %63, i32* %49, align 4, !dbg !2599, !tbaa !2587
  br label %95, !dbg !2602

__get_sym_file.exit.thread:                       ; preds = %27, %__get_sym_file.exit, %33, %.preheader.i, %21, %13
  %64 = ptrtoint i8* %pathname to i64, !dbg !2603
  %65 = tail call i64 @klee_get_valuel(i64 %64) #10, !dbg !2603
  %66 = inttoptr i64 %65 to i8*, !dbg !2603
  %67 = icmp eq i8* %66, %pathname, !dbg !2606
  %68 = zext i1 %67 to i64, !dbg !2606
  tail call void @klee_assume(i64 %68) #10, !dbg !2606
...
; <label>:69                                      ; preds = %86, %__get_sym_file.exit.thread
  ...
  %70 = load i8* %sc.0.i, align 1, !dbg !2608, !tbaa !2554
  %71 = add i32 %i.0.i, -1, !dbg !2609
  %72 = and i32 %71, %i.0.i, !dbg !2609
  %73 = icmp eq i32 %72, 0, !dbg !2609
  br i1 %73, label %74, label %78, !dbg !2609
...
; <label>:75                                      ; preds = %74
  store i8 0, i8* %sc.0.i, align 1, !dbg !2613, !tbaa !2554
  br label %__concretize_string.exit, !dbg !2615

; <label>:76                                      ; preds = %74
  %77 = getelementptr inbounds i8* %sc.0.i, i64 1, !dbg !2616
  store i8 47, i8* %sc.0.i, align 1, !dbg !2616, !tbaa !2554
  br label %86, !dbg !2619

; <label>:78                                      ; preds = %69
  %79 = sext i8 %70 to i64, !dbg !2620
  %80 = tail call i64 @klee_get_valuel(i64 %79) #10, !dbg !2620
  %81 = trunc i64 %80 to i8, !dbg !2620
  %82 = icmp eq i8 %81, %70, !dbg !2621
  %83 = zext i1 %82 to i64, !dbg !2621
  tail call void @klee_assume(i64 %83) #10, !dbg !2621
  %84 = getelementptr inbounds i8* %sc.0.i, i64 1, !dbg !2622
  store i8 %81, i8* %sc.0.i, align 1, !dbg !2622, !tbaa !2554
  %85 = icmp eq i8 %81, 0, !dbg !2623
  br i1 %85, label %__concretize_string.exit, label %86, !dbg !2623

; <label>:86                                      ; preds = %78, %76, %74
  %sc.1.i = phi i8* [ %84, %78 ], [ %77, %76 ], [ %sc.0.i, %74 ]
  %87 = add i32 %i.0.i, 1, !dbg !2607
  br label %69, !dbg !2607

__concretize_string.exit:                         ; preds = %78, %75
  %88 = tail call i64 (i64, ...)* @syscall(i64 2, i8* %pathname, i32 %flags, i32 %mode) #10, !dbg !2605
  %89 = trunc i64 %88 to i32, !dbg !2605
  %90 = icmp eq i32 %89, -1, !dbg !2625
  br i1 %90, label %91, label %93, !dbg !2625

; <label>:91                                      ; preds = %__concretize_string.exit
  %92 = tail call i32 @klee_get_errno() #10, !dbg !2627
  store i32 %92, i32* @errno, align 4, !dbg !2627, !tbaa !2548
  br label %100, !dbg !2629

; <label>:93                                      ; preds = %__concretize_string.exit
  %94 = getelementptr inbounds %struct.exe_file_t* %15, i64 0, i32 0, !dbg !2630
  store i32 %89, i32* %94, align 8, !dbg !2630, !tbaa !2631
  %.pre = and i32 %flags, 3, !dbg !2632
  br label %95

; <label>:95                                      ; preds = %93, %58
  %.pre-phi = phi i32 [ %.pre, %93 ], [ %55, %58 ], !dbg !2632
  %96 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %14, i32 1, !dbg !2634
  store i32 1, i32* %96, align 4, !dbg !2634, !tbaa !2537
...
; <label>:97                                      ; preds = %95
  store i32 5, i32* %96, align 4, !dbg !2635, !tbaa !2537
  br label %100, !dbg !2637

; <label>:98                                      ; preds = %95
  store i32 9, i32* %96, align 4, !dbg !2638, !tbaa !2537
  br label %100, !dbg !2641

; <label>:99                                      ; preds = %95
  store i32 13, i32* %96, align 4, !dbg !2642, !tbaa !2537
  br label %100
...
define internal fastcc i64 @read(i32 %fd, i8* %buf, i64 %count) #9 {
  %1 = load i32* @read.n_calls, align 4, !dbg !2645, !tbaa !2548
  %2 = add nsw i32 %1, 1, !dbg !2645
  store i32 %2, i32* @read.n_calls, align 4, !dbg !2645, !tbaa !2548
  %3 = icmp eq i64 %count, 0, !dbg !2646
  br i1 %3, label %._crit_edge, label %4, !dbg !2646

; <label>:4                                       ; preds = %0
  %5 = icmp eq i8* %buf, null, !dbg !2648
  br i1 %5, label %6, label %7, !dbg !2648

; <label>:6                                       ; preds = %4
  store i32 14, i32* @errno, align 4, !dbg !2650, !tbaa !2548
  br label %._crit_edge, !dbg !2652

; <label>:7                                       ; preds = %4
  %8 = icmp ult i32 %fd, 32, !dbg !2653
  br i1 %8, label %9, label %__get_file.exit.thread, !dbg !2653

; <label>:9                                       ; preds = %7
  %10 = sext i32 %fd to i64, !dbg !2655
  %11 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %10, i32 1, !dbg !2656
  %12 = load i32* %11, align 4, !dbg !2656, !tbaa !2537
  %13 = and i32 %12, 1, !dbg !2656
  %14 = icmp eq i32 %13, 0, !dbg !2656
  br i1 %14, label %__get_file.exit.thread, label %__get_file.exit, !dbg !2656

__get_file.exit:                                  ; preds = %9
  %15 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %10, !dbg !2655
  %16 = icmp eq %struct.exe_file_t* %15, null, !dbg !2658
  br i1 %16, label %__get_file.exit.thread, label %17, !dbg !2658

__get_file.exit.thread:                           ; preds = %__get_file.exit, %9, %7
  store i32 9, i32* @errno, align 4, !dbg !2660, !tbaa !2548
  br label %._crit_edge, !dbg !2662

; <label>:17                                      ; preds = %__get_file.exit
  %18 = load i32* @__exe_fs.5, align 8, !dbg !2663, !tbaa !2665
  %19 = icmp eq i32 %18, 0, !dbg !2663
  br i1 %19, label %26, label %20, !dbg !2663

; <label>:20                                      ; preds = %17
  %21 = load i32** @__exe_fs.6, align 8, !dbg !2663, !tbaa !2666
  %22 = load i32* %21, align 4, !dbg !2663, !tbaa !2548
  %23 = icmp eq i32 %22, %2, !dbg !2663
  br i1 %23, label %24, label %26, !dbg !2663

; <label>:24                                      ; preds = %20
  %25 = add i32 %18, -1, !dbg !2667
  store i32 %25, i32* @__exe_fs.5, align 8, !dbg !2667, !tbaa !2665
  store i32 5, i32* @errno, align 4, !dbg !2669, !tbaa !2548
  br label %._crit_edge, !dbg !2670

; <label>:26                                      ; preds = %20, %17
  %27 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %10, i32 3, !dbg !2671
  %28 = load %struct.exe_disk_file_t** %27, align 8, !dbg !2671, !tbaa !2573
  %29 = icmp eq %struct.exe_disk_file_t* %28, null, !dbg !2671
  br i1 %29, label %30, label %59, !dbg !2671

; <label>:30                                      ; preds = %26
  %31 = ptrtoint i8* %buf to i64, !dbg !2672
  %32 = tail call i64 @klee_get_valuel(i64 %31) #10, !dbg !2672
  %33 = inttoptr i64 %32 to i8*, !dbg !2672
  %34 = icmp eq i8* %33, %buf, !dbg !2674
  %35 = zext i1 %34 to i64, !dbg !2674
  tail call void @klee_assume(i64 %35) #10, !dbg !2674
  %36 = tail call i64 @klee_get_valuel(i64 %count) #10, !dbg !2675
  %37 = icmp eq i64 %36, %count, !dbg !2677
  %38 = zext i1 %37 to i64, !dbg !2677
  tail call void @klee_assume(i64 %38) #10, !dbg !2677
  tail call void @klee_check_memory_access(i8* %33, i64 %36) #10, !dbg !2678
  %39 = getelementptr inbounds %struct.exe_file_t* %15, i64 0, i32 0, !dbg !2679
  %40 = load i32* %39, align 8, !dbg !2679, !tbaa !2631
  %41 = icmp eq i32 %40, 0, !dbg !2679
  br i1 %41, label %42, label %44, !dbg !2679

; <label>:42                                      ; preds = %30
  %43 = tail call i64 (i64, ...)* @syscall(i64 0, i32 0, i8* %33, i64 %36) #10, !dbg !2681
  br label %48, !dbg !2681

; <label>:44                                      ; preds = %30
  %45 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %10, i32 2, !dbg !2682
  %46 = load i64* %45, align 8, !dbg !2682, !tbaa !2683
  %47 = tail call i64 (i64, ...)* @syscall(i64 17, i32 %40, i8* %33, i64 %36, i64 %46) #10, !dbg !2682
  br label %48

; <label>:48                                      ; preds = %44, %42
  %r.0.in = phi i64 [ %43, %42 ], [ %47, %44 ]
  %r.0 = trunc i64 %r.0.in to i32, !dbg !2681
  %49 = icmp eq i32 %r.0, -1, !dbg !2684
  br i1 %49, label %50, label %52, !dbg !2684

; <label>:50                                      ; preds = %48
  %51 = tail call i32 @klee_get_errno() #10, !dbg !2686
  store i32 %51, i32* @errno, align 4, !dbg !2686, !tbaa !2548
  br label %._crit_edge, !dbg !2688

; <label>:52                                      ; preds = %48
  %53 = load i32* %39, align 8, !dbg !2689, !tbaa !2631
  %54 = icmp eq i32 %53, 0, !dbg !2689
  tail call void @klee_overshift_check(i64 64, i64 32) #10, !dbg !2691
  %sext.pre = shl i64 %r.0.in, 32, !dbg !2691
  tail call void @klee_overshift_check(i64 64, i64 32) #10, !dbg !2691
  %.pre = ashr exact i64 %sext.pre, 32, !dbg !2691
  br i1 %54, label %._crit_edge, label %55, !dbg !2689

; <label>:55                                      ; preds = %52
  %56 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %10, i32 2, !dbg !2692
  %57 = load i64* %56, align 8, !dbg !2692, !tbaa !2683
  %58 = add nsw i64 %57, %.pre, !dbg !2692
  store i64 %58, i64* %56, align 8, !dbg !2692, !tbaa !2683
  br label %._crit_edge, !dbg !2692

; <label>:59                                      ; preds = %26
  %60 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %10, i32 2, !dbg !2693
  %61 = load i64* %60, align 8, !dbg !2693, !tbaa !2683
  %62 = icmp sgt i64 %61, -1, !dbg !2693
  br i1 %62, label %64, label %63, !dbg !2693

; <label>:63                                      ; preds = %59
  tail call void @__assert_fail(i8* getelementptr inbounds ([12 x i8]* @.str373, i64 0, i64 0), i8* getelementptr inbounds ([39 x i8]* @.str474, i64 0, i64 0), i32 386, i8* getelementptr inbounds ([34 x i8]* @__PRETTY_FUNCTION__.read, i64 0, i64 0)) #6, 
  unreachable, !dbg !2693

; <label>:64                                      ; preds = %59
  %65 = getelementptr inbounds %struct.exe_disk_file_t* %28, i64 0, i32 0, !dbg !2695
  %66 = load i32* %65, align 4, !dbg !2695, !tbaa !2697
  %67 = zext i32 %66 to i64, !dbg !2695
  %68 = icmp slt i64 %67, %61, !dbg !2695
  br i1 %68, label %._crit_edge, label %69, !dbg !2695

; <label>:69                                      ; preds = %64
  %70 = add i64 %61, %count, !dbg !2698
  %71 = icmp ugt i64 %70, %67, !dbg !2698
  %72 = sub nsw i64 %67, %61, !dbg !2700
  %.count = select i1 %71, i64 %72, i64 %count, !dbg !2698
  %73 = getelementptr inbounds %struct.exe_disk_file_t* %28, i64 0, i32 1, !dbg !2702
  %74 = load i8** %73, align 8, !dbg !2702, !tbaa !2703
  %75 = getelementptr inbounds i8* %74, i64 %61, !dbg !2702
  %76 = call i8* @memcpy(i8* %buf, i8* %75, i64 %.count)
  %77 = load i64* %60, align 8, !dbg !2704, !tbaa !2683
  %78 = add i64 %77, %.count, !dbg !2704
  store i64 %78, i64* %60, align 8, !dbg !2704, !tbaa !2683
  br label %._crit_edge, !dbg !2705
...
define internal fastcc i64 @write(i32 %fd, i8* %buf, i64 %count) #9 {
  %1 = load i32* @write.n_calls, align 4, !dbg !2707, !tbaa !2548
  %2 = add nsw i32 %1, 1, !dbg !2707
  store i32 %2, i32* @write.n_calls, align 4, !dbg !2707, !tbaa !2548
  %3 = icmp ult i32 %fd, 32, !dbg !2708
  br i1 %3, label %4, label %__get_file.exit.thread, !dbg !2708

; <label>:4                                       ; preds = %0
  %5 = sext i32 %fd to i64, !dbg !2710
  %6 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %5, i32 1, !dbg !2711
  %7 = load i32* %6, align 4, !dbg !2711, !tbaa !2537
  %8 = and i32 %7, 1, !dbg !2711
  %9 = icmp eq i32 %8, 0, !dbg !2711
  br i1 %9, label %__get_file.exit.thread, label %__get_file.exit, !dbg !2711

__get_file.exit:                                  ; preds = %4
  %10 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %5, !dbg !2710
  %11 = icmp eq %struct.exe_file_t* %10, null, !dbg !2712
  br i1 %11, label %__get_file.exit.thread, label %12, !dbg !2712

__get_file.exit.thread:                           ; preds = %__get_file.exit, %4, %0
  store i32 9, i32* @errno, align 4, !dbg !2714, !tbaa !2548
  br label %._crit_edge, !dbg !2716

; <label>:12                                      ; preds = %__get_file.exit
  %13 = load i32* @__exe_fs.5, align 8, !dbg !2717, !tbaa !2665
  %14 = icmp eq i32 %13, 0, !dbg !2717
  br i1 %14, label %21, label %15, !dbg !2717

; <label>:15                                      ; preds = %12
  %16 = load i32** @__exe_fs.7, align 8, !dbg !2717, !tbaa !2719
  %17 = load i32* %16, align 4, !dbg !2717, !tbaa !2548
  %18 = icmp eq i32 %17, %2, !dbg !2717
  br i1 %18, label %19, label %21, !dbg !2717

; <label>:19                                      ; preds = %15
  %20 = add i32 %13, -1, !dbg !2720
  store i32 %20, i32* @__exe_fs.5, align 8, !dbg !2720, !tbaa !2665
  store i32 5, i32* @errno, align 4, !dbg !2722, !tbaa !2548
  br label %._crit_edge, !dbg !2723

; <label>:21                                      ; preds = %15, %12
  %22 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %5, i32 3, !dbg !2724
  %23 = load %struct.exe_disk_file_t** %22, align 8, !dbg !2724, !tbaa !2573
  %24 = icmp eq %struct.exe_disk_file_t* %23, null, !dbg !2724
  br i1 %24, label %25, label %55, !dbg !2724

; <label>:25                                      ; preds = %21
  %26 = ptrtoint i8* %buf to i64, !dbg !2725
  %27 = tail call i64 @klee_get_valuel(i64 %26) #10, !dbg !2725
  %28 = inttoptr i64 %27 to i8*, !dbg !2725
  %29 = icmp eq i8* %28, %buf, !dbg !2727
  %30 = zext i1 %29 to i64, !dbg !2727
  tail call void @klee_assume(i64 %30) #10, !dbg !2727
  %31 = tail call i64 @klee_get_valuel(i64 %count) #10, !dbg !2728
  %32 = icmp eq i64 %31, %count, !dbg !2730
  %33 = zext i1 %32 to i64, !dbg !2730
  tail call void @klee_assume(i64 %33) #10, !dbg !2730
  tail call void @klee_check_memory_access(i8* %28, i64 %31) #10, !dbg !2731
  %34 = getelementptr inbounds %struct.exe_file_t* %10, i64 0, i32 0, !dbg !2732
  %35 = load i32* %34, align 8, !dbg !2732, !tbaa !2631
  %.off = add i32 %35, -1, !dbg !2732
  %switch = icmp ult i32 %.off, 2, !dbg !2732
  br i1 %switch, label %36, label %38, !dbg !2732

; <label>:36                                      ; preds = %25
  %37 = tail call i64 (i64, ...)* @syscall(i64 1, i32 %35, i8* %28, i64 %31) #10, !dbg !2734
  br label %42, !dbg !2734

; <label>:38                                      ; preds = %25
  %39 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %5, i32 2, !dbg !2735
  %40 = load i64* %39, align 8, !dbg !2735, !tbaa !2683
  %41 = tail call i64 (i64, ...)* @syscall(i64 18, i32 %35, i8* %28, i64 %31, i64 %40) #10, !dbg !2735
  br label %42

; <label>:42                                      ; preds = %38, %36
  %r.0.in = phi i64 [ %37, %36 ], [ %41, %38 ]
  %r.0 = trunc i64 %r.0.in to i32, !dbg !2734
  %43 = icmp eq i32 %r.0, -1, !dbg !2736
  br i1 %43, label %44, label %46, !dbg !2736

; <label>:44                                      ; preds = %42
  %45 = tail call i32 @klee_get_errno() #10, !dbg !2738
  store i32 %45, i32* @errno, align 4, !dbg !2738, !tbaa !2548
  br label %._crit_edge, !dbg !2740

; <label>:46                                      ; preds = %42
  %47 = icmp sgt i32 %r.0, -1, !dbg !2741
  br i1 %47, label %49, label %48, !dbg !2741

; <label>:48                                      ; preds = %46
  tail call void @__assert_fail(i8* getelementptr inbounds ([7 x i8]* @.str575, i64 0, i64 0), i8* getelementptr inbounds ([39 x i8]* @.str474, i64 0, i64 0), i32 440, i8* getelementptr inbounds ([41 x i8]* @__PRETTY_FUNCTION__.write, i64 0, i64 0)) #6, 
  unreachable, !dbg !2741

; <label>:49                                      ; preds = %46
  %50 = load i32* %34, align 8, !dbg !2742, !tbaa !2631
  %.off2 = add i32 %50, -1, !dbg !2742
  %switch3 = icmp ult i32 %.off2, 2, !dbg !2742
  tail call void @klee_overshift_check(i64 64, i64 32) #10, !dbg !2744
  %sext.pre = shl i64 %r.0.in, 32, !dbg !2744
  tail call void @klee_overshift_check(i64 64, i64 32) #10, !dbg !2744
  %.pre = ashr exact i64 %sext.pre, 32, !dbg !2744
  br i1 %switch3, label %._crit_edge, label %51, !dbg !2742

; <label>:51                                      ; preds = %49
  %52 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %5, i32 2, !dbg !2745
  %53 = load i64* %52, align 8, !dbg !2745, !tbaa !2683
  %54 = add nsw i64 %53, %.pre, !dbg !2745
  store i64 %54, i64* %52, align 8, !dbg !2745, !tbaa !2683
  br label %._crit_edge, !dbg !2745

; <label>:55                                      ; preds = %21
  %56 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %5, i32 2, !dbg !2746
  %57 = load i64* %56, align 8, !dbg !2746, !tbaa !2683
  %58 = add i64 %57, %count, !dbg !2746
  %59 = getelementptr inbounds %struct.exe_disk_file_t* %23, i64 0, i32 0, !dbg !2746
  %60 = load i32* %59, align 4, !dbg !2746, !tbaa !2697
  %61 = zext i32 %60 to i64, !dbg !2746
  %62 = icmp ugt i64 %58, %61, !dbg !2746
  br i1 %62, label %63, label %select.unfold, !dbg !2746

; <label>:63                                      ; preds = %55
  %64 = load i32* getelementptr inbounds ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env, i64 0, i32 3), align 8, !dbg !2748, !tbaa !2751
  %65 = icmp eq i32 %64, 0, !dbg !2748
  br i1 %65, label %67, label %66, !dbg !2748

; <label>:66                                      ; preds = %63
  tail call void @__assert_fail(i8* getelementptr inbounds ([2 x i8]* @.str6, i64 0, i64 0), i8* getelementptr inbounds ([39 x i8]* @.str474, i64 0, i64 0), i32 453, i8* getelementptr inbounds ([41 x i8]* @__PRETTY_FUNCTION__.write, i64 0, i64 0)) #6, !d
  unreachable, !dbg !2752

; <label>:67                                      ; preds = %63
  %68 = icmp sgt i64 %61, %57, !dbg !2753
  %69 = sub nsw i64 %61, %57, !dbg !2756
  br i1 %68, label %select.unfold, label %.thread

select.unfold:                                    ; preds = %67, %55
  %actual_count.0 = phi i64 [ %count, %55 ], [ %69, %67 ]
  %70 = icmp eq i64 %actual_count.0, 0, !dbg !2757
  br i1 %70, label %.thread, label %71, !dbg !2757

; <label>:71                                      ; preds = %select.unfold
  %72 = getelementptr inbounds %struct.exe_disk_file_t* %23, i64 0, i32 1, !dbg !2759
  %73 = load i8** %72, align 8, !dbg !2759, !tbaa !2703
  %74 = getelementptr inbounds i8* %73, i64 %57, !dbg !2759
  %75 = call i8* @memcpy(i8* %74, i8* %buf, i64 %actual_count.0)
  br label %.thread, !dbg !2759

.thread:                                          ; preds = %71, %select.unfold, %67
  %actual_count.04 = phi i64 [ 0, %select.unfold ], [ %actual_count.0, %71 ], [ 0, %67 ]
  %76 = icmp eq i64 %actual_count.04, %count, !dbg !2760
  br i1 %76, label %78, label %77, !dbg !2760

; <label>:77                                      ; preds = %.thread
  tail call void @klee_warning(i8* getelementptr inbounds ([24 x i8]* @.str7, i64 0, i64 0)) #10, !dbg !2762
  br label %78, !dbg !2762

; <label>:78                                      ; preds = %77, %.thread
  %79 = load %struct.exe_disk_file_t** %22, align 8, !dbg !2763, !tbaa !2573
  %80 = load %struct.exe_disk_file_t** @__exe_fs.2, align 8, !dbg !2763, !tbaa !2765
  %81 = icmp eq %struct.exe_disk_file_t* %79, %80, !dbg !2763
  br i1 %81, label %82, label %87, !dbg !2763

; <label>:82                                      ; preds = %78
  %83 = load i32* @__exe_fs.3, align 8, !dbg !2766, !tbaa !2767
  %84 = zext i32 %83 to i64, !dbg !2766
  %85 = add i64 %84, %actual_count.04, !dbg !2766
  %86 = trunc i64 %85 to i32, !dbg !2766
  store i32 %86, i32* @__exe_fs.3, align 8, !dbg !2766, !tbaa !2767
  br label %87, !dbg !2766

; <label>:87                                      ; preds = %82, %78
  %88 = load i64* %56, align 8, !dbg !2768, !tbaa !2683
  %89 = add i64 %88, %count, !dbg !2768
  store i64 %89, i64* %56, align 8, !dbg !2768, !tbaa !2683
...
; Function Attrs: nounwind uwtable
define internal fastcc void @__fd_stat(%struct.stat64.648* %buf) #9 {
.preheader.i:
  %0 = load i32* @__exe_fs.0, align 8, !dbg !2771, !tbaa !2558
  %1 = icmp eq i32 %0, 0, !dbg !2771
  br i1 %1, label %__get_sym_file.exit.thread, label %.lr.ph.i, !dbg !2771

; <label>:2                                       ; preds = %.lr.ph.i
  %3 = icmp ult i32 %5, %0, !dbg !2771
  br i1 %3, label %.lr.ph.i, label %__get_sym_file.exit.thread, !dbg !2771

.lr.ph.i:                                         ; preds = %.preheader.i, %2
  %i.02.i = phi i32 [ %5, %2 ], [ 0, %.preheader.i ]
  tail call void @klee_overshift_check(i64 32, i64 24) #10, !dbg !2773
  tail call void @klee_overshift_check(i64 32, i64 24) #10, !dbg !2773
  %sext.i.mask = and i32 %i.02.i, 255, !dbg !2773
  %4 = icmp eq i32 %sext.i.mask, 237, !dbg !2773
  %5 = add i32 %i.02.i, 1, !dbg !2771
  br i1 %4, label %6, label %2, !dbg !2773

; <label>:6                                       ; preds = %.lr.ph.i
  %7 = zext i32 %i.02.i to i64, !dbg !2774
  %8 = load %struct.exe_disk_file_t** @__exe_fs.4, align 8, !dbg !2774, !tbaa !2562
  %9 = getelementptr inbounds %struct.exe_disk_file_t* %8, i64 %7, i32 2, !dbg !2775
  %10 = load %struct.stat64.648** %9, align 8, !dbg !2775, !tbaa !2565
  %11 = getelementptr inbounds %struct.stat64.648* %10, i64 0, i32 1, !dbg !2775
  %12 = load i64* %11, align 8, !dbg !2775, !tbaa !2567
  %13 = icmp eq i64 %12, 0, !dbg !2775
  %14 = getelementptr inbounds %struct.exe_disk_file_t* %8, i64 %7, !dbg !2774
  %15 = icmp eq %struct.exe_disk_file_t* %14, null, !dbg !2776
  %or.cond = or i1 %13, %15, !dbg !2775
  br i1 %or.cond, label %__get_sym_file.exit.thread, label %16, !dbg !2775

; <label>:16                                      ; preds = %6
  %17 = bitcast %struct.stat64.648* %buf to i8*, !dbg !2778
  %18 = bitcast %struct.stat64.648* %10 to i8*, !dbg !2778
  %19 = call i8* @memcpy(i8* %17, i8* %18, i64 144)
  br label %48, !dbg !2780

__get_sym_file.exit.thread:                       ; preds = %2, %6, %.preheader.i
  %20 = tail call i64 @klee_get_valuel(i64 ptrtoint ([2 x i8]* @.str102 to i64)) #10, !dbg !2781
  %21 = inttoptr i64 %20 to i8*, !dbg !2781
  %22 = icmp eq i8* %21, getelementptr inbounds ([2 x i8]* @.str102, i64 0, i64 0), !dbg !2784
  %23 = zext i1 %22 to i64, !dbg !2784
  tail call void @klee_assume(i64 %23) #10, !dbg !2784
...
; <label>:24                                      ; preds = %41, %__get_sym_file.exit.thread
  ...
  %25 = load i8* %sc.0.i, align 1, !dbg !2786, !tbaa !2554
  %26 = add i32 %i.0.i, -1, !dbg !2787
  %27 = and i32 %26, %i.0.i, !dbg !2787
  %28 = icmp eq i32 %27, 0, !dbg !2787
  br i1 %28, label %29, label %33, !dbg !2787
...
; <label>:30                                      ; preds = %29
  store i8 0, i8* %sc.0.i, align 1, !dbg !2789, !tbaa !2554
  br label %__concretize_string.exit, !dbg !2790

; <label>:31                                      ; preds = %29
  %32 = getelementptr inbounds i8* %sc.0.i, i64 1, !dbg !2791
  store i8 47, i8* %sc.0.i, align 1, !dbg !2791, !tbaa !2554
  br label %41, !dbg !2792

; <label>:33                                      ; preds = %24
  %34 = sext i8 %25 to i64, !dbg !2793
  %35 = tail call i64 @klee_get_valuel(i64 %34) #10, !dbg !2793
  %36 = trunc i64 %35 to i8, !dbg !2793
  %37 = icmp eq i8 %36, %25, !dbg !2794
  %38 = zext i1 %37 to i64, !dbg !2794
  tail call void @klee_assume(i64 %38) #10, !dbg !2794
  %39 = getelementptr inbounds i8* %sc.0.i, i64 1, !dbg !2795
  store i8 %36, i8* %sc.0.i, align 1, !dbg !2795, !tbaa !2554
  %40 = icmp eq i8 %36, 0, !dbg !2796
  br i1 %40, label %__concretize_string.exit, label %41, !dbg !2796

; <label>:41                                      ; preds = %33, %31, %29
  %sc.1.i = phi i8* [ %39, %33 ], [ %32, %31 ], [ %sc.0.i, %29 ]
  %42 = add i32 %i.0.i, 1, !dbg !2785
  br label %24, !dbg !2785

__concretize_string.exit:                         ; preds = %33, %30
  %43 = tail call i64 (i64, ...)* @syscall(i64 4, i8* getelementptr inbounds ([2 x i8]* @.str102, i64 0, i64 0), %struct.stat64.648* %buf) #10, !dbg !2783
  %44 = trunc i64 %43 to i32, !dbg !2783
  %45 = icmp eq i32 %44, -1, !dbg !2797
  br i1 %45, label %46, label %48, !dbg !2797

; <label>:46                                      ; preds = %__concretize_string.exit
  %47 = tail call i32 @klee_get_errno() #10, !dbg !2799
  store i32 %47, i32* @errno, align 4, !dbg !2799, !tbaa !2548
  br label %48, !dbg !2799
...
; Function Attrs: nounwind uwtable
define internal fastcc i32 @__fd_fstat(i32 %fd, %struct.stat64.648* %buf) #9 {
...
; <label>:2                                       ; preds = %0
  ...
  %5 = load i32* %4, align 4, !dbg !2803, !tbaa !2537
...
__get_file.exit:                                  ; preds = %2
  ...
  br i1 %9, label %__get_file.exit.thread, label %10, !dbg !2804

__get_file.exit.thread:                           ; preds = %__get_file.exit, %2, %0
  store i32 9, i32* @errno, align 4, !dbg !2806, !tbaa !2548
  br label %28, !dbg !2808

; <label>:10                                      ; preds = %__get_file.exit
  %11 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, i32 3, !dbg !2809
  %12 = load %struct.exe_disk_file_t** %11, align 8, !dbg !2809, !tbaa !2573
  %13 = icmp eq %struct.exe_disk_file_t* %12, null, !dbg !2809
  br i1 %13, label %14, label %22, !dbg !2809

; <label>:14                                      ; preds = %10
  %15 = getelementptr inbounds %struct.exe_file_t* %8, i64 0, i32 0, !dbg !2810
  %16 = load i32* %15, align 8, !dbg !2810, !tbaa !2631
  %17 = tail call i64 (i64, ...)* @syscall(i64 5, i32 %16, %struct.stat64.648* %buf) #10, !dbg !2810
  %18 = trunc i64 %17 to i32, !dbg !2810
  %19 = icmp eq i32 %18, -1, !dbg !2811
  br i1 %19, label %20, label %28, !dbg !2811

; <label>:20                                      ; preds = %14
  %21 = tail call i32 @klee_get_errno() #10, !dbg !2813
  store i32 %21, i32* @errno, align 4, !dbg !2813, !tbaa !2548
  br label %28, !dbg !2813

; <label>:22                                      ; preds = %10
  %23 = bitcast %struct.stat64.648* %buf to i8*, !dbg !2814
  %24 = getelementptr inbounds %struct.exe_disk_file_t* %12, i64 0, i32 2, !dbg !2814
  %25 = load %struct.stat64.648** %24, align 8, !dbg !2814, !tbaa !2565
  %26 = bitcast %struct.stat64.648* %25 to i8*, !dbg !2814
...
define internal i32 @ioctl(i32 %fd, i64 %request, ...) #9 {
  ...
  %1 = icmp ult i32 %fd, 32, !dbg !2817
  br i1 %1, label %2, label %__get_file.exit.thread, !dbg !2817

; <label>:2                                       ; preds = %0
  %3 = sext i32 %fd to i64, !dbg !2819
  %4 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, i32 1, !dbg !2820
  %5 = load i32* %4, align 4, !dbg !2820, !tbaa !2537
  %6 = and i32 %5, 1, !dbg !2820
  %7 = icmp eq i32 %6, 0, !dbg !2820
  br i1 %7, label %__get_file.exit.thread, label %__get_file.exit, !dbg !2820

__get_file.exit:                                  ; preds = %2
  %8 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, !dbg !2819
  %9 = icmp eq %struct.exe_file_t* %8, null, !dbg !2821
  br i1 %9, label %__get_file.exit.thread, label %10, !dbg !2821

__get_file.exit.thread:                           ; preds = %__get_file.exit, %2, %0
  store i32 9, i32* @errno, align 4, !dbg !2823, !tbaa !2548
  br label %75, !dbg !2825

; <label>:10                                      ; preds = %__get_file.exit
  %11 = bitcast [1 x %struct.__va_list_tag.655]* %ap to i8*, !dbg !2826
  call void @llvm.va_start(i8* %11), !dbg !2826
  %12 = getelementptr inbounds [1 x %struct.__va_list_tag.655]* %ap, i64 0, i64 0, i32 0, !dbg !2827
  %13 = load i32* %12, align 16, !dbg !2827
  %14 = icmp ult i32 %13, 41, !dbg !2827
  br i1 %14, label %15, label %21, !dbg !2827

; <label>:15                                      ; preds = %10
  %16 = getelementptr inbounds [1 x %struct.__va_list_tag.655]* %ap, i64 0, i64 0, i32 3, !dbg !2827
  %17 = load i8** %16, align 16, !dbg !2827
  %18 = sext i32 %13 to i64, !dbg !2827
  %19 = getelementptr i8* %17, i64 %18, !dbg !2827
  %20 = add i32 %13, 8, !dbg !2827
  store i32 %20, i32* %12, align 16, !dbg !2827
  br label %25, !dbg !2827

; <label>:21                                      ; preds = %10
  %22 = getelementptr inbounds [1 x %struct.__va_list_tag.655]* %ap, i64 0, i64 0, i32 2, !dbg !2827
  %23 = load i8** %22, align 8, !dbg !2827
  %24 = getelementptr i8* %23, i64 8, !dbg !2827
  store i8* %24, i8** %22, align 8, !dbg !2827
  br label %25, !dbg !2827

; <label>:25                                      ; preds = %21, %15
  %.in = phi i8* [ %19, %15 ], [ %23, %21 ]
  %26 = bitcast i8* %.in to i8**, !dbg !2827
  %27 = load i8** %26, align 8, !dbg !2827
  call void @llvm.va_end(i8* %11), !dbg !2828
  %28 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, i32 3, !dbg !2829
  %29 = load %struct.exe_disk_file_t** %28, align 8, !dbg !2829, !tbaa !2573
  %30 = icmp eq %struct.exe_disk_file_t* %29, null, !dbg !2829
  br i1 %30, label %67, label %31, !dbg !2829

; <label>:31                                      ; preds = %25
  %32 = getelementptr inbounds %struct.exe_disk_file_t* %29, i64 0, i32 2, !dbg !2830
  %33 = load %struct.stat64.648** %32, align 8, !dbg !2830, !tbaa !2565
  call void @klee_warning_once(i8* getelementptr inbounds ([41 x i8]* @.str13, i64 0, i64 0)) #10, !dbg !2831
  %34 = getelementptr inbounds %struct.stat64.648* %33, i64 0, i32 3, !dbg !2832
  %35 = load i32* %34, align 4, !dbg !2832, !tbaa !2834
  %36 = and i32 %35, 61440, !dbg !2832
  %37 = icmp eq i32 %36, 8192, !dbg !2832
  br i1 %37, label %38, label %66, !dbg !2832

; <label>:38                                      ; preds = %31
  %39 = bitcast i8* %27 to i32*, !dbg !2836
  store i32 27906, i32* %39, align 4, !dbg !2836, !tbaa !2838
  %40 = getelementptr inbounds i8* %27, i64 4, !dbg !2840
  %41 = bitcast i8* %40 to i32*, !dbg !2840
  store i32 5, i32* %41, align 4, !dbg !2840, !tbaa !2841
  %42 = getelementptr inbounds i8* %27, i64 8, !dbg !2842
  %43 = bitcast i8* %42 to i32*, !dbg !2842
  store i32 1215, i32* %43, align 4, !dbg !2842, !tbaa !2843
  %44 = getelementptr inbounds i8* %27, i64 12, !dbg !2844
  %45 = bitcast i8* %44 to i32*, !dbg !2844
  store i32 35287, i32* %45, align 4, !dbg !2844, !tbaa !2845
  %46 = getelementptr inbounds i8* %27, i64 16, !dbg !2846
  store i8 0, i8* %46, align 1, !dbg !2846, !tbaa !2847
  %47 = getelementptr inbounds i8* %27, i64 17, !dbg !2848
  store i8 3, i8* %47, align 1, !dbg !2848, !tbaa !2554
  %48 = getelementptr inbounds i8* %27, i64 18, !dbg !2849
  store i8 28, i8* %48, align 1, !dbg !2849, !tbaa !2554
  %49 = getelementptr inbounds i8* %27, i64 19, !dbg !2850
  store i8 127, i8* %49, align 1, !dbg !2850, !tbaa !2554
  %50 = getelementptr inbounds i8* %27, i64 20, !dbg !2851
  store i8 21, i8* %50, align 1, !dbg !2851, !tbaa !2554
  %51 = getelementptr inbounds i8* %27, i64 21, !dbg !2852
  store i8 4, i8* %51, align 1, !dbg !2852, !tbaa !2554
  %52 = getelementptr inbounds i8* %27, i64 22, !dbg !2853
  store i8 0, i8* %52, align 1, !dbg !2853, !tbaa !2554
  %53 = getelementptr inbounds i8* %27, i64 23, !dbg !2854
  store i8 1, i8* %53, align 1, !dbg !2854, !tbaa !2554
  %54 = getelementptr inbounds i8* %27, i64 24, !dbg !2855
  store i8 -1, i8* %54, align 1, !dbg !2855, !tbaa !2554
  %55 = getelementptr inbounds i8* %27, i64 25, !dbg !2856
  store i8 17, i8* %55, align 1, !dbg !2856, !tbaa !2554
  %56 = getelementptr inbounds i8* %27, i64 26, !dbg !2857
  store i8 19, i8* %56, align 1, !dbg !2857, !tbaa !2554
  %57 = getelementptr inbounds i8* %27, i64 27, !dbg !2858
  store i8 26, i8* %57, align 1, !dbg !2858, !tbaa !2554
  %58 = getelementptr inbounds i8* %27, i64 28, !dbg !2859
  store i8 -1, i8* %58, align 1, !dbg !2859, !tbaa !2554
  %59 = getelementptr inbounds i8* %27, i64 29, !dbg !2860
  store i8 18, i8* %59, align 1, !dbg !2860, !tbaa !2554
  %60 = getelementptr inbounds i8* %27, i64 30, !dbg !2861
  store i8 15, i8* %60, align 1, !dbg !2861, !tbaa !2554
  %61 = getelementptr inbounds i8* %27, i64 31, !dbg !2862
  store i8 23, i8* %61, align 1, !dbg !2862, !tbaa !2554
  %62 = getelementptr inbounds i8* %27, i64 32, !dbg !2863
  store i8 22, i8* %62, align 1, !dbg !2863, !tbaa !2554
  %63 = getelementptr inbounds i8* %27, i64 33, !dbg !2864
  store i8 -1, i8* %63, align 1, !dbg !2864, !tbaa !2554
  %64 = getelementptr inbounds i8* %27, i64 34, !dbg !2865
  store i8 0, i8* %64, align 1, !dbg !2865, !tbaa !2554
  %65 = getelementptr inbounds i8* %27, i64 35, !dbg !2866
  store i8 0, i8* %65, align 1, !dbg !2866, !tbaa !2554
  br label %75, !dbg !2867

; <label>:66                                      ; preds = %31
  store i32 25, i32* @errno, align 4, !dbg !2868, !tbaa !2548
  br label %75, !dbg !2870

; <label>:67                                      ; preds = %25
  %68 = getelementptr inbounds %struct.exe_file_t* %8, i64 0, i32 0, !dbg !2871
  %69 = load i32* %68, align 8, !dbg !2871, !tbaa !2631
  %70 = call i64 (i64, ...)* @syscall(i64 16, i32 %69, i64 21505, i8* %27) #10, !dbg !2871
  %71 = trunc i64 %70 to i32, !dbg !2871
  %72 = icmp eq i32 %71, -1, !dbg !2872
  br i1 %72, label %73, label %75, !dbg !2872

; <label>:73                                      ; preds = %67
  %74 = call i32 @klee_get_errno() #10, !dbg !2874
  store i32 %74, i32* @errno, align 4, !dbg !2874, !tbaa !2548
  br label %75, !dbg !2874
...
define internal fastcc i32 @fcntl(i32 %fd) #9 {
  %1 = icmp ult i32 %fd, 32, !dbg !2876
  br i1 %1, label %2, label %__get_file.exit.thread, !dbg !2876

; <label>:2                                       ; preds = %0
  %3 = sext i32 %fd to i64, !dbg !2878
  %4 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, i32 1, !dbg !2879
  %5 = load i32* %4, align 4, !dbg !2879, !tbaa !2537
  %6 = and i32 %5, 1, !dbg !2879
  %7 = icmp eq i32 %6, 0, !dbg !2879
  br i1 %7, label %__get_file.exit.thread, label %__get_file.exit, !dbg !2879

__get_file.exit:                                  ; preds = %2
  %8 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, !dbg !2878
  %9 = icmp eq %struct.exe_file_t* %8, null, !dbg !2880
  br i1 %9, label %__get_file.exit.thread, label %10, !dbg !2880

__get_file.exit.thread:                           ; preds = %__get_file.exit, %2, %0
  store i32 9, i32* @errno, align 4, !dbg !2882, !tbaa !2548
  br label %25, !dbg !2884

; <label>:10                                      ; preds = %__get_file.exit
  %11 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, i32 3, !dbg !2885
  %12 = load %struct.exe_disk_file_t** %11, align 8, !dbg !2885, !tbaa !2573
  %13 = icmp eq %struct.exe_disk_file_t* %12, null, !dbg !2885
  br i1 %13, label %17, label %14, !dbg !2885

; <label>:14                                      ; preds = %10
  %15 = load i32* %4, align 4, !dbg !2886, !tbaa !2537
  call void @klee_overshift_check(i64 32, i64 1) #10, !dbg !2886
  %16 = lshr i32 %15, 1, !dbg !2886
  %.lobit = and i32 %16, 1, !dbg !2886
  br label %25, !dbg !2888

; <label>:17                                      ; preds = %10
  %18 = getelementptr inbounds %struct.exe_file_t* %8, i64 0, i32 0, !dbg !2889
  %19 = load i32* %18, align 8, !dbg !2889, !tbaa !2631
  %20 = call i64 (i64, ...)* @syscall(i64 72, i32 %19, i32 1, i32 0) #10, !dbg !2889
  %21 = trunc i64 %20 to i32, !dbg !2889
  %22 = icmp eq i32 %21, -1, !dbg !2890
  br i1 %22, label %23, label %25, !dbg !2890

; <label>:23                                      ; preds = %17
  %24 = call i32 @klee_get_errno() #10, !dbg !2892
  store i32 %24, i32* @errno, align 4, !dbg !2892, !tbaa !2548
  br label %25, !dbg !2892
...
; Function Attrs: nounwind uwtable
define internal i32 @open(i8* %pathname, i32 %flags, ...) #9 {
  %ap = alloca [1 x %struct.__va_list_tag.663], align 16
  %1 = and i32 %flags, 64, !dbg !2894
  %2 = icmp eq i32 %1, 0, !dbg !2894
  br i1 %2, label %21, label %3, !dbg !2894

; <label>:3                                       ; preds = %0
  %4 = bitcast [1 x %struct.__va_list_tag.663]* %ap to i8*, !dbg !2895
  call void @llvm.va_start(i8* %4), !dbg !2895
  %5 = getelementptr inbounds [1 x %struct.__va_list_tag.663]* %ap, i64 0, i64 0, i32 0, !dbg !2896
  %6 = load i32* %5, align 16, !dbg !2896
  %7 = icmp ult i32 %6, 41, !dbg !2896
  br i1 %7, label %8, label %14, !dbg !2896

; <label>:8                                       ; preds = %3
  %9 = getelementptr inbounds [1 x %struct.__va_list_tag.663]* %ap, i64 0, i64 0, i32 3, !dbg !2896
  %10 = load i8** %9, align 16, !dbg !2896
  %11 = sext i32 %6 to i64, !dbg !2896
  %12 = getelementptr i8* %10, i64 %11, !dbg !2896
  %13 = add i32 %6, 8, !dbg !2896
  store i32 %13, i32* %5, align 16, !dbg !2896
  br label %18, !dbg !2896

; <label>:14                                      ; preds = %3
  %15 = getelementptr inbounds [1 x %struct.__va_list_tag.663]* %ap, i64 0, i64 0, i32 2, !dbg !2896
  %16 = load i8** %15, align 8, !dbg !2896
  %17 = getelementptr i8* %16, i64 8, !dbg !2896
  store i8* %17, i8** %15, align 8, !dbg !2896
  br label %18, !dbg !2896

; <label>:18                                      ; preds = %14, %8
  %.in = phi i8* [ %12, %8 ], [ %16, %14 ]
  %19 = bitcast i8* %.in to i32*, !dbg !2896
  %20 = load i32* %19, align 4, !dbg !2896
  call void @llvm.va_end(i8* %4), !dbg !2897
  br label %21, !dbg !2898

; <label>:21                                      ; preds = %18, %0
  %mode.0 = phi i32 [ %20, %18 ], [ 0, %0 ]
  %22 = call fastcc i32 @__fd_open(i8* %pathname, i32 %flags, i32 %mode.0) #10, !dbg !2899
  ret i32 %22, !dbg !2899
}

; Function Attrs: inlinehint nounwind uwtable
define internal fastcc i32 @fstat(i32 %fd, %struct.stat.657* nocapture %buf) #12 {
  %tmp = alloca %struct.stat64.648, align 16
  %1 = bitcast %struct.stat64.648* %tmp to i8*, !dbg !2900
  %2 = call fastcc i32 @__fd_fstat(i32 %fd, %struct.stat64.648* %tmp) #10, !dbg !2901
  %3 = bitcast %struct.stat64.648* %tmp to <2 x i64>*, !dbg !2902
  %4 = load <2 x i64>* %3, align 16, !dbg !2902, !tbaa !2904
  %5 = bitcast %struct.stat.657* %buf to <2 x i64>*, !dbg !2902
  store <2 x i64> %4, <2 x i64>* %5, align 8, !dbg !2902, !tbaa !2904
  %6 = getelementptr inbounds %struct.stat64.648* %tmp, i64 0, i32 3, !dbg !2905
  %7 = bitcast i32* %6 to i64*, !dbg !2905
  %8 = load i64* %7, align 8, !dbg !2905
  %9 = trunc i64 %8 to i32, !dbg !2905
  %10 = getelementptr inbounds %struct.stat.657* %buf, i64 0, i32 3, !dbg !2905
  store i32 %9, i32* %10, align 4, !dbg !2905, !tbaa !2834
  %11 = getelementptr inbounds %struct.stat64.648* %tmp, i64 0, i32 2, !dbg !2906
  %12 = load i64* %11, align 16, !dbg !2906, !tbaa !2907
  %13 = getelementptr inbounds %struct.stat.657* %buf, i64 0, i32 2, !dbg !2906
  store i64 %12, i64* %13, align 8, !dbg !2906, !tbaa !2908
  call void @klee_overshift_check(i64 64, i64 32) #10
  %14 = lshr i64 %8, 32
  %15 = trunc i64 %14 to i32
  %16 = getelementptr inbounds %struct.stat.657* %buf, i64 0, i32 4, !dbg !2909
  store i32 %15, i32* %16, align 4, !dbg !2909, !tbaa !2910
  %17 = getelementptr inbounds %struct.stat64.648* %tmp, i64 0, i32 5, !dbg !2911
  %18 = load i32* %17, align 16, !dbg !2911, !tbaa !2912
  %19 = getelementptr inbounds %struct.stat.657* %buf, i64 0, i32 5, !dbg !2911
  store i32 %18, i32* %19, align 4, !dbg !2911, !tbaa !2913
  %20 = getelementptr inbounds %struct.stat64.648* %tmp, i64 0, i32 7, !dbg !2914
  %21 = getelementptr inbounds %struct.stat.657* %buf, i64 0, i32 7, !dbg !2914
  %22 = bitcast i64* %20 to <2 x i64>*, !dbg !2914
  %23 = load <2 x i64>* %22, align 8, !dbg !2914, !tbaa !2904
  %24 = bitcast i64* %21 to <2 x i64>*, !dbg !2914
  store <2 x i64> %23, <2 x i64>* %24, align 8, !dbg !2914, !tbaa !2904
  %25 = getelementptr inbounds %struct.stat64.648* %tmp, i64 0, i32 11, i32 0, !dbg !2915
  %26 = load i64* %25, align 8, !dbg !2915, !tbaa !2916
  %27 = getelementptr inbounds %struct.stat.657* %buf, i64 0, i32 11, i32 0, !dbg !2915
  store i64 %26, i64* %27, align 8, !dbg !2915, !tbaa !2917
  %28 = getelementptr inbounds %struct.stat64.648* %tmp, i64 0, i32 12, i32 0, !dbg !2918
  %29 = load i64* %28, align 8, !dbg !2918, !tbaa !2919
  %30 = getelementptr inbounds %struct.stat.657* %buf, i64 0, i32 12, i32 0, !dbg !2918
  store i64 %29, i64* %30, align 8, !dbg !2918, !tbaa !2920
  %31 = getelementptr inbounds %struct.stat64.648* %tmp, i64 0, i32 13, i32 0, !dbg !2921
  %32 = load i64* %31, align 8, !dbg !2921, !tbaa !2922
  %33 = getelementptr inbounds %struct.stat.657* %buf, i64 0, i32 13, i32 0, !dbg !2921
  store i64 %32, i64* %33, align 8, !dbg !2921, !tbaa !2923
  %34 = getelementptr inbounds %struct.stat64.648* %tmp, i64 0, i32 9, !dbg !2924
  %35 = getelementptr inbounds %struct.stat.657* %buf, i64 0, i32 9, !dbg !2924
  %36 = bitcast i64* %34 to <2 x i64>*, !dbg !2924
  %37 = load <2 x i64>* %36, align 8, !dbg !2924, !tbaa !2904
  %38 = bitcast i64* %35 to <2 x i64>*, !dbg !2924
  store <2 x i64> %37, <2 x i64>* %38, align 8, !dbg !2924, !tbaa !2904
  %39 = getelementptr inbounds %struct.stat64.648* %tmp, i64 0, i32 11, i32 1, !dbg !2925
  %40 = load i64* %39, align 8, !dbg !2925, !tbaa !2926
  %41 = getelementptr inbounds %struct.stat.657* %buf, i64 0, i32 11, i32 1, !dbg !2925
  store i64 %40, i64* %41, align 8, !dbg !2925, !tbaa !2927
  %42 = getelementptr inbounds %struct.stat64.648* %tmp, i64 0, i32 12, i32 1, !dbg !2928
  %43 = load i64* %42, align 8, !dbg !2928, !tbaa !2929
  %44 = getelementptr inbounds %struct.stat.657* %buf, i64 0, i32 12, i32 1, !dbg !2928
  store i64 %43, i64* %44, align 8, !dbg !2928, !tbaa !2930
  %45 = getelementptr inbounds %struct.stat64.648* %tmp, i64 0, i32 13, i32 1, !dbg !2931
  %46 = load i64* %45, align 8, !dbg !2931, !tbaa !2932
  %47 = getelementptr inbounds %struct.stat.657* %buf, i64 0, i32 13, i32 1, !dbg !2931
  store i64 %46, i64* %47, align 8, !dbg !2931, !tbaa !2933
  ret i32 %2, !dbg !2934
}

; Function Attrs: nounwind uwtable
define internal fastcc void @__xstat64(%struct.stat.665* %buf) #9 {
  %1 = bitcast %struct.stat.665* %buf to %struct.stat64.648*, !dbg !2935
  tail call fastcc void @__fd_stat(%struct.stat64.648* %1) #10, !dbg !2935
  ret void
}
...
define internal fastcc void @klee_init_fds(i32 %n_files, i32 %file_length, i32 %stdin_length, i32 %sym_stdout_flag, i32 %save_all_writes_flag, i32 %max_failures) #9 {
  ...
  %1 = getelementptr inbounds [7 x i8]* %name, i64 0, i64 0, !dbg !2936
  %2 = call i8* @memcpy(i8* %1, i8* getelementptr inbounds ([7 x i8]* @klee_init_fds.name, i64 0, i64 0), i64 7)
  %3 = bitcast %struct.stat64.648* %s to i8*, !dbg !2937
  %4 = bitcast %struct.stat64.648* %s to %struct.stat.665*, !dbg !2938
  call fastcc void @__xstat64(%struct.stat.665* %4) #10, !dbg !2938
  store i32 %n_files, i32* @__exe_fs.0, align 8, !dbg !2941, !tbaa !2558
  %5 = zext i32 %n_files to i64, !dbg !2942
  %6 = mul i64 %5, 24, !dbg !2942
  %7 = call noalias i8* @malloc(i64 %6) #10, !dbg !2942
  %8 = bitcast i8* %7 to %struct.exe_disk_file_t*, !dbg !2942
  store %struct.exe_disk_file_t* %8, %struct.exe_disk_file_t** @__exe_fs.4, align 8, !dbg !2942, !tbaa !2562
  %9 = icmp eq i32 %n_files, 0, !dbg !2943
  br i1 %9, label %._crit_edge, label %.lr.ph.preheader, !dbg !2943

.lr.ph.preheader:                                 ; preds = %0
  store i8 65, i8* %1, align 1, !dbg !2945, !tbaa !2554
  call fastcc void @__create_new_dfile(%struct.exe_disk_file_t* %8, i32 %file_length, i8* %1, %struct.stat64.648* %s), !dbg !2947
  %exitcond1 = icmp eq i32 %n_files, 1, !dbg !2943
  br i1 %exitcond1, label %._crit_edge, label %._crit_edge2, !dbg !2943

._crit_edge2:                                     ; preds = %.lr.ph.preheader, %._crit_edge2
  %indvars.iv.next2 = phi i64 [ %indvars.iv.next, %._crit_edge2 ], [ 1, %.lr.ph.preheader ]
  %.pre = load %struct.exe_disk_file_t** @__exe_fs.4, align 8, !dbg !2947, !tbaa !2562
  %10 = trunc i64 %indvars.iv.next2 to i8, !dbg !2945
  %11 = add i8 %10, 65, !dbg !2945
  store i8 %11, i8* %1, align 1, !dbg !2945, !tbaa !2554
  %12 = getelementptr inbounds %struct.exe_disk_file_t* %.pre, i64 %indvars.iv.next2, !dbg !2947
  call fastcc void @__create_new_dfile(%struct.exe_disk_file_t* %12, i32 %file_length, i8* %1, %struct.stat64.648* %s), !dbg !2947
  %indvars.iv.next = add nuw nsw i64 %indvars.iv.next2, 1, !dbg !2943
  %lftr.wideiv3 = trunc i64 %indvars.iv.next to i32, !dbg !2943
  %exitcond4 = icmp eq i32 %lftr.wideiv3, %n_files, !dbg !2943
  br i1 %exitcond4, label %._crit_edge, label %._crit_edge2, !dbg !2943

._crit_edge:                                      ; preds = %._crit_edge2, %.lr.ph.preheader, %0
  %13 = icmp eq i32 %stdin_length, 0, !dbg !2948
  br i1 %13, label %18, label %14, !dbg !2948

; <label>:14                                      ; preds = %._crit_edge
  %15 = call noalias i8* @malloc(i64 24) #10, !dbg !2950
  %16 = bitcast i8* %15 to %struct.exe_disk_file_t*, !dbg !2950
  store %struct.exe_disk_file_t* %16, %struct.exe_disk_file_t** @__exe_fs.1, align 8, !dbg !2950, !tbaa !2952
  call fastcc void @__create_new_dfile(%struct.exe_disk_file_t* %16, i32 %stdin_length, i8* getelementptr inbounds ([6 x i8]* @.str1105, i64 0, i64 0), %struct.stat64.648* %s), !dbg !2953
  %17 = load %struct.exe_disk_file_t** @__exe_fs.1, align 8, !dbg !2954, !tbaa !2952
  store %struct.exe_disk_file_t* %17, %struct.exe_disk_file_t** getelementptr inbounds ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env, i64 0, i32 0, i64 0, i32 3), align 8, !dbg !2954, !tbaa !2573
  br label %19, !dbg !2955

; <label>:18                                      ; preds = %._crit_edge
  store %struct.exe_disk_file_t* null, %struct.exe_disk_file_t** @__exe_fs.1, align 8, !dbg !2956, !tbaa !2952
  br label %19

; <label>:19                                      ; preds = %18, %14
  store i32 %max_failures, i32* @__exe_fs.5, align 8, !dbg !2957, !tbaa !2665
  %20 = icmp eq i32 %max_failures, 0, !dbg !2958
  br i1 %20, label %40, label %21, !dbg !2958

; <label>:21                                      ; preds = %19
  %22 = call noalias i8* @malloc(i64 4) #10, !dbg !2960
  %23 = bitcast i8* %22 to i32*, !dbg !2960
  store i32* %23, i32** @__exe_fs.6, align 8, !dbg !2960, !tbaa !2666
  %24 = call noalias i8* @malloc(i64 4) #10, !dbg !2962
  %25 = bitcast i8* %24 to i32*, !dbg !2962
  store i32* %25, i32** @__exe_fs.7, align 8, !dbg !2962, !tbaa !2719
  %26 = call noalias i8* @malloc(i64 4) #10, !dbg !2963
  %27 = bitcast i8* %26 to i32*, !dbg !2963
  store i32* %27, i32** @__exe_fs.8, align 8, !dbg !2963, !tbaa !2964
  %28 = call noalias i8* @malloc(i64 4) #10, !dbg !2965
  %29 = bitcast i8* %28 to i32*, !dbg !2965
  store i32* %29, i32** @__exe_fs.9, align 8, !dbg !2965, !tbaa !2966
  %30 = call noalias i8* @malloc(i64 4) #10, !dbg !2967
  %31 = bitcast i8* %30 to i32*, !dbg !2967
  store i32* %31, i32** @__exe_fs.10, align 8, !dbg !2967, !tbaa !2968
  call void @klee_make_symbolic(i8* %22, i64 4, i8* getelementptr inbounds ([10 x i8]* @.str2106, i64 0, i64 0)) #10, !dbg !2969
  %32 = load i32** @__exe_fs.7, align 8, !dbg !2970, !tbaa !2719
  %33 = bitcast i32* %32 to i8*, !dbg !2970
  call void @klee_make_symbolic(i8* %33, i64 4, i8* getelementptr inbounds ([11 x i8]* @.str3107, i64 0, i64 0)) #10, !dbg !2970
  %34 = load i32** @__exe_fs.8, align 8, !dbg !2971, !tbaa !2964
  %35 = bitcast i32* %34 to i8*, !dbg !2971
  call void @klee_make_symbolic(i8* %35, i64 4, i8* getelementptr inbounds ([11 x i8]* @.str4108, i64 0, i64 0)) #10, !dbg !2971
  %36 = load i32** @__exe_fs.9, align 8, !dbg !2972, !tbaa !2966
  %37 = bitcast i32* %36 to i8*, !dbg !2972
  call void @klee_make_symbolic(i8* %37, i64 4, i8* getelementptr inbounds ([15 x i8]* @.str5109, i64 0, i64 0)) #10, !dbg !2972
  %38 = load i32** @__exe_fs.10, align 8, !dbg !2973, !tbaa !2968
  %39 = bitcast i32* %38 to i8*, !dbg !2973
  call void @klee_make_symbolic(i8* %39, i64 4, i8* getelementptr inbounds ([12 x i8]* @.str6110, i64 0, i64 0)) #10, !dbg !2973
  br label %40, !dbg !2974

; <label>:40                                      ; preds = %21, %19
  %41 = icmp eq i32 %sym_stdout_flag, 0, !dbg !2975
  br i1 %41, label %46, label %42, !dbg !2975

; <label>:42                                      ; preds = %40
  %43 = call noalias i8* @malloc(i64 24) #10, !dbg !2977
  %44 = bitcast i8* %43 to %struct.exe_disk_file_t*, !dbg !2977
  store %struct.exe_disk_file_t* %44, %struct.exe_disk_file_t** @__exe_fs.2, align 8, !dbg !2977, !tbaa !2765
  call fastcc void @__create_new_dfile(%struct.exe_disk_file_t* %44, i32 1024, i8* getelementptr inbounds ([7 x i8]* @.str7111, i64 0, i64 0), %struct.stat64.648* %s), !dbg !2979
  %45 = load %struct.exe_disk_file_t** @__exe_fs.2, align 8, !dbg !2980, !tbaa !2765
  store %struct.exe_disk_file_t* %45, %struct.exe_disk_file_t** getelementptr inbounds ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env, i64 0, i32 0, i64 1, i32 3), align 8, !dbg !2980, !tbaa !2573
  store i32 0, i32* @__exe_fs.3, align 8, !dbg !2981, !tbaa !2767
  br label %47, !dbg !2982

; <label>:46                                      ; preds = %40
  store %struct.exe_disk_file_t* null, %struct.exe_disk_file_t** @__exe_fs.2, align 8, !dbg !2983, !tbaa !2765
  br label %47

; <label>:47                                      ; preds = %46, %42
  store i32 %save_all_writes_flag, i32* getelementptr inbounds ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env, i64 0, i32 3), align 8, !dbg !2984, !tbaa !2751
  %48 = bitcast i32* %x.i to i8*, !dbg !2985
  call void @klee_make_symbolic(i8* %48, i64 4, i8* getelementptr inbounds ([14 x i8]* @.str8112, i64 0, i64 0)) #10, !dbg !2987
  %49 = load i32* %x.i, align 4, !dbg !2988, !tbaa !2548
  store i32 %49, i32* getelementptr inbounds ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env, i64 0, i32 2), align 4, !dbg !2986, !tbaa !2989
  %50 = icmp eq i32 %49, 1, !dbg !2990
  %51 = zext i1 %50 to i64, !dbg !2990
  call void @klee_assume(i64 %51) #10, !dbg !2990
  ret void, !dbg !2991
}
...
; Function Attrs: nounwind uwtable
define internal fastcc void @__create_new_dfile(%struct.exe_disk_file_t* nocapture %dfile, i32 %size, i8* %name, %struct.stat64.648* nocapture readonly %defaults) #9 {
  %sname = alloca [64 x i8], align 16
  %1 = call noalias i8* @malloc(i64 144) #10, !dbg !2992
  %2 = bitcast i8* %1 to %struct.stat64.648*, !dbg !2992
  %3 = getelementptr inbounds [64 x i8]* %sname, i64 0, i64 0, !dbg !2993
  %4 = load i8* %name, align 1, !dbg !2994, !tbaa !2554
  %5 = icmp eq i8 %4, 0, !dbg !2994
  %6 = ptrtoint i8* %name to i64, !dbg !2996
  br i1 %5, label %._crit_edge, label %.lr.ph, !dbg !2994

.lr.ph:                                           ; preds = %0, %.lr.ph
  %7 = phi i8* [ %14, %.lr.ph ], [ %3, %0 ]
  %8 = phi i8 [ %10, %.lr.ph ], [ %4, %0 ]
  %sp.01 = phi i8* [ %9, %.lr.ph ], [ %name, %0 ]
  store i8 %8, i8* %7, align 1, !dbg !2997, !tbaa !2554
  %9 = getelementptr inbounds i8* %sp.01, i64 1, !dbg !2994
  %10 = load i8* %9, align 1, !dbg !2994, !tbaa !2554
  %11 = icmp eq i8 %10, 0, !dbg !2994
  %12 = ptrtoint i8* %9 to i64, !dbg !2996
  %13 = sub i64 %12, %6, !dbg !2996
  %14 = getelementptr inbounds [64 x i8]* %sname, i64 0, i64 %13, !dbg !2996
  br i1 %11, label %._crit_edge, label %.lr.ph, !dbg !2994

._crit_edge:                                      ; preds = %.lr.ph, %0
  %.lcssa = phi i8* [ %3, %0 ], [ %14, %.lr.ph ]
  %15 = call i8* @memcpy(i8* %.lcssa, i8* getelementptr inbounds ([6 x i8]* @.str9113, i64 0, i64 0), i64 6)
  %16 = icmp eq i32 %size, 0, !dbg !2998
  br i1 %16, label %17, label %18, !dbg !2998
...
; <label>:18                                      ; preds = %._crit_edge
  %19 = getelementptr inbounds %struct.exe_disk_file_t* %dfile, i64 0, i32 0, !dbg !2999
  store i32 %size, i32* %19, align 4, !dbg !2999, !tbaa !2697
  %20 = zext i32 %size to i64, !dbg !3000
  %21 = call noalias i8* @malloc(i64 %20) #10, !dbg !3000
  %22 = getelementptr inbounds %struct.exe_disk_file_t* %dfile, i64 0, i32 1, !dbg !3000
  store i8* %21, i8** %22, align 8, !dbg !3000, !tbaa !2703
  call void @klee_make_symbolic(i8* %21, i64 %20, i8* %name) #10, !dbg !3001
  call void @klee_make_symbolic(i8* %1, i64 144, i8* %3) #10, !dbg !3002
  %23 = getelementptr inbounds i8* %1, i64 8, !dbg !3003
  %24 = bitcast i8* %23 to i64*, !dbg !3003
  %25 = load i64* %24, align 8, !dbg !3003, !tbaa !2567
  %26 = call i32 @klee_is_symbolic(i64 %25) #10, !dbg !3003
  %27 = icmp eq i32 %26, 0, !dbg !3003
  %28 = load i64* %24, align 8, !dbg !3003, !tbaa !2567
  %29 = and i64 %28, 2147483647, !dbg !3003
  %30 = icmp eq i64 %29, 0, !dbg !3003
  %or.cond = and i1 %27, %30, !dbg !3003
  br i1 %or.cond, label %31, label %._crit_edge3, !dbg !3003

; <label>:31                                      ; preds = %18
  %32 = getelementptr inbounds %struct.stat64.648* %defaults, i64 0, i32 1, !dbg !3005
  %33 = load i64* %32, align 8, !dbg !3005, !tbaa !2567
  store i64 %33, i64* %24, align 8, !dbg !3005, !tbaa !2567
  br label %._crit_edge3, !dbg !3005

._crit_edge3:                                     ; preds = %31, %18
  %34 = phi i64 [ %33, %31 ], [ %28, %18 ]
  %35 = and i64 %34, 2147483647, !dbg !3006
  %36 = icmp ne i64 %35, 0, !dbg !3006
  %37 = zext i1 %36 to i64, !dbg !3006
  call void @klee_assume(i64 %37) #10, !dbg !3006
  %38 = getelementptr inbounds i8* %1, i64 56, !dbg !3007
  %39 = bitcast i8* %38 to i64*, !dbg !3007
  %40 = load i64* %39, align 8, !dbg !3007, !tbaa !3008
  %41 = icmp ult i64 %40, 65536, !dbg !3007
  %42 = zext i1 %41 to i64, !dbg !3007
  call void @klee_assume(i64 %42) #10, !dbg !3007
  %43 = getelementptr inbounds i8* %1, i64 24, !dbg !3009
  %44 = bitcast i8* %43 to i32*, !dbg !3009
  %45 = load i32* %44, align 4, !dbg !3009, !tbaa !2587
  %46 = and i32 %45, -61952, !dbg !3009
  %47 = icmp eq i32 %46, 0, !dbg !3009
  %48 = zext i1 %47 to i64, !dbg !3009
  call void @klee_posix_prefer_cex(i8* %1, i64 %48) #10, !dbg !3009
  %49 = bitcast i8* %1 to i64*, !dbg !3010
  %50 = load i64* %49, align 8, !dbg !3010, !tbaa !3011
  %51 = getelementptr inbounds %struct.stat64.648* %defaults, i64 0, i32 0, !dbg !3010
  %52 = load i64* %51, align 8, !dbg !3010, !tbaa !3011
  %53 = icmp eq i64 %50, %52, !dbg !3010
  %54 = zext i1 %53 to i64, !dbg !3010
  call void @klee_posix_prefer_cex(i8* %1, i64 %54) #10, !dbg !3010
  %55 = getelementptr inbounds i8* %1, i64 40, !dbg !3012
  %56 = bitcast i8* %55 to i64*, !dbg !3012
  %57 = load i64* %56, align 8, !dbg !3012, !tbaa !3013
  %58 = getelementptr inbounds %struct.stat64.648* %defaults, i64 0, i32 7, !dbg !3012
  %59 = load i64* %58, align 8, !dbg !3012, !tbaa !3013
  %60 = icmp eq i64 %57, %59, !dbg !3012
  %61 = zext i1 %60 to i64, !dbg !3012
  call void @klee_posix_prefer_cex(i8* %1, i64 %61) #10, !dbg !3012
  %62 = load i32* %44, align 4, !dbg !3014, !tbaa !2587
  %63 = and i32 %62, 448, !dbg !3014
  %64 = icmp eq i32 %63, 384, !dbg !3014
  %65 = zext i1 %64 to i64, !dbg !3014
  call void @klee_posix_prefer_cex(i8* %1, i64 %65) #10, !dbg !3014
  %66 = load i32* %44, align 4, !dbg !3015, !tbaa !2587
  %67 = and i32 %66, 56, !dbg !3015
  %68 = icmp eq i32 %67, 16, !dbg !3015
  %69 = zext i1 %68 to i64, !dbg !3015
  call void @klee_posix_prefer_cex(i8* %1, i64 %69) #10, !dbg !3015
  %70 = load i32* %44, align 4, !dbg !3016, !tbaa !2587
  %71 = and i32 %70, 7, !dbg !3016
  %72 = icmp eq i32 %71, 2, !dbg !3016
  %73 = zext i1 %72 to i64, !dbg !3016
  call void @klee_posix_prefer_cex(i8* %1, i64 %73) #10, !dbg !3016
  %74 = load i32* %44, align 4, !dbg !3017, !tbaa !2587
  %75 = and i32 %74, 61440, !dbg !3017
  %76 = icmp eq i32 %75, 32768, !dbg !3017
  %77 = zext i1 %76 to i64, !dbg !3017
  call void @klee_posix_prefer_cex(i8* %1, i64 %77) #10, !dbg !3017
  %78 = getelementptr inbounds i8* %1, i64 16, !dbg !3018
  %79 = bitcast i8* %78 to i64*, !dbg !3018
  %80 = load i64* %79, align 8, !dbg !3018, !tbaa !2907
  %81 = icmp eq i64 %80, 1, !dbg !3018
  %82 = zext i1 %81 to i64, !dbg !3018
  call void @klee_posix_prefer_cex(i8* %1, i64 %82) #10, !dbg !3018
  %83 = getelementptr inbounds i8* %1, i64 28, !dbg !3019
  %84 = bitcast i8* %83 to i32*, !dbg !3019
  %85 = load i32* %84, align 4, !dbg !3019, !tbaa !3020
  %86 = getelementptr inbounds %struct.stat64.648* %defaults, i64 0, i32 4, !dbg !3019
  %87 = load i32* %86, align 4, !dbg !3019, !tbaa !3020
  %88 = icmp eq i32 %85, %87, !dbg !3019
  %89 = zext i1 %88 to i64, !dbg !3019
  call void @klee_posix_prefer_cex(i8* %1, i64 %89) #10, !dbg !3019
  %90 = getelementptr inbounds i8* %1, i64 32, !dbg !3021
  %91 = bitcast i8* %90 to i32*, !dbg !3021
  %92 = load i32* %91, align 4, !dbg !3021, !tbaa !2912
  %93 = getelementptr inbounds %struct.stat64.648* %defaults, i64 0, i32 5, !dbg !3021
  %94 = load i32* %93, align 4, !dbg !3021, !tbaa !2912
  %95 = icmp eq i32 %92, %94, !dbg !3021
  %96 = zext i1 %95 to i64, !dbg !3021
  call void @klee_posix_prefer_cex(i8* %1, i64 %96) #10, !dbg !3021
  %97 = load i64* %39, align 8, !dbg !3022, !tbaa !3008
  %98 = icmp eq i64 %97, 4096, !dbg !3022
  %99 = zext i1 %98 to i64, !dbg !3022
  call void @klee_posix_prefer_cex(i8* %1, i64 %99) #10, !dbg !3022
  %100 = getelementptr inbounds i8* %1, i64 72, !dbg !3023
  %101 = bitcast i8* %100 to i64*, !dbg !3023
  %102 = load i64* %101, align 8, !dbg !3023, !tbaa !2916
  %103 = getelementptr inbounds %struct.stat64.648* %defaults, i64 0, i32 11, i32 0, !dbg !3023
  %104 = load i64* %103, align 8, !dbg !3023, !tbaa !2916
  %105 = icmp eq i64 %102, %104, !dbg !3023
  %106 = zext i1 %105 to i64, !dbg !3023
  call void @klee_posix_prefer_cex(i8* %1, i64 %106) #10, !dbg !3023
  %107 = getelementptr inbounds i8* %1, i64 88, !dbg !3024
  %108 = bitcast i8* %107 to i64*, !dbg !3024
  %109 = load i64* %108, align 8, !dbg !3024, !tbaa !2919
  %110 = getelementptr inbounds %struct.stat64.648* %defaults, i64 0, i32 12, i32 0, !dbg !3024
  %111 = load i64* %110, align 8, !dbg !3024, !tbaa !2919
  %112 = icmp eq i64 %109, %111, !dbg !3024
  %113 = zext i1 %112 to i64, !dbg !3024
  call void @klee_posix_prefer_cex(i8* %1, i64 %113) #10, !dbg !3024
  %114 = getelementptr inbounds i8* %1, i64 104, !dbg !3025
  %115 = bitcast i8* %114 to i64*, !dbg !3025
  %116 = load i64* %115, align 8, !dbg !3025, !tbaa !2922
  %117 = getelementptr inbounds %struct.stat64.648* %defaults, i64 0, i32 13, i32 0, !dbg !3025
  %118 = load i64* %117, align 8, !dbg !3025, !tbaa !2922
  %119 = icmp eq i64 %116, %118, !dbg !3025
  %120 = zext i1 %119 to i64, !dbg !3025
  call void @klee_posix_prefer_cex(i8* %1, i64 %120) #10, !dbg !3025
  %121 = load i32* %19, align 4, !dbg !3026, !tbaa !2697
  %122 = zext i32 %121 to i64, !dbg !3026
  %123 = getelementptr inbounds i8* %1, i64 48, !dbg !3026
  %124 = bitcast i8* %123 to i64*, !dbg !3026
  store i64 %122, i64* %124, align 8, !dbg !3026, !tbaa !3027
  %125 = getelementptr inbounds i8* %1, i64 64, !dbg !3028
  %126 = bitcast i8* %125 to i64*, !dbg !3028
  store i64 8, i64* %126, align 8, !dbg !3028, !tbaa !3029
  %127 = getelementptr inbounds %struct.exe_disk_file_t* %dfile, i64 0, i32 2, !dbg !3030
  store %struct.stat64.648* %2, %struct.stat64.648** %127, align 8, !dbg !3030, !tbaa !2565
  ret void, !dbg !3031
}
...
define internal fastcc void @klee_init_env(i32* nocapture %argcPtr, i8*** nocapture %argvPtr) #9 {
  ...
  %1 = load i32* %argcPtr, align 4, !dbg !3032, !tbaa !2548
  %2 = load i8*** %argvPtr, align 8, !dbg !3033, !tbaa !3034
  %3 = bitcast [1024 x i8*]* %new_argv to i8*, !dbg !3035
  %4 = getelementptr inbounds [5 x i8]* %sym_arg_name, i64 0, i64 0, !dbg !3036
  %5 = bitcast [5 x i8]* %sym_arg_name to i32*, !dbg !3036
  store i32 6779489, i32* %5, align 4, !dbg !3036
  %6 = getelementptr inbounds [5 x i8]* %sym_arg_name, i64 0, i64 4, !dbg !3037
  store i8 0, i8* %6, align 4, !dbg !3037, !tbaa !2554
  %7 = icmp eq i32 %1, 2, !dbg !3038
  br i1 %7, label %8, label %__streq.exit.thread.preheader, !dbg !3038

; <label>:8                                       ; preds = %0
  %9 = getelementptr inbounds i8** %2, i64 1, !dbg !3038
  %10 = load i8** %9, align 8, !dbg !3038, !tbaa !3034
  %11 = load i8* %10, align 1, !dbg !3040, !tbaa !2554
  %12 = icmp eq i8 %11, 45, !dbg !3040
  br i1 %12, label %.lr.ph.i, label %.lr.ph410, !dbg !3040

.lr.ph.i:                                         ; preds = %8, %15
  %13 = phi i8 [ %18, %15 ], [ 45, %8 ]
  %.04.i = phi i8* [ %17, %15 ], [ getelementptr inbounds ([7 x i8]* @.str116, i64 0, i64 0), %8 ]
  %.013.i = phi i8* [ %16, %15 ], [ %10, %8 ]
  %14 = icmp eq i8 %13, 0, !dbg !3041
  br i1 %14, label %23, label %15, !dbg !3041

; <label>:15                                      ; preds = %.lr.ph.i
  %16 = getelementptr inbounds i8* %.013.i, i64 1, !dbg !3044
  %17 = getelementptr inbounds i8* %.04.i, i64 1, !dbg !3045
  %18 = load i8* %16, align 1, !dbg !3040, !tbaa !2554
  %19 = load i8* %17, align 1, !dbg !3040, !tbaa !2554
  %20 = icmp eq i8 %18, %19, !dbg !3040
  br i1 %20, label %.lr.ph.i, label %__streq.exit.thread.preheader, !dbg !3040

__streq.exit.thread.preheader:                    ; preds = %15, %0
  %21 = icmp sgt i32 %1, 0, !dbg !3046
  br i1 %21, label %.lr.ph410, label %__streq.exit.thread._crit_edge, !dbg !3046

.lr.ph410:                                        ; preds = %__streq.exit.thread.preheader, %8
  %22 = getelementptr inbounds [5 x i8]* %sym_arg_name, i64 0, i64 3, !dbg !3047
  br label %24, !dbg !3046

; <label>:23                                      ; preds = %.lr.ph.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([964 x i8]* @.str1117, i64 0, i64 0)), !dbg !3048
  unreachable
...
; <label>:24                                      ; preds = %__streq.exit.thread.backedge, %.lr.ph410
  ...
  %26 = sext i32 %k.0369 to i64, !dbg !3050
  %27 = getelementptr inbounds i8** %2, i64 %26, !dbg !3050
  %28 = load i8** %27, align 8, !dbg !3050, !tbaa !3034
  %29 = load i8* %28, align 1, !dbg !3051, !tbaa !2554
  %30 = icmp eq i8 %29, 45, !dbg !3051
  br i1 %30, label %.lr.ph.i7, label %.loopexit162, !dbg !3051
...
.lr.ph.i7:                                        ; preds = %24, %33
  ...
  %32 = icmp eq i8 %31, 0, !dbg !3052
  br i1 %32, label %__streq.exit9.thread124, label %33, !dbg !3052

; <label>:33                                      ; preds = %.lr.ph.i7
  %34 = getelementptr inbounds i8* %.013.i6, i64 1, !dbg !3053
  %35 = getelementptr inbounds i8* %.04.i5, i64 1, !dbg !3054
  %36 = load i8* %34, align 1, !dbg !3051, !tbaa !2554
  %37 = load i8* %35, align 1, !dbg !3051, !tbaa !2554
  %38 = icmp eq i8 %36, %37, !dbg !3051
  br i1 %38, label %.lr.ph.i7, label %.lr.ph.i13, !dbg !3051
...
.lr.ph.i13:                                       ; preds = %33, %41
  ...
  %40 = icmp eq i8 %39, 0, !dbg !3052
  br i1 %40, label %__streq.exit9.thread124, label %41, !dbg !3052

; <label>:41                                      ; preds = %.lr.ph.i13
  %42 = getelementptr inbounds i8* %.013.i12, i64 1, !dbg !3053
  %43 = getelementptr inbounds i8* %.04.i11, i64 1, !dbg !3054
  %44 = load i8* %42, align 1, !dbg !3051, !tbaa !2554
  %45 = load i8* %43, align 1, !dbg !3051, !tbaa !2554
  %46 = icmp eq i8 %44, %45, !dbg !3051
  br i1 %46, label %.lr.ph.i13, label %.lr.ph.i24, !dbg !3051

__streq.exit9.thread124:                          ; preds = %.lr.ph.i13, %.lr.ph.i7
  %47 = add nsw i32 %k.0369, 1, !dbg !3055
  %48 = icmp eq i32 %47, %1, !dbg !3055
  br i1 %48, label %49, label %50, !dbg !3055

; <label>:49                                      ; preds = %__streq.exit9.thread124
  call fastcc void @__emit_error(i8* getelementptr inbounds ([48 x i8]* @.str4120, i64 0, i64 0)), !dbg !3057
  unreachable

; <label>:50                                      ; preds = %__streq.exit9.thread124
  %51 = add nsw i32 %k.0369, 2, !dbg !3058
  %52 = sext i32 %47 to i64, !dbg !3058
  %53 = getelementptr inbounds i8** %2, i64 %52, !dbg !3058
  %54 = load i8** %53, align 8, !dbg !3058, !tbaa !3034
  %55 = load i8* %54, align 1, !dbg !3059, !tbaa !2554
  %56 = icmp eq i8 %55, 0, !dbg !3059
  br i1 %56, label %57, label %.lr.ph.i19, !dbg !3059

; <label>:57                                      ; preds = %50
  call fastcc void @__emit_error(i8* getelementptr inbounds ([48 x i8]* @.str4120, i64 0, i64 0)) #10, !dbg !3059
  unreachable
...
.lr.ph.i19:                                       ; preds = %50, %61
  ...
  %59 = getelementptr inbounds i8* %s.pn.i16, i64 1, !dbg !3061
  %.off.i18 = add i8 %58, -48, !dbg !3062
  %60 = icmp ult i8 %.off.i18, 10, !dbg !3062
  br i1 %60, label %61, label %68, !dbg !3062

; <label>:61                                      ; preds = %.lr.ph.i19
  %62 = sext i8 %58 to i64, !dbg !3066
  %63 = mul nsw i64 %res.02.i17, 10, !dbg !3067
  %64 = add i64 %62, -48, !dbg !3067
  %65 = add i64 %64, %63, !dbg !3067
  %66 = load i8* %59, align 1, !dbg !3061, !tbaa !2554
  %67 = icmp eq i8 %66, 0, !dbg !3061
  br i1 %67, label %__str_to_int.exit20, label %.lr.ph.i19, !dbg !3061

; <label>:68                                      ; preds = %.lr.ph.i19
  call fastcc void @__emit_error(i8* getelementptr inbounds ([48 x i8]* @.str4120, i64 0, i64 0)) #10, !dbg !3069
  unreachable

__str_to_int.exit20:                              ; preds = %61
  %69 = trunc i64 %65 to i32, !dbg !3058
  %70 = add i32 %sym_arg_num.0360, 48, !dbg !3047
  %71 = trunc i32 %70 to i8, !dbg !3047
  store i8 %71, i8* %22, align 1, !dbg !3047, !tbaa !2554
  %72 = call fastcc i8* @__get_sym_str(i32 %69, i8* %4), !dbg !3071
  %73 = icmp eq i32 %25, 1024, !dbg !3072
  br i1 %73, label %74, label %__add_arg.exit21, !dbg !3072

; <label>:74                                      ; preds = %__str_to_int.exit20
  call fastcc void @__emit_error(i8* getelementptr inbounds ([37 x i8]* @.str24140, i64 0, i64 0)) #10, !dbg !3075
  unreachable

__add_arg.exit21:                                 ; preds = %__str_to_int.exit20
  %75 = add i32 %sym_arg_num.0360, 1, !dbg !3047
  %76 = sext i32 %25 to i64, !dbg !3077
  %77 = getelementptr inbounds [1024 x i8*]* %new_argv, i64 0, i64 %76, !dbg !3077
  store i8* %72, i8** %77, align 8, !dbg !3077, !tbaa !3034
  %78 = add nsw i32 %25, 1, !dbg !3079
  br label %__streq.exit.thread.backedge, !dbg !3080
...
.lr.ph.i24:                                       ; preds = %41, %81
  ...
  %80 = icmp eq i8 %79, 0, !dbg !3081
  br i1 %80, label %__streq.exit26.thread126, label %81, !dbg !3081

; <label>:81                                      ; preds = %.lr.ph.i24
  %82 = getelementptr inbounds i8* %.013.i23, i64 1, !dbg !3083
  %83 = getelementptr inbounds i8* %.04.i22, i64 1, !dbg !3084
  %84 = load i8* %82, align 1, !dbg !3085, !tbaa !2554
  %85 = load i8* %83, align 1, !dbg !3085, !tbaa !2554
  %86 = icmp eq i8 %84, %85, !dbg !3085
  br i1 %86, label %.lr.ph.i24, label %.lr.ph.i29, !dbg !3085
...
.lr.ph.i29:                                       ; preds = %81, %89
  ...
  %88 = icmp eq i8 %87, 0, !dbg !3081
  br i1 %88, label %__streq.exit26.thread126, label %89, !dbg !3081

; <label>:89                                      ; preds = %.lr.ph.i29
  %90 = getelementptr inbounds i8* %.013.i28, i64 1, !dbg !3083
  %91 = getelementptr inbounds i8* %.04.i27, i64 1, !dbg !3084
  %92 = load i8* %90, align 1, !dbg !3085, !tbaa !2554
  %93 = load i8* %91, align 1, !dbg !3085, !tbaa !2554
  %94 = icmp eq i8 %92, %93, !dbg !3085
  br i1 %94, label %.lr.ph.i29, label %.lr.ph.i50, !dbg !3085

__streq.exit26.thread126:                         ; preds = %.lr.ph.i29, %.lr.ph.i24
  %95 = add nsw i32 %k.0369, 3, !dbg !3086
  %96 = icmp slt i32 %95, %1, !dbg !3086
  br i1 %96, label %98, label %97, !dbg !3086

; <label>:97                                      ; preds = %__streq.exit26.thread126
  call fastcc void @__emit_error(i8* getelementptr inbounds ([77 x i8]* @.str7123, i64 0, i64 0)), !dbg !3088
  unreachable

; <label>:98                                      ; preds = %__streq.exit26.thread126
  %99 = add nsw i32 %k.0369, 1, !dbg !3089
  %100 = add nsw i32 %k.0369, 2, !dbg !3090
  %101 = sext i32 %99 to i64, !dbg !3090
  %102 = getelementptr inbounds i8** %2, i64 %101, !dbg !3090
  %103 = load i8** %102, align 8, !dbg !3090, !tbaa !3034
  %104 = load i8* %103, align 1, !dbg !3091, !tbaa !2554
  %105 = icmp eq i8 %104, 0, !dbg !3091
  br i1 %105, label %106, label %.lr.ph.i35, !dbg !3091

; <label>:106                                     ; preds = %98
  call fastcc void @__emit_error(i8* getelementptr inbounds ([77 x i8]* @.str7123, i64 0, i64 0)) #10, !dbg !3091
  unreachable
...
.lr.ph.i35:                                       ; preds = %98, %110
  ...
  %108 = getelementptr inbounds i8* %s.pn.i32, i64 1, !dbg !3092
  %.off.i34 = add i8 %107, -48, !dbg !3093
  %109 = icmp ult i8 %.off.i34, 10, !dbg !3093
  br i1 %109, label %110, label %117, !dbg !3093

; <label>:110                                     ; preds = %.lr.ph.i35
  %111 = sext i8 %107 to i64, !dbg !3094
  %112 = mul nsw i64 %res.02.i33, 10, !dbg !3095
  %113 = add i64 %111, -48, !dbg !3095
  %114 = add i64 %113, %112, !dbg !3095
  %115 = load i8* %108, align 1, !dbg !3092, !tbaa !2554
  %116 = icmp eq i8 %115, 0, !dbg !3092
  br i1 %116, label %__str_to_int.exit36, label %.lr.ph.i35, !dbg !3092

; <label>:117                                     ; preds = %.lr.ph.i35
  call fastcc void @__emit_error(i8* getelementptr inbounds ([77 x i8]* @.str7123, i64 0, i64 0)) #10, !dbg !3096
  unreachable

__str_to_int.exit36:                              ; preds = %110
  %118 = trunc i64 %114 to i32, !dbg !3090
  %119 = sext i32 %100 to i64, !dbg !3097
  %120 = getelementptr inbounds i8** %2, i64 %119, !dbg !3097
  %121 = load i8** %120, align 8, !dbg !3097, !tbaa !3034
  %122 = load i8* %121, align 1, !dbg !3098, !tbaa !2554
  %123 = icmp eq i8 %122, 0, !dbg !3098
  br i1 %123, label %124, label %.lr.ph.i40, !dbg !3098

; <label>:124                                     ; preds = %__str_to_int.exit36
  call fastcc void @__emit_error(i8* getelementptr inbounds ([77 x i8]* @.str7123, i64 0, i64 0)) #10, !dbg !3098
  unreachable
...
.lr.ph.i40:                                       ; preds = %__str_to_int.exit36, %128
  ...
  %126 = getelementptr inbounds i8* %s.pn.i37, i64 1, !dbg !3099
  %.off.i39 = add i8 %125, -48, !dbg !3100
  %127 = icmp ult i8 %.off.i39, 10, !dbg !3100
  br i1 %127, label %128, label %135, !dbg !3100

; <label>:128                                     ; preds = %.lr.ph.i40
  %129 = sext i8 %125 to i64, !dbg !3101
  %130 = mul nsw i64 %res.02.i38, 10, !dbg !3102
  %131 = add i64 %129, -48, !dbg !3102
  %132 = add i64 %131, %130, !dbg !3102
  %133 = load i8* %126, align 1, !dbg !3099, !tbaa !2554
  %134 = icmp eq i8 %133, 0, !dbg !3099
  br i1 %134, label %__str_to_int.exit41, label %.lr.ph.i40, !dbg !3099

; <label>:135                                     ; preds = %.lr.ph.i40
  call fastcc void @__emit_error(i8* getelementptr inbounds ([77 x i8]* @.str7123, i64 0, i64 0)) #10, !dbg !3103
  unreachable

__str_to_int.exit41:                              ; preds = %128
  %136 = trunc i64 %132 to i32, !dbg !3097
  %137 = add nsw i32 %k.0369, 4, !dbg !3104
  %138 = sext i32 %95 to i64, !dbg !3104
  %139 = getelementptr inbounds i8** %2, i64 %138, !dbg !3104
  %140 = load i8** %139, align 8, !dbg !3104, !tbaa !3034
  %141 = load i8* %140, align 1, !dbg !3105, !tbaa !2554
  %142 = icmp eq i8 %141, 0, !dbg !3105
  br i1 %142, label %143, label %.lr.ph.i45, !dbg !3105

; <label>:143                                     ; preds = %__str_to_int.exit41
  call fastcc void @__emit_error(i8* getelementptr inbounds ([77 x i8]* @.str7123, i64 0, i64 0)) #10, !dbg !3105
  unreachable
...
.lr.ph.i45:                                       ; preds = %__str_to_int.exit41, %147
  ...
  %145 = getelementptr inbounds i8* %s.pn.i42, i64 1, !dbg !3106
  %.off.i44 = add i8 %144, -48, !dbg !3107
  %146 = icmp ult i8 %.off.i44, 10, !dbg !3107
  br i1 %146, label %147, label %154, !dbg !3107

; <label>:147                                     ; preds = %.lr.ph.i45
  %148 = sext i8 %144 to i64, !dbg !3108
  %149 = mul nsw i64 %res.02.i43, 10, !dbg !3109
  %150 = add i64 %148, -48, !dbg !3109
  %151 = add i64 %150, %149, !dbg !3109
  %152 = load i8* %145, align 1, !dbg !3106, !tbaa !2554
  %153 = icmp eq i8 %152, 0, !dbg !3106
  br i1 %153, label %__str_to_int.exit46, label %.lr.ph.i45, !dbg !3106

; <label>:154                                     ; preds = %.lr.ph.i45
  call fastcc void @__emit_error(i8* getelementptr inbounds ([77 x i8]* @.str7123, i64 0, i64 0)) #10, !dbg !3110
  unreachable

__str_to_int.exit46:                              ; preds = %147
  %155 = trunc i64 %151 to i32, !dbg !3104
  %156 = add i32 %136, 1, !dbg !3111
  %157 = call i32 @klee_range(i32 %118, i32 %156, i8* getelementptr inbounds ([7 x i8]* @.str8124, i64 0, i64 0)) #10, !dbg !3111
  %158 = icmp sgt i32 %157, 0, !dbg !3112
  br i1 %158, label %.lr.ph, label %__streq.exit.thread.backedge, !dbg !3112

.lr.ph:                                           ; preds = %__str_to_int.exit46
  %159 = sext i32 %25 to i64
  br label %160, !dbg !3112
...
; <label>:160                                     ; preds = %__add_arg.exit47, %.lr.ph
  ...
  %162 = add i32 %sym_arg_num.1172, 48, !dbg !3114
  %163 = trunc i32 %162 to i8, !dbg !3114
  store i8 %163, i8* %22, align 1, !dbg !3114, !tbaa !2554
  %164 = call fastcc i8* @__get_sym_str(i32 %155, i8* %4), !dbg !3116
  %165 = trunc i64 %indvars.iv to i32, !dbg !3117
  %166 = icmp eq i32 %165, 1024, !dbg !3117
  br i1 %166, label %167, label %__add_arg.exit47, !dbg !3117

; <label>:167                                     ; preds = %160
  call fastcc void @__emit_error(i8* getelementptr inbounds ([37 x i8]* @.str24140, i64 0, i64 0)) #10, !dbg !3119
  unreachable

__add_arg.exit47:                                 ; preds = %160
  %168 = add i32 %sym_arg_num.1172, 1, !dbg !3114
  %169 = getelementptr inbounds [1024 x i8*]* %new_argv, i64 0, i64 %indvars.iv, !dbg !3120
  store i8* %164, i8** %169, align 8, !dbg !3120, !tbaa !3034
  %indvars.iv.next = add nsw i64 %indvars.iv, 1, !dbg !3112
  %170 = add nsw i32 %161, 1, !dbg !3121
  %171 = add nsw i32 %i.0173, 1, !dbg !3112
  %172 = icmp slt i32 %171, %157, !dbg !3112
  br i1 %172, label %160, label %__streq.exit.thread.backedge, !dbg !3112
...
.lr.ph.i50:                                       ; preds = %89, %175
  ...
  %174 = icmp eq i8 %173, 0, !dbg !3122
  br i1 %174, label %__streq.exit52.thread128, label %175, !dbg !3122

; <label>:175                                     ; preds = %.lr.ph.i50
  %176 = getelementptr inbounds i8* %.013.i49, i64 1, !dbg !3124
  %177 = getelementptr inbounds i8* %.04.i48, i64 1, !dbg !3125
  %178 = load i8* %176, align 1, !dbg !3126, !tbaa !2554
  %179 = load i8* %177, align 1, !dbg !3126, !tbaa !2554
  %180 = icmp eq i8 %178, %179, !dbg !3126
  br i1 %180, label %.lr.ph.i50, label %.lr.ph.i55, !dbg !3126
...
.lr.ph.i55:                                       ; preds = %175, %183
  ...
  %182 = icmp eq i8 %181, 0, !dbg !3122
  br i1 %182, label %__streq.exit52.thread128, label %183, !dbg !3122

; <label>:183                                     ; preds = %.lr.ph.i55
  %184 = getelementptr inbounds i8* %.013.i54, i64 1, !dbg !3124
  %185 = getelementptr inbounds i8* %.04.i53, i64 1, !dbg !3125
  %186 = load i8* %184, align 1, !dbg !3126, !tbaa !2554
  %187 = load i8* %185, align 1, !dbg !3126, !tbaa !2554
  %188 = icmp eq i8 %186, %187, !dbg !3126
  br i1 %188, label %.lr.ph.i55, label %.lr.ph.i70, !dbg !3126

__streq.exit52.thread128:                         ; preds = %.lr.ph.i55, %.lr.ph.i50
  %189 = add nsw i32 %k.0369, 2, !dbg !3127
  %190 = icmp slt i32 %189, %1, !dbg !3127
  br i1 %190, label %192, label %191, !dbg !3127

; <label>:191                                     ; preds = %__streq.exit52.thread128
  call fastcc void @__emit_error(i8* getelementptr inbounds ([72 x i8]* @.str11127, i64 0, i64 0)), !dbg !3129
  unreachable

; <label>:192                                     ; preds = %__streq.exit52.thread128
  %193 = add nsw i32 %k.0369, 1, !dbg !3130
  %194 = sext i32 %193 to i64, !dbg !3131
  %195 = getelementptr inbounds i8** %2, i64 %194, !dbg !3131
  %196 = load i8** %195, align 8, !dbg !3131, !tbaa !3034
  %197 = load i8* %196, align 1, !dbg !3132, !tbaa !2554
  %198 = icmp eq i8 %197, 0, !dbg !3132
  br i1 %198, label %199, label %.lr.ph.i61, !dbg !3132

; <label>:199                                     ; preds = %192
  call fastcc void @__emit_error(i8* getelementptr inbounds ([72 x i8]* @.str11127, i64 0, i64 0)) #10, !dbg !3132
  unreachable
...
.lr.ph.i61:                                       ; preds = %192, %203
  ...
  %201 = getelementptr inbounds i8* %s.pn.i58, i64 1, !dbg !3133
  %.off.i60 = add i8 %200, -48, !dbg !3134
  %202 = icmp ult i8 %.off.i60, 10, !dbg !3134
  br i1 %202, label %203, label %210, !dbg !3134

; <label>:203                                     ; preds = %.lr.ph.i61
  %204 = sext i8 %200 to i64, !dbg !3135
  %205 = mul nsw i64 %res.02.i59, 10, !dbg !3136
  %206 = add i64 %204, -48, !dbg !3136
  %207 = add i64 %206, %205, !dbg !3136
  %208 = load i8* %201, align 1, !dbg !3133, !tbaa !2554
  %209 = icmp eq i8 %208, 0, !dbg !3133
  br i1 %209, label %__str_to_int.exit62, label %.lr.ph.i61, !dbg !3133

; <label>:210                                     ; preds = %.lr.ph.i61
  call fastcc void @__emit_error(i8* getelementptr inbounds ([72 x i8]* @.str11127, i64 0, i64 0)) #10, !dbg !3137
  unreachable

__str_to_int.exit62:                              ; preds = %203
  %211 = trunc i64 %207 to i32, !dbg !3131
  %212 = add nsw i32 %k.0369, 3, !dbg !3138
  %213 = sext i32 %189 to i64, !dbg !3138
  %214 = getelementptr inbounds i8** %2, i64 %213, !dbg !3138
  %215 = load i8** %214, align 8, !dbg !3138, !tbaa !3034
  %216 = load i8* %215, align 1, !dbg !3139, !tbaa !2554
  %217 = icmp eq i8 %216, 0, !dbg !3139
  br i1 %217, label %218, label %.lr.ph.i66, !dbg !3139

; <label>:218                                     ; preds = %__str_to_int.exit62
  call fastcc void @__emit_error(i8* getelementptr inbounds ([72 x i8]* @.str11127, i64 0, i64 0)) #10, !dbg !3139
  unreachable
...
.lr.ph.i66:                                       ; preds = %__str_to_int.exit62, %222
  ...
  %220 = getelementptr inbounds i8* %s.pn.i63, i64 1, !dbg !3140
  %.off.i65 = add i8 %219, -48, !dbg !3141
  %221 = icmp ult i8 %.off.i65, 10, !dbg !3141
  br i1 %221, label %222, label %229, !dbg !3141

; <label>:222                                     ; preds = %.lr.ph.i66
  %223 = sext i8 %219 to i64, !dbg !3142
  %224 = mul nsw i64 %res.02.i64, 10, !dbg !3143
  %225 = add i64 %223, -48, !dbg !3143
  %226 = add i64 %225, %224, !dbg !3143
  %227 = load i8* %220, align 1, !dbg !3140, !tbaa !2554
  %228 = icmp eq i8 %227, 0, !dbg !3140
  br i1 %228, label %__str_to_int.exit67, label %.lr.ph.i66, !dbg !3140

; <label>:229                                     ; preds = %.lr.ph.i66
  call fastcc void @__emit_error(i8* getelementptr inbounds ([72 x i8]* @.str11127, i64 0, i64 0)) #10, !dbg !3144
  unreachable

__str_to_int.exit67:                              ; preds = %222
  %230 = trunc i64 %226 to i32, !dbg !3138
  br label %__streq.exit.thread.backedge, !dbg !3145
...
.lr.ph.i70:                                       ; preds = %183, %233
  ...
  %232 = icmp eq i8 %231, 0, !dbg !3146
  br i1 %232, label %__streq.exit72.thread130, label %233, !dbg !3146

; <label>:233                                     ; preds = %.lr.ph.i70
  %234 = getelementptr inbounds i8* %.013.i69, i64 1, !dbg !3148
  %235 = getelementptr inbounds i8* %.04.i68, i64 1, !dbg !3149
  %236 = load i8* %234, align 1, !dbg !3150, !tbaa !2554
  %237 = load i8* %235, align 1, !dbg !3150, !tbaa !2554
  %238 = icmp eq i8 %236, %237, !dbg !3150
  br i1 %238, label %.lr.ph.i70, label %.lr.ph.i75, !dbg !3150
...
.lr.ph.i75:                                       ; preds = %233, %241
  ...
  %240 = icmp eq i8 %239, 0, !dbg !3151
  br i1 %240, label %__streq.exit72.thread130, label %241, !dbg !3151

; <label>:241                                     ; preds = %.lr.ph.i75
  %242 = getelementptr inbounds i8* %.013.i74, i64 1, !dbg !3153
  %243 = getelementptr inbounds i8* %.04.i73, i64 1, !dbg !3154
  %244 = load i8* %242, align 1, !dbg !3155, !tbaa !2554
  %245 = load i8* %243, align 1, !dbg !3155, !tbaa !2554
  %246 = icmp eq i8 %244, %245, !dbg !3155
  br i1 %246, label %.lr.ph.i75, label %.lr.ph.i85, !dbg !3155

__streq.exit72.thread130:                         ; preds = %.lr.ph.i75, %.lr.ph.i70
  %247 = add nsw i32 %k.0369, 1, !dbg !3156
  %248 = icmp eq i32 %247, %1, !dbg !3156
  br i1 %248, label %249, label %250, !dbg !3156

; <label>:249                                     ; preds = %__streq.exit72.thread130
  call fastcc void @__emit_error(i8* getelementptr inbounds ([57 x i8]* @.str14130, i64 0, i64 0)), !dbg !3158
  unreachable

; <label>:250                                     ; preds = %__streq.exit72.thread130
  %251 = add nsw i32 %k.0369, 2, !dbg !3159
  %252 = sext i32 %247 to i64, !dbg !3159
  %253 = getelementptr inbounds i8** %2, i64 %252, !dbg !3159
  %254 = load i8** %253, align 8, !dbg !3159, !tbaa !3034
  %255 = load i8* %254, align 1, !dbg !3160, !tbaa !2554
  %256 = icmp eq i8 %255, 0, !dbg !3160
  br i1 %256, label %257, label %.lr.ph.i81, !dbg !3160

; <label>:257                                     ; preds = %250
  call fastcc void @__emit_error(i8* getelementptr inbounds ([57 x i8]* @.str14130, i64 0, i64 0)) #10, !dbg !3160
  unreachable
...
.lr.ph.i81:                                       ; preds = %250, %261
  ...
  %259 = getelementptr inbounds i8* %s.pn.i78, i64 1, !dbg !3161
  %.off.i80 = add i8 %258, -48, !dbg !3162
  %260 = icmp ult i8 %.off.i80, 10, !dbg !3162
  br i1 %260, label %261, label %268, !dbg !3162

; <label>:261                                     ; preds = %.lr.ph.i81
  %262 = sext i8 %258 to i64, !dbg !3163
  %263 = mul nsw i64 %res.02.i79, 10, !dbg !3164
  %264 = add i64 %262, -48, !dbg !3164
  %265 = add i64 %264, %263, !dbg !3164
  %266 = load i8* %259, align 1, !dbg !3161, !tbaa !2554
  %267 = icmp eq i8 %266, 0, !dbg !3161
  br i1 %267, label %__str_to_int.exit82, label %.lr.ph.i81, !dbg !3161

; <label>:268                                     ; preds = %.lr.ph.i81
  call fastcc void @__emit_error(i8* getelementptr inbounds ([57 x i8]* @.str14130, i64 0, i64 0)) #10, !dbg !3165
  unreachable

__str_to_int.exit82:                              ; preds = %261
  %269 = trunc i64 %265 to i32, !dbg !3159
  br label %__streq.exit.thread.backedge, !dbg !3166
...
__streq.exit.thread.backedge:                     ; preds = %__add_arg.exit47, %__add_arg.exit, %__str_to_int.exit, %__streq.exit117.thread136, %__streq.exit97.thread134, %__streq.exit87.thread132, %__str_to_int.exit82, %__str_to_int.exit67, %__str_to_in
  ...
  %270 = icmp slt i32 %k.0.be, %1, !dbg !3046
  br i1 %270, label %24, label %__streq.exit.thread._crit_edge, !dbg !3046
...
.lr.ph.i85:                                       ; preds = %241, %273
  ...
  %272 = icmp eq i8 %271, 0, !dbg !3167
  br i1 %272, label %__streq.exit87.thread132, label %273, !dbg !3167

; <label>:273                                     ; preds = %.lr.ph.i85
  %274 = getelementptr inbounds i8* %.013.i84, i64 1, !dbg !3169
  %275 = getelementptr inbounds i8* %.04.i83, i64 1, !dbg !3170
  %276 = load i8* %274, align 1, !dbg !3171, !tbaa !2554
  %277 = load i8* %275, align 1, !dbg !3171, !tbaa !2554
  %278 = icmp eq i8 %276, %277, !dbg !3171
  br i1 %278, label %.lr.ph.i85, label %.lr.ph.i90, !dbg !3171
...
.lr.ph.i90:                                       ; preds = %273, %281
  ...
  %280 = icmp eq i8 %279, 0, !dbg !3172
  br i1 %280, label %__streq.exit87.thread132, label %281, !dbg !3172

; <label>:281                                     ; preds = %.lr.ph.i90
  %282 = getelementptr inbounds i8* %.013.i89, i64 1, !dbg !3174
  %283 = getelementptr inbounds i8* %.04.i88, i64 1, !dbg !3175
  %284 = load i8* %282, align 1, !dbg !3176, !tbaa !2554
  %285 = load i8* %283, align 1, !dbg !3176, !tbaa !2554
  %286 = icmp eq i8 %284, %285, !dbg !3176
  br i1 %286, label %.lr.ph.i90, label %.lr.ph.i95, !dbg !3176

__streq.exit87.thread132:                         ; preds = %.lr.ph.i90, %.lr.ph.i85
  %287 = add nsw i32 %k.0369, 1, !dbg !3177
  br label %__streq.exit.thread.backedge, !dbg !3179
...
.lr.ph.i95:                                       ; preds = %281, %290
  ...
  %289 = icmp eq i8 %288, 0, !dbg !3180
  br i1 %289, label %__streq.exit97.thread134, label %290, !dbg !3180

; <label>:290                                     ; preds = %.lr.ph.i95
  %291 = getelementptr inbounds i8* %.013.i94, i64 1, !dbg !3182
  %292 = getelementptr inbounds i8* %.04.i93, i64 1, !dbg !3183
  %293 = load i8* %291, align 1, !dbg !3184, !tbaa !2554
  %294 = load i8* %292, align 1, !dbg !3184, !tbaa !2554
  %295 = icmp eq i8 %293, %294, !dbg !3184
  br i1 %295, label %.lr.ph.i95, label %.lr.ph.i120, !dbg !3184
...
.lr.ph.i120:                                      ; preds = %290, %298
  ...
  %297 = icmp eq i8 %296, 0, !dbg !3180
  br i1 %297, label %__streq.exit97.thread134, label %298, !dbg !3180

; <label>:298                                     ; preds = %.lr.ph.i120
  %299 = getelementptr inbounds i8* %.013.i119, i64 1, !dbg !3182
  %300 = getelementptr inbounds i8* %.04.i118, i64 1, !dbg !3183
  %301 = load i8* %299, align 1, !dbg !3184, !tbaa !2554
  %302 = load i8* %300, align 1, !dbg !3184, !tbaa !2554
  %303 = icmp eq i8 %301, %302, !dbg !3184
  br i1 %303, label %.lr.ph.i120, label %.lr.ph.i115, !dbg !3184

__streq.exit97.thread134:                         ; preds = %.lr.ph.i120, %.lr.ph.i95
  %304 = add nsw i32 %k.0369, 1, !dbg !3185
  br label %__streq.exit.thread.backedge, !dbg !3187
...
.lr.ph.i115:                                      ; preds = %298, %307
  ...
  %306 = icmp eq i8 %305, 0, !dbg !3188
  br i1 %306, label %__streq.exit117.thread136, label %307, !dbg !3188

; <label>:307                                     ; preds = %.lr.ph.i115
  %308 = getelementptr inbounds i8* %.013.i114, i64 1, !dbg !3190
  %309 = getelementptr inbounds i8* %.04.i113, i64 1, !dbg !3191
  %310 = load i8* %308, align 1, !dbg !3192, !tbaa !2554
  %311 = load i8* %309, align 1, !dbg !3192, !tbaa !2554
  %312 = icmp eq i8 %310, %311, !dbg !3192
  br i1 %312, label %.lr.ph.i115, label %.lr.ph.i110, !dbg !3192
...
.lr.ph.i110:                                      ; preds = %307, %315
  ...
  %314 = icmp eq i8 %313, 0, !dbg !3188
  br i1 %314, label %__streq.exit117.thread136, label %315, !dbg !3188

; <label>:315                                     ; preds = %.lr.ph.i110
  %316 = getelementptr inbounds i8* %.013.i109, i64 1, !dbg !3190
  %317 = getelementptr inbounds i8* %.04.i108, i64 1, !dbg !3191
  %318 = load i8* %316, align 1, !dbg !3192, !tbaa !2554
  %319 = load i8* %317, align 1, !dbg !3192, !tbaa !2554
  %320 = icmp eq i8 %318, %319, !dbg !3192
  br i1 %320, label %.lr.ph.i110, label %.lr.ph.i105, !dbg !3192

__streq.exit117.thread136:                        ; preds = %.lr.ph.i110, %.lr.ph.i115
  %321 = add nsw i32 %k.0369, 1, !dbg !3193
  br label %__streq.exit.thread.backedge, !dbg !3195
...
.lr.ph.i105:                                      ; preds = %315, %324
  ...
  %323 = icmp eq i8 %322, 0, !dbg !3196
  br i1 %323, label %__streq.exit107.thread138, label %324, !dbg !3196

; <label>:324                                     ; preds = %.lr.ph.i105
  %325 = getelementptr inbounds i8* %.013.i104, i64 1, !dbg !3198
  %326 = getelementptr inbounds i8* %.04.i103, i64 1, !dbg !3199
  %327 = load i8* %325, align 1, !dbg !3200, !tbaa !2554
  %328 = load i8* %326, align 1, !dbg !3200, !tbaa !2554
  %329 = icmp eq i8 %327, %328, !dbg !3200
  br i1 %329, label %.lr.ph.i105, label %.lr.ph.i100, !dbg !3200
...
.lr.ph.i100:                                      ; preds = %324, %332
  ...
  %331 = icmp eq i8 %330, 0, !dbg !3196
  br i1 %331, label %__streq.exit107.thread138, label %332, !dbg !3196

; <label>:332                                     ; preds = %.lr.ph.i100
  %333 = getelementptr inbounds i8* %.013.i99, i64 1, !dbg !3198
  %334 = getelementptr inbounds i8* %.04.i98, i64 1, !dbg !3199
  %335 = load i8* %333, align 1, !dbg !3200, !tbaa !2554
  %336 = load i8* %334, align 1, !dbg !3200, !tbaa !2554
  %337 = icmp eq i8 %335, %336, !dbg !3200
  br i1 %337, label %.lr.ph.i100, label %.loopexit162, !dbg !3200

__streq.exit107.thread138:                        ; preds = %.lr.ph.i100, %.lr.ph.i105
  %338 = add nsw i32 %k.0369, 1, !dbg !3201
  %339 = icmp eq i32 %338, %1, !dbg !3201
  br i1 %339, label %340, label %341, !dbg !3201

; <label>:340                                     ; preds = %__streq.exit107.thread138
  call fastcc void @__emit_error(i8* getelementptr inbounds ([54 x i8]* @.str23139, i64 0, i64 0)), !dbg !3203
  unreachable

; <label>:341                                     ; preds = %__streq.exit107.thread138
  %342 = add nsw i32 %k.0369, 2, !dbg !3204
  %343 = sext i32 %338 to i64, !dbg !3204
  %344 = getelementptr inbounds i8** %2, i64 %343, !dbg !3204
  %345 = load i8** %344, align 8, !dbg !3204, !tbaa !3034
  %346 = load i8* %345, align 1, !dbg !3205, !tbaa !2554
  %347 = icmp eq i8 %346, 0, !dbg !3205
  br i1 %347, label %348, label %.lr.ph.i10, !dbg !3205

; <label>:348                                     ; preds = %341
  call fastcc void @__emit_error(i8* getelementptr inbounds ([54 x i8]* @.str23139, i64 0, i64 0)) #10, !dbg !3205
  unreachable
...
.lr.ph.i10:                                       ; preds = %341, %352
  ...
  %350 = getelementptr inbounds i8* %s.pn.i, i64 1, !dbg !3206
  %.off.i = add i8 %349, -48, !dbg !3207
  %351 = icmp ult i8 %.off.i, 10, !dbg !3207
  br i1 %351, label %352, label %359, !dbg !3207

; <label>:352                                     ; preds = %.lr.ph.i10
  %353 = sext i8 %349 to i64, !dbg !3208
  %354 = mul nsw i64 %res.02.i, 10, !dbg !3209
  %355 = add i64 %353, -48, !dbg !3209
  %356 = add i64 %355, %354, !dbg !3209
  %357 = load i8* %350, align 1, !dbg !3206, !tbaa !2554
  %358 = icmp eq i8 %357, 0, !dbg !3206
  br i1 %358, label %__str_to_int.exit, label %.lr.ph.i10, !dbg !3206

; <label>:359                                     ; preds = %.lr.ph.i10
  call fastcc void @__emit_error(i8* getelementptr inbounds ([54 x i8]* @.str23139, i64 0, i64 0)) #10, !dbg !3210
  unreachable

__str_to_int.exit:                                ; preds = %352
  %360 = trunc i64 %356 to i32, !dbg !3204
  br label %__streq.exit.thread.backedge, !dbg !3211

.loopexit162:                                     ; preds = %332, %24
  %361 = icmp eq i32 %25, 1024, !dbg !3212
  br i1 %361, label %362, label %__add_arg.exit, !dbg !3212

; <label>:362                                     ; preds = %.loopexit162
  call fastcc void @__emit_error(i8* getelementptr inbounds ([37 x i8]* @.str24140, i64 0, i64 0)) #10, !dbg !3215
  unreachable

__add_arg.exit:                                   ; preds = %.loopexit162
  %363 = add nsw i32 %k.0369, 1, !dbg !3213
  %364 = sext i32 %25 to i64, !dbg !3216
  %365 = getelementptr inbounds [1024 x i8*]* %new_argv, i64 0, i64 %364, !dbg !3216
  store i8* %28, i8** %365, align 8, !dbg !3216, !tbaa !3034
  %366 = add nsw i32 %25, 1, !dbg !3217
...
__streq.exit.thread._crit_edge:                   ; preds = %__streq.exit.thread.backedge, %__streq.exit.thread.preheader
  ...
  %367 = add nsw i32 %.lcssa176, 1, !dbg !3218
  %368 = sext i32 %367 to i64, !dbg !3218
  call void @klee_overshift_check(i64 64, i64 3) #10, !dbg !3218
  %369 = shl nsw i64 %368, 3, !dbg !3218
  %370 = call noalias i8* @malloc(i64 %369) #10, !dbg !3218
  %371 = bitcast i8* %370 to i8**, !dbg !3218
  call void @klee_mark_global(i8* %370) #10, !dbg !3219
  %372 = sext i32 %.lcssa176 to i64, !dbg !3220
  call void @klee_overshift_check(i64 64, i64 3) #10, !dbg !3220
  %373 = shl nsw i64 %372, 3, !dbg !3220
  %374 = call i8* @memcpy(i8* %370, i8* %3, i64 %373)
  %375 = getelementptr inbounds i8** %371, i64 %372, !dbg !3221
  store i8* null, i8** %375, align 8, !dbg !3221, !tbaa !3034
  store i32 %.lcssa176, i32* %argcPtr, align 4, !dbg !3222, !tbaa !2548
  store i8** %371, i8*** %argvPtr, align 8, !dbg !3223, !tbaa !3034
  call fastcc void @klee_init_fds(i32 %sym_files.0.lcssa, i32 %sym_file_len.0.lcssa, i32 %sym_stdin_len.0.lcssa, i32 %sym_stdout_flag.0.lcssa, i32 %save_all_writes_flag.0.lcssa, i32 %fd_fail.0.lcssa) #10, !dbg !3224
  ret void, !dbg !3225
}
...
define internal fastcc void @__emit_error(i8* %msg) #14 {
  tail call void @klee_report_error(i8* getelementptr inbounds ([50 x i8]* @.str25, i64 0, i64 0), i32 24, i8* %msg, i8* getelementptr inbounds ([9 x i8]* @.str26, i64 0, i64 0)) #6, !dbg !3226
  unreachable, !dbg !3226
}

; Function Attrs: nounwind uwtable
define internal fastcc i8* @__get_sym_str(i32 %numChars, i8* %name) #9 {
  %1 = add nsw i32 %numChars, 1, !dbg !3227
  %2 = sext i32 %1 to i64, !dbg !3227
  %3 = tail call noalias i8* @malloc(i64 %2) #10, !dbg !3227
  tail call void @klee_mark_global(i8* %3) #10, !dbg !3228
  tail call void @klee_make_symbolic(i8* %3, i64 %2, i8* %name) #10, !dbg !3229
  %4 = icmp sgt i32 %numChars, 0, !dbg !3230
  br i1 %4, label %.lr.ph, label %._crit_edge, !dbg !3230

.lr.ph:                                           ; preds = %0, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %.lr.ph ], [ 0, %0 ]
  %5 = getelementptr inbounds i8* %3, i64 %indvars.iv, !dbg !3232
  %6 = load i8* %5, align 1, !dbg !3232, !tbaa !2554
  %7 = icmp sgt i8 %6, 31, !dbg !3233
  %8 = icmp ne i8 %6, 127, !dbg !3233
  %..i = and i1 %7, %8, !dbg !3233
  %9 = zext i1 %..i to i64, !dbg !3232
  tail call void @klee_posix_prefer_cex(i8* %3, i64 %9) #10, !dbg !3232
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !3230
  %lftr.wideiv1 = trunc i64 %indvars.iv.next to i32, !dbg !3230
  %exitcond2 = icmp eq i32 %lftr.wideiv1, %numChars, !dbg !3230
  br i1 %exitcond2, label %._crit_edge, label %.lr.ph, !dbg !3230

._crit_edge:                                      ; preds = %.lr.ph, %0
  %10 = sext i32 %numChars to i64, !dbg !3234
  %11 = getelementptr inbounds i8* %3, i64 %10, !dbg !3234
  store i8 0, i8* %11, align 1, !dbg !3234, !tbaa !2554
  ret i8* %3, !dbg !3235
}

; Function Attrs: nounwind uwtable
define void @klee_div_zero_check(i64 %z) #9 {
  %1 = icmp eq i64 %z, 0, !dbg !3236
  br i1 %1, label %2, label %3, !dbg !3236

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([60 x i8]* @.str143, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str1144, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2145, i64 0, i64 0)) #17, !dbg !3238
...
define i32 @klee_int(i8* %name) #9 {
  ...
  %1 = bitcast i32* %x to i8*, !dbg !3240
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #16, !dbg !3240
  %2 = load i32* %x, align 4, !dbg !3241, !tbaa !2548
  ret i32 %2, !dbg !3241
}
...
define void @klee_overshift_check(i64 %bitWidth, i64 %shift) #9 {
  %1 = icmp ult i64 %shift, %bitWidth, !dbg !3242
  br i1 %1, label %3, label %2, !dbg !3242

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3146, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25147, i64 0, i64 0)) #17, !dbg !3244
...
define i32 @klee_range(i32 %start, i32 %end, i8* %name) #9 {
  %x = alloca i32, align 4
  %1 = icmp slt i32 %start, %end, !dbg !3247
  br i1 %1, label %3, label %2, !dbg !3247

; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([51 x i8]* @.str6148, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #17, !dbg !3249
  unreachable, !dbg !3249

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %start, 1, !dbg !3250
  %5 = icmp eq i32 %4, %end, !dbg !3250
  br i1 %5, label %21, label %6, !dbg !3250

; <label>:6                                       ; preds = %3
  %7 = bitcast i32* %x to i8*, !dbg !3252
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #16, !dbg !3252
  %8 = icmp eq i32 %start, 0, !dbg !3254
  %9 = load i32* %x, align 4, !dbg !3256, !tbaa !2548
  br i1 %8, label %10, label %13, !dbg !3254

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !3256
  %12 = zext i1 %11 to i64, !dbg !3256
  call void @klee_assume(i64 %12) #16, !dbg !3256
  br label %19, !dbg !3258

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !3259
  %15 = zext i1 %14 to i64, !dbg !3259
  call void @klee_assume(i64 %15) #16, !dbg !3259
  %16 = load i32* %x, align 4, !dbg !3261, !tbaa !2548
  %17 = icmp slt i32 %16, %end, !dbg !3261
  %18 = zext i1 %17 to i64, !dbg !3261
  call void @klee_assume(i64 %18) #16, !dbg !3261
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !3262, !tbaa !2548
  br label %21, !dbg !3262
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #9 {
  %1 = icmp eq i64 %len, 0, !dbg !3264
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !3264
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !3265
  %wide.load = load <16 x i8>* %3, align 1, !dbg !3265
  %next.gep.sum279 = or i64 %index, 16, !dbg !3265
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !3265
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !3265
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !3265
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !3265
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !3265
  %next.gep103.sum296 = or i64 %index, 16, !dbg !3265
  %7 = getelementptr i8* %destaddr, i64 %next.gep103.sum296, !dbg !3265
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !3265
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !3265
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !3266
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !3264
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !3265
  %12 = load i8* %src.03, align 1, !dbg !3265, !tbaa !2554
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !3265
  store i8 %12, i8* %dest.02, align 1, !dbg !3265, !tbaa !2554
  %14 = icmp eq i64 %10, 0, !dbg !3264
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !3264, !llvm.loop !3269

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %0
  ret i8* %destaddr, !dbg !3270
}

; Function Attrs: nounwind uwtable
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #9 {
  %1 = icmp eq i8* %src, %dst, !dbg !3271
  br i1 %1, label %.loopexit, label %2, !dbg !3271

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !3273
  br i1 %3, label %.preheader, label %18, !dbg !3273

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !3275
  br i1 %4, label %.loopexit, label %.lr.ph.preheader, !dbg !3275
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %6 = bitcast i8* %next.gep to <16 x i8>*, !dbg !3275
  %wide.load = load <16 x i8>* %6, align 1, !dbg !3275
  %next.gep.sum586 = or i64 %index, 16, !dbg !3275
  %7 = getelementptr i8* %src, i64 %next.gep.sum586, !dbg !3275
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !3275
  %wide.load207 = load <16 x i8>* %8, align 1, !dbg !3275
  %9 = bitcast i8* %next.gep110 to <16 x i8>*, !dbg !3275
  store <16 x i8> %wide.load, <16 x i8>* %9, align 1, !dbg !3275
  %next.gep110.sum603 = or i64 %index, 16, !dbg !3275
  %10 = getelementptr i8* %dst, i64 %next.gep110.sum603, !dbg !3275
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !3275
  store <16 x i8> %wide.load207, <16 x i8>* %11, align 1, !dbg !3275
  %index.next = add i64 %index, 32
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !3277
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %13 = add i64 %.02, -1, !dbg !3275
  %14 = getelementptr inbounds i8* %b.04, i64 1, !dbg !3275
  %15 = load i8* %b.04, align 1, !dbg !3275, !tbaa !2554
  %16 = getelementptr inbounds i8* %a.03, i64 1, !dbg !3275
  store i8 %15, i8* %a.03, align 1, !dbg !3275, !tbaa !2554
  %17 = icmp eq i64 %13, 0, !dbg !3275
  br i1 %17, label %.loopexit, label %.lr.ph, !dbg !3275, !llvm.loop !3278

; <label>:18                                      ; preds = %2
  %19 = add i64 %count, -1, !dbg !3279
  %20 = icmp eq i64 %count, 0, !dbg !3281
  br i1 %20, label %.loopexit, label %.lr.ph9, !dbg !3281

.lr.ph9:                                          ; preds = %18
  %21 = getelementptr inbounds i8* %src, i64 %19, !dbg !3282
  %22 = getelementptr inbounds i8* %dst, i64 %19, !dbg !3279
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %next.gep236.sum = add i64 %.sum440, -15, !dbg !3281
  %24 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !3281
  %25 = bitcast i8* %24 to <16 x i8>*, !dbg !3281
  %wide.load434 = load <16 x i8>* %25, align 1, !dbg !3281
  %reverse = shufflevector <16 x i8> %wide.load434, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !3281
  %.sum505 = add i64 %.sum440, -31, !dbg !3281
  %26 = getelementptr i8* %src, i64 %.sum505, !dbg !3281
  %27 = bitcast i8* %26 to <16 x i8>*, !dbg !3281
  %wide.load435 = load <16 x i8>* %27, align 1, !dbg !3281
  %reverse436 = shufflevector <16 x i8> %wide.load435, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !3281
  %reverse437 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !3281
  %next.gep333.sum = add i64 %.sum472, -15, !dbg !3281
  %28 = getelementptr i8* %dst, i64 %next.gep333.sum, !dbg !3281
  %29 = bitcast i8* %28 to <16 x i8>*, !dbg !3281
  store <16 x i8> %reverse437, <16 x i8>* %29, align 1, !dbg !3281
  %reverse438 = shufflevector <16 x i8> %reverse436, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !3281
  %.sum507 = add i64 %.sum472, -31, !dbg !3281
  %30 = getelementptr i8* %dst, i64 %.sum507, !dbg !3281
  %31 = bitcast i8* %30 to <16 x i8>*, !dbg !3281
  store <16 x i8> %reverse438, <16 x i8>* %31, align 1, !dbg !3281
  %index.next234 = add i64 %index212, 32
  %32 = icmp eq i64 %index.next234, %n.vec215
  br i1 %32, label %middle.block210, label %vector.body209, !llvm.loop !3283
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %33 = add i64 %.16, -1, !dbg !3281
  %34 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !3281
  %35 = load i8* %b.18, align 1, !dbg !3281, !tbaa !2554
  %36 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !3281
  store i8 %35, i8* %a.17, align 1, !dbg !3281, !tbaa !2554
  %37 = icmp eq i64 %33, 0, !dbg !3281
  br i1 %37, label %.loopexit, label %scalar.ph211, !dbg !3281, !llvm.loop !3284
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #9 {
  %1 = icmp eq i64 %len, 0, !dbg !3286
  br i1 %1, label %15, label %.lr.ph.preheader, !dbg !3286
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !3287
  %wide.load = load <16 x i8>* %3, align 1, !dbg !3287
  %next.gep.sum280 = or i64 %index, 16, !dbg !3287
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum280, !dbg !3287
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !3287
  %wide.load201 = load <16 x i8>* %5, align 1, !dbg !3287
  %6 = bitcast i8* %next.gep104 to <16 x i8>*, !dbg !3287
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !3287
  %next.gep104.sum297 = or i64 %index, 16, !dbg !3287
  %7 = getelementptr i8* %destaddr, i64 %next.gep104.sum297, !dbg !3287
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !3287
  store <16 x i8> %wide.load201, <16 x i8>* %8, align 1, !dbg !3287
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !3288
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !3286
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !3287
  %12 = load i8* %src.03, align 1, !dbg !3287, !tbaa !2554
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !3287
  store i8 %12, i8* %dest.02, align 1, !dbg !3287, !tbaa !2554
  %14 = icmp eq i64 %10, 0, !dbg !3286
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !3286, !llvm.loop !3289

._crit_edge:                                      ; preds = %.lr.ph, %middle.block
  %scevgep = getelementptr i8* %destaddr, i64 %len
  br label %15, !dbg !3286

; <label>:15                                      ; preds = %._crit_edge, %0
  %dest.0.lcssa = phi i8* [ %scevgep, %._crit_edge ], [ %destaddr, %0 ]
  ret i8* %dest.0.lcssa, !dbg !3290
}

; Function Attrs: nounwind uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #9 {
  %1 = icmp eq i64 %count, 0, !dbg !3291
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !3291

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !3292
  br label %3, !dbg !3291

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.02 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.01 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.01, -1, !dbg !3291
  %5 = getelementptr inbounds i8* %a.02, i64 1, !dbg !3292
  store volatile i8 %2, i8* %a.02, align 1, !dbg !3292, !tbaa !2554
  %6 = icmp eq i64 %4, 0, !dbg !3291
  br i1 %6, label %._crit_edge, label %3, !dbg !3291
...
!9 = metadata !{i32 786478, metadata !1, metadata !10, metadata !"lava_set", metadata !"lava_set", metadata !"", i32 5, metadata !11, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !7, i32 5} ; [ DW_TAG_subprogram ] 
...
!14 = metadata !{i32 786478, metadata !1, metadata !10, metadata !"lava_get", metadata !"lava_get", metadata !"", i32 7, metadata !15, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !7, i32 7} ; [ DW_TAG_subprogram ]
...
!2212 = metadata !{i32 38, i32 0, metadata !2213, null}
!2213 = metadata !{i32 786443, metadata !1, metadata !17, i32 38, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/toy_example_distrib/buggy/2/toy/test.c]
!2214 = metadata !{i32 39, i32 0, metadata !2213, null}
!2215 = metadata !{i32 40, i32 0, metadata !2216, null}
!2216 = metadata !{i32 786443, metadata !1, metadata !17, i32 40, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/toy_example_distrib/buggy/2/toy/test.c]
!2217 = metadata !{i32 41, i32 0, metadata !2216, null}
!2218 = metadata !{i32 42, i32 0, metadata !17, null}
!2219 = metadata !{i32 45, i32 0, metadata !89, null}
!2220 = metadata !{i32 46, i32 0, metadata !2221, null}
!2221 = metadata !{i32 786443, metadata !1, metadata !89, i32 46, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/klee/toy_example_distrib/buggy/2/toy/test.c]
!2222 = metadata !{i32 47, i32 0, metadata !2221, null}
!2223 = metadata !{i32 48, i32 0, metadata !89, null}
!2224 = metadata !{i32 52, i32 0, metadata !107, null}
!2225 = metadata !{i32 53, i32 0, metadata !2226, null}
!2226 = metadata !{i32 786443, metadata !1, metadata !107, i32 53, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/toy_example_distrib/buggy/2/toy/test.c]
!2227 = metadata !{i32 55, i32 0, metadata !2228, null}
!2228 = metadata !{i32 786443, metadata !1, metadata !2229, i32 54, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/klee/toy_example_distrib/buggy/2/toy/test.c]
!2229 = metadata !{i32 786443, metadata !1, metadata !2230, i32 54, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/toy_example_distrib/buggy/2/toy/test.c]
!2230 = metadata !{i32 786443, metadata !1, metadata !2231, i32 54, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/toy_example_distrib/buggy/2/toy/test.c]
!2231 = metadata !{i32 786443, metadata !1, metadata !2226, i32 53, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/toy_example_distrib/buggy/2/toy/test.c]
!2232 = metadata !{i32 56, i32 0, metadata !2230, null}
!2233 = metadata !{i32 57, i32 0, metadata !2231, null}
!2234 = metadata !{i32 58, i32 0, metadata !2235, null} ; [ DW_TAG_imported_module ]
!2235 = metadata !{i32 786443, metadata !1, metadata !2226, i32 58, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/klee/toy_example_distrib/buggy/2/toy/test.c]
!2236 = metadata !{i32 59, i32 0, metadata !2237, null}
!2237 = metadata !{i32 786443, metadata !1, metadata !2235, i32 58, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/klee/toy_example_distrib/buggy/2/toy/test.c]
!2238 = metadata !{i32 62, i32 0, metadata !2239, null}
!2239 = metadata !{i32 786443, metadata !1, metadata !2235, i32 61, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/klee/toy_example_distrib/buggy/2/toy/test.c]
!2240 = metadata !{i32 63, i32 0, metadata !2239, null}
!2241 = metadata !{i32 65, i32 0, metadata !107, null}
!2242 = metadata !{i32 66, i32 0, metadata !107, null}
!2243 = metadata !{i32 69, i32 0, metadata !110, null}
!2244 = metadata !{i32 72, i32 0, metadata !110, null}
!2245 = metadata !{i32 73, i32 0, metadata !110, null}
!2246 = metadata !{i32 76, i32 0, metadata !2247, null}
!2247 = metadata !{i32 786443, metadata !1, metadata !110, i32 76, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [/home/klee/toy_example_distrib/buggy/2/toy/test.c]
!2248 = metadata !{i32 77, i32 0, metadata !2249, null}
!2249 = metadata !{i32 786443, metadata !1, metadata !2247, i32 76, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/home/klee/toy_example_distrib/buggy/2/toy/test.c]
!2250 = metadata !{i32 78, i32 0, metadata !2249, null}
!2251 = metadata !{i32 80, i32 0, metadata !110, null}
!2252 = metadata !{i32 20, i32 0, metadata !198, null}
!2253 = metadata !{i32 102, i32 0, metadata !2254, null}
!2254 = metadata !{i32 786443, metadata !235, metadata !2255, i32 102, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2255 = metadata !{i32 786443, metadata !235, metadata !2256, i32 101, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2256 = metadata !{i32 786443, metadata !235, metadata !237, i32 101, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2257 = metadata !{i32 60, i32 0, metadata !2258, null}
!2258 = metadata !{i32 786443, metadata !235, metadata !2259, i32 60, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2259 = metadata !{i32 786443, metadata !235, metadata !2260, i32 60, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2260 = metadata !{i32 786443, metadata !235, metadata !2261, i32 57, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2261 = metadata !{i32 786443, metadata !235, metadata !2262, i32 57, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2262 = metadata !{i32 786443, metadata !235, metadata !2263, i32 54, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2263 = metadata !{i32 786443, metadata !235, metadata !2264, i32 54, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2264 = metadata !{i32 786443, metadata !235, metadata !2265, i32 52, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2265 = metadata !{i32 786443, metadata !235, metadata !2266, i32 52, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2266 = metadata !{i32 786443, metadata !235, metadata !2267, i32 50, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2267 = metadata !{i32 786443, metadata !235, metadata !237, i32 50, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2268 = metadata !{i32 105, i32 0, metadata !2255, null}
!2269 = metadata !{i32 107, i32 0, metadata !2255, null}
!2270 = metadata !{i32 146, i32 0, metadata !2271, null}
!2271 = metadata !{i32 786443, metadata !235, metadata !2272, i32 146, i32 0, i32 24} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2272 = metadata !{i32 786443, metadata !235, metadata !2273, i32 142, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2273 = metadata !{i32 786443, metadata !235, metadata !237, i32 120, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2274 = metadata !{i32 155, i32 0, metadata !237, null}
!2275 = metadata !{i32 173, i32 0, metadata !237, null}
!2276 = metadata !{i32 174, i32 0, metadata !237, null}
!2277 = metadata !{i32 175, i32 0, metadata !237, null}
!2278 = metadata !{i32 177, i32 0, metadata !2279, null}
!2279 = metadata !{i32 786443, metadata !235, metadata !237, i32 177, i32 0, i32 26} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2280 = metadata !{i32 178, i32 0, metadata !2281, null}
!2281 = metadata !{i32 786443, metadata !235, metadata !2282, i32 178, i32 0, i32 28} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2282 = metadata !{i32 786443, metadata !235, metadata !2279, i32 177, i32 0, i32 27} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2283 = metadata !{i32 179, i32 0, metadata !2284, null}
!2284 = metadata !{i32 786443, metadata !235, metadata !2281, i32 178, i32 0, i32 29} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2285 = metadata !{i32 180, i32 0, metadata !2284, null}
!2286 = metadata !{i32 181, i32 0, metadata !2284, null}
!2287 = metadata !{i32 186, i32 0, metadata !2288, null}
!2288 = metadata !{i32 786443, metadata !235, metadata !2281, i32 181, i32 0, i32 30} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2289 = metadata !{i32 191, i32 0, metadata !237, null}
!2290 = metadata !{i32 192, i32 0, metadata !237, null}
!2291 = metadata !{i32 193, i32 0, metadata !237, null}
!2292 = metadata !{i32 199, i32 0, metadata !237, null}
!2293 = metadata !{i32 202, i32 0, metadata !237, null}
!2294 = metadata !{i32 224, i32 0, metadata !2295, null}
!2295 = metadata !{i32 786443, metadata !235, metadata !237, i32 219, i32 0, i32 31} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_fopen.c]
!2296 = metadata !{i32 225, i32 0, metadata !2295, null}
!2297 = metadata !{i32 233, i32 0, metadata !237, null}
!2298 = metadata !{i32 234, i32 0, metadata !237, null}
!2299 = metadata !{i32 280, i32 0, metadata !270, null}
!2300 = metadata !{i32 282, i32 0, metadata !270, null}
!2301 = metadata !{i32 283, i32 0, metadata !270, null}
!2302 = metadata !{i32 284, i32 0, metadata !270, null}
!2303 = metadata !{i32 291, i32 0, metadata !270, null}
!2304 = metadata !{i32 23, i32 0, metadata !2305, null}
!2305 = metadata !{i32 786443, metadata !305, metadata !307, i32 23, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_wcommit.c]
!2306 = metadata !{i32 24, i32 0, metadata !2307, null}
!2307 = metadata !{i32 786443, metadata !305, metadata !2305, i32 23, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_wcommit.c]
!2308 = metadata !{i32 25, i32 0, metadata !2307, null}
!2309 = metadata !{i32 26, i32 0, metadata !2307, null}
!2310 = metadata !{i32 28, i32 0, metadata !307, null}
!2311 = metadata !{i32 26, i32 0, metadata !2312, null}
!2312 = metadata !{i32 786443, metadata !399, metadata !398, i32 26, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fread.c]
!2313 = metadata !{i32 27, i32 0, metadata !2312, null}
!2314 = metadata !{i32 31, i32 0, metadata !2315, null}
!2315 = metadata !{i32 786443, metadata !399, metadata !2316, i32 31, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fread.c]
!2316 = metadata !{i32 786443, metadata !399, metadata !2312, i32 29, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fread.c]
!2317 = metadata !{i32 35, i32 0, metadata !2318, null}
!2318 = metadata !{i32 786443, metadata !399, metadata !2315, i32 31, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fread.c]
!2319 = metadata !{i32 40, i32 0, metadata !2320, null}
!2320 = metadata !{i32 786443, metadata !399, metadata !2318, i32 38, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fread.c]
!2321 = metadata !{i32 38, i32 0, metadata !2318, null}
!2322 = metadata !{i32 39, i32 0, metadata !2320, null}
!2323 = metadata !{i32 41, i32 0, metadata !2324, null}
!2324 = metadata !{i32 786443, metadata !399, metadata !2320, i32 41, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fread.c]
!2325 = metadata !{i32 48, i32 0, metadata !2326, null}
!2326 = metadata !{i32 786443, metadata !399, metadata !2318, i32 48, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fread.c]
!2327 = metadata !{i32 49, i32 0, metadata !2328, null}
!2328 = metadata !{i32 786443, metadata !399, metadata !2329, i32 49, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fread.c]
!2329 = metadata !{i32 786443, metadata !399, metadata !2326, i32 48, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fread.c]
!2330 = metadata !{i32 52, i32 0, metadata !2329, null}
!2331 = metadata !{i32 53, i32 0, metadata !2329, null}
!2332 = metadata !{i32 54, i32 0, metadata !2329, null}
!2333 = metadata !{i32 55, i32 0, metadata !2334, null}
!2334 = metadata !{i32 786443, metadata !399, metadata !2329, i32 55, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fread.c]
!2335 = metadata !{i32 63, i32 0, metadata !2336, null}
!2336 = metadata !{i32 786443, metadata !399, metadata !2318, i32 63, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fread.c]
!2337 = metadata !{i32 64, i32 0, metadata !2338, null}
!2338 = metadata !{i32 786443, metadata !399, metadata !2336, i32 63, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fread.c]
!2339 = metadata !{i32 65, i32 0, metadata !2338, null}
!2340 = metadata !{i32 71, i32 0, metadata !2318, null}
!2341 = metadata !{i32 72, i32 0, metadata !2342, null}
!2342 = metadata !{i32 786443, metadata !399, metadata !2318, i32 71, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fread.c]
!2343 = metadata !{i32 73, i32 0, metadata !2344, null}
!2344 = metadata !{i32 786443, metadata !399, metadata !2342, i32 73, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fread.c]
!2345 = metadata !{i32 80, i32 0, metadata !2318, null}
!2346 = metadata !{i32 83, i32 0, metadata !2316, null}
!2347 = metadata !{i32 84, i32 0, metadata !2316, null}
!2348 = metadata !{i32 85, i32 0, metadata !2316, null}
!2349 = metadata !{i32 89, i32 0, metadata !398, null}
!2350 = metadata !{i32 28, i32 0, metadata !431, null}
!2351 = metadata !{i32 29, i32 0, metadata !2352, null}
!2352 = metadata !{i32 786443, metadata !429, metadata !431, i32 28, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/string/memcpy.c]
!2353 = metadata !{i32 30, i32 0, metadata !2352, null}
!2354 = metadata !{i32 30, i32 0, metadata !472, null}
!2355 = metadata !{i32 43, i32 0, metadata !479, null}
!2356 = metadata !{i32 45, i32 0, metadata !479, null}
!2357 = metadata !{i32 46, i32 0, metadata !479, null}
!2358 = metadata !{i32 47, i32 0, metadata !479, null}
!2359 = metadata !{i32 48, i32 0, metadata !479, null}
!2360 = metadata !{i32 49, i32 0, metadata !479, null}
!2361 = metadata !{i32 61, i32 0, metadata !2362, null}
!2362 = metadata !{i32 786443, metadata !477, metadata !2363, i32 60, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/termios/tcgetattr.c]
!2363 = metadata !{i32 786443, metadata !477, metadata !479, i32 58, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/termios/tcgetattr.c]
!2364 = metadata !{i32 79, i32 0, metadata !479, null}
!2365 = metadata !{i32 191, i32 0, metadata !2366, null}
!2366 = metadata !{i32 786443, metadata !507, metadata !509, i32 191, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2367 = metadata !{i32 193, i32 0, metadata !509, null}
!2368 = metadata !{i32 238, i32 0, metadata !2369, null}
!2369 = metadata !{i32 786443, metadata !507, metadata !509, i32 238, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2370 = metadata !{i32 239, i32 0, metadata !2369, null}
!2371 = metadata !{i32 240, i32 0, metadata !509, null}
!2372 = metadata !{i32 294, i32 0, metadata !512, null}
!2373 = metadata !{i32 298, i32 0, metadata !2374, null}
!2374 = metadata !{i32 786443, metadata !507, metadata !512, i32 298, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2375 = metadata !{i32 300, i32 0, metadata !2376, null}
!2376 = metadata !{i32 786443, metadata !507, metadata !2374, i32 298, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2377 = metadata !{i32 301, i32 0, metadata !2376, null}
!2378 = metadata !{i32 305, i32 0, metadata !512, null}
!2379 = metadata !{i32 306, i32 0, metadata !512, null}
!2380 = metadata !{i32 307, i32 0, metadata !512, null}
!2381 = metadata !{i32 308, i32 0, metadata !2382, null}
!2382 = metadata !{i32 786443, metadata !507, metadata !512, i32 307, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2383 = metadata !{i32 311, i32 0, metadata !512, null}
!2384 = metadata !{i32 313, i32 0, metadata !2385, null}
!2385 = metadata !{i32 786443, metadata !507, metadata !2386, i32 313, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2386 = metadata !{i32 786443, metadata !507, metadata !512, i32 311, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2387 = metadata !{i32 314, i32 0, metadata !2388, null}
!2388 = metadata !{i32 786443, metadata !507, metadata !2385, i32 313, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2389 = metadata !{i32 315, i32 0, metadata !2388, null}
!2390 = metadata !{i32 316, i32 0, metadata !2386, null}
!2391 = metadata !{i32 323, i32 0, metadata !512, null}
!2392 = metadata !{i32 331, i32 0, metadata !2393, null}
!2393 = metadata !{i32 786443, metadata !507, metadata !512, i32 331, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2394 = metadata !{i32 336, i32 0, metadata !2395, null}
!2395 = metadata !{i32 786443, metadata !507, metadata !2393, i32 335, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2396 = metadata !{i32 337, i32 0, metadata !2395, null}
!2397 = metadata !{i32 338, i32 0, metadata !2395, null}
!2398 = metadata !{i32 339, i32 0, metadata !2395, null}
!2399 = metadata !{i32 342, i32 0, metadata !512, null}
!2400 = metadata !{i32 391, i32 0, metadata !2401, null}
!2401 = metadata !{i32 786443, metadata !507, metadata !512, i32 391, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2402 = metadata !{i32 392, i32 0, metadata !2401, null}
!2403 = metadata !{i32 401, i32 0, metadata !512, null}
!2404 = metadata !{i32 160, i32 0, metadata !2405, null}
!2405 = metadata !{i32 786443, metadata !507, metadata !528} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2406 = metadata !{i32 161, i32 0, metadata !2405, null}
!2407 = metadata !{i32 162, i32 0, metadata !2405, null}
!2408 = metadata !{i32 163, i32 0, metadata !2405, null}
!2409 = metadata !{i32 165, i32 0, metadata !2410, null}
!2410 = metadata !{i32 786443, metadata !507, metadata !2405, i32 165, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2411 = metadata !{i32 169, i32 0, metadata !2405, null}
!2412 = metadata !{i32 139, i32 0, metadata !2413, null}
!2413 = metadata !{i32 786443, metadata !507, metadata !519, i32 139, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2414 = metadata !{i32 143, i32 0, metadata !2415, null}
!2415 = metadata !{i32 786443, metadata !507, metadata !2413, i32 140, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2416 = metadata !{i32 147, i32 0, metadata !2417, null}
!2417 = metadata !{i32 786443, metadata !507, metadata !2415, i32 147, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2418 = metadata !{i32 148, i32 18, metadata !2417, null}
!2419 = metadata !{i32 150, i32 0, metadata !2420, null}
!2420 = metadata !{i32 786443, metadata !507, metadata !2417, i32 149, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!2421 = metadata !{i32 153, i32 0, metadata !519, null}
!2422 = metadata !{i32 56, i32 0, metadata !2423, null}
!2423 = metadata !{i32 786443, metadata !523, metadata !522} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/./include/sys/sysmacros.h]
!2424 = metadata !{i32 38, i32 0, metadata !2425, null}
!2425 = metadata !{i32 786443, metadata !560, metadata !562, i32 38, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_READ.c]
!2426 = metadata !{i32 39, i32 0, metadata !2427, null}
!2427 = metadata !{i32 786443, metadata !560, metadata !2428, i32 39, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_READ.c]
!2428 = metadata !{i32 786443, metadata !560, metadata !2425, i32 38, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_READ.c]
!2429 = metadata !{i32 47, i32 0, metadata !2430, null}
!2430 = metadata !{i32 786443, metadata !560, metadata !2428, i32 47, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_READ.c]
!2431 = metadata !{i32 48, i32 0, metadata !2432, null}
!2432 = metadata !{i32 786443, metadata !560, metadata !2433, i32 48, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_READ.c]
!2433 = metadata !{i32 786443, metadata !560, metadata !2430, i32 47, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_READ.c]
!2434 = metadata !{i32 49, i32 0, metadata !2435, null}
!2435 = metadata !{i32 786443, metadata !560, metadata !2432, i32 48, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_READ.c]
!2436 = metadata !{i32 50, i32 0, metadata !2435, null}
!2437 = metadata !{i32 52, i32 0, metadata !2438, null}
!2438 = metadata !{i32 786443, metadata !560, metadata !2432, i32 50, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_READ.c]
!2439 = metadata !{i32 68, i32 0, metadata !562, null}
!2440 = metadata !{i32 47, i32 0, metadata !2441, null}
!2441 = metadata !{i32 786443, metadata !590, metadata !2442, i32 47, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_WRITE.c]
!2442 = metadata !{i32 786443, metadata !590, metadata !592, i32 46, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_WRITE.c]
!2443 = metadata !{i32 52, i32 0, metadata !2444, null}
!2444 = metadata !{i32 786443, metadata !590, metadata !2442, i32 52, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_WRITE.c]
!2445 = metadata !{i32 51, i32 0, metadata !2442, null}
!2446 = metadata !{i32 62, i32 0, metadata !2447, null}
!2447 = metadata !{i32 786443, metadata !590, metadata !2444, i32 52, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_WRITE.c]
!2448 = metadata !{i32 63, i32 0, metadata !2447, null}
!2449 = metadata !{i32 70, i32 0, metadata !2450, null}
!2450 = metadata !{i32 786443, metadata !590, metadata !2444, i32 69, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_WRITE.c]
!2451 = metadata !{i32 73, i32 0, metadata !2452, null}
!2452 = metadata !{i32 786443, metadata !590, metadata !2450, i32 73, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_WRITE.c]
!2453 = metadata !{i32 76, i32 0, metadata !2454, null}
!2454 = metadata !{i32 786443, metadata !590, metadata !2455, i32 76, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_WRITE.c]
!2455 = metadata !{i32 786443, metadata !590, metadata !2452, i32 73, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_WRITE.c]
!2456 = metadata !{i32 80, i32 0, metadata !2455, null}
!2457 = metadata !{i32 82, i32 0, metadata !2455, null}
!2458 = metadata !{i32 83, i32 0, metadata !2459, null}
!2459 = metadata !{i32 786443, metadata !590, metadata !2460, i32 83, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_WRITE.c]
!2460 = metadata !{i32 786443, metadata !590, metadata !2455, i32 82, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_WRITE.c]
!2461 = metadata !{i32 88, i32 0, metadata !2460, null}
!2462 = metadata !{i32 89, i32 0, metadata !2460, null}
!2463 = metadata !{i32 90, i32 0, metadata !2460, null}
!2464 = metadata !{i32 92, i32 0, metadata !2455, null}
!2465 = metadata !{i32 94, i32 0, metadata !2455, null}
!2466 = metadata !{i32 95, i32 0, metadata !2455, null}
!2467 = metadata !{i32 99, i32 0, metadata !2450, null}
!2468 = metadata !{i32 102, i32 0, metadata !592, null}
!2469 = metadata !{i32 34, i32 0, metadata !2470, null}
!2470 = metadata !{i32 786443, metadata !653, metadata !655, i32 34, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_trans2r.c]
!2471 = metadata !{i32 35, i32 0, metadata !2472, null}
!2472 = metadata !{i32 786443, metadata !653, metadata !2473, i32 35, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_trans2r.c]
!2473 = metadata !{i32 786443, metadata !653, metadata !2470, i32 34, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_trans2r.c]
!2474 = metadata !{i32 39, i32 0, metadata !2473, null}
!2475 = metadata !{i32 40, i32 0, metadata !2473, null}
!2476 = metadata !{i32 43, i32 0, metadata !2477, null}
!2477 = metadata !{i32 786443, metadata !653, metadata !655, i32 43, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_trans2r.c]
!2478 = metadata !{i32 47, i32 0, metadata !2479, null}
!2479 = metadata !{i32 786443, metadata !653, metadata !2477, i32 43, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_trans2r.c]
!2480 = metadata !{i32 51, i32 0, metadata !2479, null}
!2481 = metadata !{i32 53, i32 0, metadata !2479, null}
!2482 = metadata !{i32 56, i32 0, metadata !2483, null}
!2483 = metadata !{i32 786443, metadata !653, metadata !655, i32 56, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_trans2r.c]
!2484 = metadata !{i32 74, i32 0, metadata !655, null}
!2485 = metadata !{i32 58, i32 0, metadata !2486, null} ; [ DW_TAG_imported_module ]
!2486 = metadata !{i32 786443, metadata !653, metadata !2487, i32 58, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_trans2r.c]
!2487 = metadata !{i32 786443, metadata !653, metadata !2483, i32 56, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/_trans2r.c]
!2488 = metadata !{i32 63, i32 0, metadata !2487, null}
!2489 = metadata !{i32 64, i32 0, metadata !2487, null}
!2490 = metadata !{i32 72, i32 0, metadata !2487, null}
!2491 = metadata !{i32 78, i32 0, metadata !655, null}
!2492 = metadata !{i32 79, i32 0, metadata !655, null}
!2493 = metadata !{i32 85, i32 0, metadata !2494, null}
!2494 = metadata !{i32 786443, metadata !716, metadata !715, i32 85, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fflush.c]
!2495 = metadata !{i32 90, i32 0, metadata !2496, null}
!2496 = metadata !{i32 786443, metadata !716, metadata !715, i32 90, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fflush.c]
!2497 = metadata !{i32 95, i32 0, metadata !2498, null}
!2498 = metadata !{i32 786443, metadata !716, metadata !2496, i32 90, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fflush.c]
!2499 = metadata !{i32 98, i32 0, metadata !2498, null}
!2500 = metadata !{i32 103, i32 0, metadata !2501, null}
!2501 = metadata !{i32 786443, metadata !716, metadata !2502, i32 103, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fflush.c]
!2502 = metadata !{i32 786443, metadata !716, metadata !2498, i32 98, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fflush.c]
!2503 = metadata !{i32 106, i32 0, metadata !2504, null}
!2504 = metadata !{i32 786443, metadata !716, metadata !2505, i32 106, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fflush.c]
!2505 = metadata !{i32 786443, metadata !716, metadata !2501, i32 103, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fflush.c]
!2506 = metadata !{i32 110, i32 0, metadata !2507, null}
!2507 = metadata !{i32 786443, metadata !716, metadata !2508, i32 110, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fflush.c]
!2508 = metadata !{i32 786443, metadata !716, metadata !2504, i32 109, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fflush.c]
!2509 = metadata !{i32 111, i32 0, metadata !2510, null}
!2510 = metadata !{i32 786443, metadata !716, metadata !2507, i32 110, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fflush.c]
!2511 = metadata !{i32 112, i32 0, metadata !2510, null}
!2512 = metadata !{i32 113, i32 0, metadata !2510, null}
!2513 = metadata !{i32 119, i32 0, metadata !2502, null}
!2514 = metadata !{i32 124, i32 0, metadata !2515, null}
!2515 = metadata !{i32 786443, metadata !716, metadata !2496, i32 124, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fflush.c]
!2516 = metadata !{i32 125, i32 0, metadata !2517, null}
!2517 = metadata !{i32 786443, metadata !716, metadata !2518, i32 125, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fflush.c]
!2518 = metadata !{i32 786443, metadata !716, metadata !2515, i32 124, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fflush.c]
!2519 = metadata !{i32 126, i32 0, metadata !2520, null}
!2520 = metadata !{i32 786443, metadata !716, metadata !2517, i32 125, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/stdio/fflush.c]
!2521 = metadata !{i32 127, i32 0, metadata !2520, null}
!2522 = metadata !{i32 128, i32 0, metadata !2520, null}
!2523 = metadata !{i32 150, i32 0, metadata !715, null}
!2524 = metadata !{i32 30, i32 0, metadata !753, null}
!2525 = metadata !{i32 31, i32 0, metadata !2526, null}
!2526 = metadata !{i32 786443, metadata !751, metadata !753, i32 30, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/string/mempcpy.c]
!2527 = metadata !{i32 32, i32 0, metadata !2526, null}
!2528 = metadata !{i32 36, i32 0, metadata !753, null}
!2529 = metadata !{i32 27, i32 0, metadata !761, null}
!2530 = metadata !{i32 28, i32 0, metadata !2531, null}
!2531 = metadata !{i32 786443, metadata !759, metadata !761, i32 27, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee-uclibc/libc/string/memset.c]
!2532 = metadata !{i32 29, i32 0, metadata !2531, null}
!2533 = metadata !{i32 133, i32 0, metadata !2534, null}
!2534 = metadata !{i32 786443, metadata !898, metadata !981, i32 133, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2535 = metadata !{i32 134, i32 0, metadata !2536, null}
!2536 = metadata !{i32 786443, metadata !898, metadata !2534, i32 134, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2537 = metadata !{metadata !2538, metadata !2539, i64 4}
!2538 = metadata !{metadata !"", metadata !2539, i64 0, metadata !2539, i64 4, metadata !2542, i64 8, metadata !2543, i64 16}
!2539 = metadata !{metadata !"int", metadata !2540, i64 0}
!2540 = metadata !{metadata !"omnipotent char", metadata !2541, i64 0}
!2541 = metadata !{metadata !"Simple C/C++ TBAA"}
!2542 = metadata !{metadata !"long", metadata !2540, i64 0}
!2543 = metadata !{metadata !"any pointer", metadata !2540, i64 0}
!2544 = metadata !{i32 136, i32 0, metadata !2545, null}
!2545 = metadata !{i32 786443, metadata !898, metadata !981, i32 136, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2546 = metadata !{i32 137, i32 0, metadata !2547, null}
!2547 = metadata !{i32 786443, metadata !898, metadata !2545, i32 136, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2548 = metadata !{metadata !2539, metadata !2539, i64 0}
!2549 = metadata !{i32 138, i32 0, metadata !2547, null}
!2550 = metadata !{i32 141, i32 0, metadata !981, null}
!2551 = metadata !{i32 144, i32 0, metadata !981, null}
!2552 = metadata !{i32 40, i32 0, metadata !1528, metadata !2553}
!2553 = metadata !{i32 146, i32 0, metadata !981, null}
!2554 = metadata !{metadata !2540, metadata !2540, i64 0}
!2555 = metadata !{i32 43, i32 0, metadata !2556, metadata !2553}
!2556 = metadata !{i32 786443, metadata !898, metadata !1528, i32 43, i32 0, i32 379} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2557 = metadata !{i32 46, i32 0, metadata !1539, metadata !2553}
!2558 = metadata !{metadata !2559, metadata !2539, i64 0}
!2559 = metadata !{metadata !"", metadata !2539, i64 0, metadata !2543, i64 8, metadata !2543, i64 16, metadata !2539, i64 24, metadata !2543, i64 32, metadata !2539, i64 40, metadata !2543, i64 48, metadata !2543, i64 56, metadata !2543, i64 64, metadat
!2560 = metadata !{i32 47, i32 0, metadata !1537, metadata !2553}
!2561 = metadata !{i32 48, i32 0, metadata !1536, metadata !2553}
!2562 = metadata !{metadata !2559, metadata !2543, i64 32}
!2563 = metadata !{i32 49, i32 0, metadata !2564, metadata !2553}
!2564 = metadata !{i32 786443, metadata !898, metadata !1536, i32 49, i32 0, i32 384} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2565 = metadata !{metadata !2566, metadata !2543, i64 16}
!2566 = metadata !{metadata !"", metadata !2539, i64 0, metadata !2543, i64 8, metadata !2543, i64 16}
!2567 = metadata !{metadata !2568, metadata !2542, i64 8}
!2568 = metadata !{metadata !"stat64", metadata !2542, i64 0, metadata !2542, i64 8, metadata !2542, i64 16, metadata !2539, i64 24, metadata !2539, i64 28, metadata !2539, i64 32, metadata !2539, i64 36, metadata !2542, i64 40, metadata !2542, i64 48, m
!2569 = metadata !{metadata !"timespec", metadata !2542, i64 0, metadata !2542, i64 8}
!2570 = metadata !{i32 147, i32 0, metadata !1003, null}
!2571 = metadata !{i32 150, i32 0, metadata !2572, null}
!2572 = metadata !{i32 786443, metadata !898, metadata !1003, i32 147, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2573 = metadata !{metadata !2538, metadata !2543, i64 16}
!2574 = metadata !{i32 152, i32 0, metadata !2575, null}
!2575 = metadata !{i32 786443, metadata !898, metadata !2572, i32 152, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2576 = metadata !{i32 153, i32 0, metadata !2577, null}
!2577 = metadata !{i32 786443, metadata !898, metadata !2575, i32 152, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2578 = metadata !{i32 154, i32 0, metadata !2577, null}
!2579 = metadata !{i32 168, i32 0, metadata !2580, null}
!2580 = metadata !{i32 786443, metadata !898, metadata !2581, i32 165, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2581 = metadata !{i32 786443, metadata !898, metadata !2572, i32 165, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2582 = metadata !{i32 169, i32 0, metadata !2580, null}
!2583 = metadata !{i32 170, i32 0, metadata !2580, null}
!2584 = metadata !{i32 99, i32 0, metadata !1521, metadata !2585}
!2585 = metadata !{i32 173, i32 0, metadata !2586, null}
!2586 = metadata !{i32 786443, metadata !898, metadata !2572, i32 173, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2587 = metadata !{metadata !2568, metadata !2539, i64 24}
!2588 = metadata !{i32 101, i32 0, metadata !2589, metadata !2585}
!2589 = metadata !{i32 786443, metadata !898, metadata !1521, i32 101, i32 0, i32 375} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2590 = metadata !{i32 118, i32 0, metadata !2591, metadata !2585}
!2591 = metadata !{i32 786443, metadata !898, metadata !1521, i32 118, i32 0, i32 377} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2592 = metadata !{i32 105, i32 0, metadata !2593, metadata !2585}
!2593 = metadata !{i32 786443, metadata !898, metadata !1521, i32 105, i32 0, i32 376} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2594 = metadata !{i32 121, i32 0, metadata !2595, metadata !2585}
!2595 = metadata !{i32 786443, metadata !898, metadata !1521, i32 121, i32 0, i32 378} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2596 = metadata !{i32 174, i32 0, metadata !2597, null}
!2597 = metadata !{i32 786443, metadata !898, metadata !2586, i32 173, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2598 = metadata !{i32 175, i32 0, metadata !2597, null}
!2599 = metadata !{i32 178, i32 0, metadata !2586, null}
!2600 = metadata !{metadata !2601, metadata !2539, i64 768}
!2601 = metadata !{metadata !"", metadata !2540, i64 0, metadata !2539, i64 768, metadata !2539, i64 772, metadata !2539, i64 776}
!2602 = metadata !{i32 180, i32 0, metadata !2572, null}
!2603 = metadata !{i32 1417, i32 0, metadata !1494, metadata !2604}
!2604 = metadata !{i32 1429, i32 0, metadata !1475, metadata !2605}
!2605 = metadata !{i32 181, i32 0, metadata !1002, null}
!2606 = metadata !{i32 1418, i32 0, metadata !1494, metadata !2604}
!2607 = metadata !{i32 1432, i32 0, metadata !1484, metadata !2605}
!2608 = metadata !{i32 1433, i32 0, metadata !1483, metadata !2605}
!2609 = metadata !{i32 1434, i32 0, metadata !1487, metadata !2605}
!2610 = metadata !{i32 1435, i32 0, metadata !2611, metadata !2605}
!2611 = metadata !{i32 786443, metadata !898, metadata !2612, i32 1435, i32 0, i32 362} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2612 = metadata !{i32 786443, metadata !898, metadata !1487, i32 1434, i32 0, i32 361} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2613 = metadata !{i32 1436, i32 0, metadata !2614, metadata !2605}
!2614 = metadata !{i32 786443, metadata !898, metadata !2611, i32 1435, i32 0, i32 363} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2615 = metadata !{i32 1437, i32 0, metadata !2614, metadata !2605}
!2616 = metadata !{i32 1439, i32 0, metadata !2617, metadata !2605}
!2617 = metadata !{i32 786443, metadata !898, metadata !2618, i32 1438, i32 0, i32 365} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2618 = metadata !{i32 786443, metadata !898, metadata !2611, i32 1438, i32 0, i32 364} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2619 = metadata !{i32 1440, i32 0, metadata !2617, metadata !2605}
!2620 = metadata !{i32 1442, i32 0, metadata !1486, metadata !2605}
!2621 = metadata !{i32 1443, i32 0, metadata !1486, metadata !2605}
!2622 = metadata !{i32 1444, i32 0, metadata !1486, metadata !2605}
!2623 = metadata !{i32 1445, i32 0, metadata !2624, metadata !2605}
!2624 = metadata !{i32 786443, metadata !898, metadata !1486, i32 1445, i32 0, i32 367} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2625 = metadata !{i32 182, i32 0, metadata !2626, null}
!2626 = metadata !{i32 786443, metadata !898, metadata !1002, i32 182, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2627 = metadata !{i32 183, i32 0, metadata !2628, null}
!2628 = metadata !{i32 786443, metadata !898, metadata !2626, i32 182, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2629 = metadata !{i32 184, i32 0, metadata !2628, null}
!2630 = metadata !{i32 186, i32 0, metadata !1002, null}
!2631 = metadata !{metadata !2538, metadata !2539, i64 0}
!2632 = metadata !{i32 190, i32 0, metadata !2633, null}
!2633 = metadata !{i32 786443, metadata !898, metadata !981, i32 190, i32 0, i32 21} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2634 = metadata !{i32 189, i32 0, metadata !981, null}
!2635 = metadata !{i32 191, i32 0, metadata !2636, null}
!2636 = metadata !{i32 786443, metadata !898, metadata !2633, i32 190, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2637 = metadata !{i32 192, i32 0, metadata !2636, null}
!2638 = metadata !{i32 193, i32 0, metadata !2639, null}
!2639 = metadata !{i32 786443, metadata !898, metadata !2640, i32 192, i32 0, i32 24} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2640 = metadata !{i32 786443, metadata !898, metadata !2633, i32 192, i32 0, i32 23} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2641 = metadata !{i32 194, i32 0, metadata !2639, null}
!2642 = metadata !{i32 195, i32 0, metadata !2643, null}
!2643 = metadata !{i32 786443, metadata !898, metadata !2640, i32 194, i32 0, i32 25} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2644 = metadata !{i32 199, i32 0, metadata !981, null}
!2645 = metadata !{i32 339, i32 0, metadata !1050, null}
!2646 = metadata !{i32 341, i32 0, metadata !2647, null}
!2647 = metadata !{i32 786443, metadata !898, metadata !1050, i32 341, i32 0, i32 61} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2648 = metadata !{i32 344, i32 0, metadata !2649, null}
!2649 = metadata !{i32 786443, metadata !898, metadata !1050, i32 344, i32 0, i32 62} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2650 = metadata !{i32 345, i32 0, metadata !2651, null}
!2651 = metadata !{i32 786443, metadata !898, metadata !2649, i32 344, i32 0, i32 63} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2652 = metadata !{i32 346, i32 0, metadata !2651, null}
!2653 = metadata !{i32 64, i32 0, metadata !1520, metadata !2654}
!2654 = metadata !{i32 349, i32 0, metadata !1050, null}
!2655 = metadata !{i32 65, i32 0, metadata !1519, metadata !2654}
!2656 = metadata !{i32 66, i32 0, metadata !2657, metadata !2654}
!2657 = metadata !{i32 786443, metadata !898, metadata !1519, i32 66, i32 0, i32 374} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2658 = metadata !{i32 351, i32 0, metadata !2659, null}
!2659 = metadata !{i32 786443, metadata !898, metadata !1050, i32 351, i32 0, i32 64} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2660 = metadata !{i32 352, i32 0, metadata !2661, null}
!2661 = metadata !{i32 786443, metadata !898, metadata !2659, i32 351, i32 0, i32 65} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2662 = metadata !{i32 353, i32 0, metadata !2661, null}
!2663 = metadata !{i32 356, i32 0, metadata !2664, null}
!2664 = metadata !{i32 786443, metadata !898, metadata !1050, i32 356, i32 0, i32 66} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2665 = metadata !{metadata !2559, metadata !2539, i64 40}
!2666 = metadata !{metadata !2559, metadata !2543, i64 48}
!2667 = metadata !{i32 357, i32 0, metadata !2668, null}
!2668 = metadata !{i32 786443, metadata !898, metadata !2664, i32 356, i32 0, i32 67} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2669 = metadata !{i32 358, i32 0, metadata !2668, null}
!2670 = metadata !{i32 359, i32 0, metadata !2668, null}
!2671 = metadata !{i32 362, i32 0, metadata !1063, null}
!2672 = metadata !{i32 1417, i32 0, metadata !1494, metadata !2673}
!2673 = metadata !{i32 365, i32 0, metadata !1062, null}
!2674 = metadata !{i32 1418, i32 0, metadata !1494, metadata !2673}
!2675 = metadata !{i32 1423, i32 0, metadata !1488, metadata !2676}
!2676 = metadata !{i32 366, i32 0, metadata !1062, null}
!2677 = metadata !{i32 1424, i32 0, metadata !1488, metadata !2676}
!2678 = metadata !{i32 370, i32 0, metadata !1062, null}
!2679 = metadata !{i32 371, i32 0, metadata !2680, null}
!2680 = metadata !{i32 786443, metadata !898, metadata !1062, i32 371, i32 0, i32 70} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2681 = metadata !{i32 372, i32 0, metadata !2680, null}
!2682 = metadata !{i32 374, i32 0, metadata !2680, null}
!2683 = metadata !{metadata !2538, metadata !2542, i64 8}
!2684 = metadata !{i32 376, i32 0, metadata !2685, null}
!2685 = metadata !{i32 786443, metadata !898, metadata !1062, i32 376, i32 0, i32 71} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2686 = metadata !{i32 377, i32 0, metadata !2687, null}
!2687 = metadata !{i32 786443, metadata !898, metadata !2685, i32 376, i32 0, i32 72} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2688 = metadata !{i32 378, i32 0, metadata !2687, null}
!2689 = metadata !{i32 381, i32 0, metadata !2690, null}
!2690 = metadata !{i32 786443, metadata !898, metadata !1062, i32 381, i32 0, i32 73} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2691 = metadata !{i32 383, i32 0, metadata !1062, null}
!2692 = metadata !{i32 382, i32 0, metadata !2690, null}
!2693 = metadata !{i32 386, i32 0, metadata !2694, null}
!2694 = metadata !{i32 786443, metadata !898, metadata !1063, i32 385, i32 0, i32 74} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2695 = metadata !{i32 387, i32 0, metadata !2696, null}
!2696 = metadata !{i32 786443, metadata !898, metadata !2694, i32 387, i32 0, i32 75} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2697 = metadata !{metadata !2566, metadata !2539, i64 0}
!2698 = metadata !{i32 391, i32 0, metadata !2699, null}
!2699 = metadata !{i32 786443, metadata !898, metadata !2694, i32 391, i32 0, i32 76} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2700 = metadata !{i32 392, i32 0, metadata !2701, null}
!2701 = metadata !{i32 786443, metadata !898, metadata !2699, i32 391, i32 0, i32 77} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2702 = metadata !{i32 395, i32 0, metadata !2694, null}
!2703 = metadata !{metadata !2566, metadata !2543, i64 8}
!2704 = metadata !{i32 396, i32 0, metadata !2694, null}
!2705 = metadata !{i32 398, i32 0, metadata !2694, null}
!2706 = metadata !{i32 400, i32 0, metadata !1050, null}
!2707 = metadata !{i32 407, i32 0, metadata !1064, null}
!2708 = metadata !{i32 64, i32 0, metadata !1520, metadata !2709}
!2709 = metadata !{i32 409, i32 0, metadata !1064, null}
!2710 = metadata !{i32 65, i32 0, metadata !1519, metadata !2709}
!2711 = metadata !{i32 66, i32 0, metadata !2657, metadata !2709}
!2712 = metadata !{i32 411, i32 0, metadata !2713, null}
!2713 = metadata !{i32 786443, metadata !898, metadata !1064, i32 411, i32 0, i32 78} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2714 = metadata !{i32 412, i32 0, metadata !2715, null}
!2715 = metadata !{i32 786443, metadata !898, metadata !2713, i32 411, i32 0, i32 79} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2716 = metadata !{i32 413, i32 0, metadata !2715, null}
!2717 = metadata !{i32 416, i32 0, metadata !2718, null}
!2718 = metadata !{i32 786443, metadata !898, metadata !1064, i32 416, i32 0, i32 80} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2719 = metadata !{metadata !2559, metadata !2543, i64 56}
!2720 = metadata !{i32 417, i32 0, metadata !2721, null}
!2721 = metadata !{i32 786443, metadata !898, metadata !2718, i32 416, i32 0, i32 81} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2722 = metadata !{i32 418, i32 0, metadata !2721, null}
!2723 = metadata !{i32 419, i32 0, metadata !2721, null}
!2724 = metadata !{i32 422, i32 0, metadata !1074, null}
!2725 = metadata !{i32 1417, i32 0, metadata !1494, metadata !2726}
!2726 = metadata !{i32 425, i32 0, metadata !1073, null}
!2727 = metadata !{i32 1418, i32 0, metadata !1494, metadata !2726}
!2728 = metadata !{i32 1423, i32 0, metadata !1488, metadata !2729}
!2729 = metadata !{i32 426, i32 0, metadata !1073, null}
!2730 = metadata !{i32 1424, i32 0, metadata !1488, metadata !2729}
!2731 = metadata !{i32 430, i32 0, metadata !1073, null}
!2732 = metadata !{i32 431, i32 0, metadata !2733, null}
!2733 = metadata !{i32 786443, metadata !898, metadata !1073, i32 431, i32 0, i32 84} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2734 = metadata !{i32 432, i32 0, metadata !2733, null}
!2735 = metadata !{i32 433, i32 0, metadata !2733, null}
!2736 = metadata !{i32 435, i32 0, metadata !2737, null}
!2737 = metadata !{i32 786443, metadata !898, metadata !1073, i32 435, i32 0, i32 85} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2738 = metadata !{i32 436, i32 0, metadata !2739, null}
!2739 = metadata !{i32 786443, metadata !898, metadata !2737, i32 435, i32 0, i32 86} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2740 = metadata !{i32 437, i32 0, metadata !2739, null}
!2741 = metadata !{i32 440, i32 0, metadata !1073, null}
!2742 = metadata !{i32 441, i32 0, metadata !2743, null}
!2743 = metadata !{i32 786443, metadata !898, metadata !1073, i32 441, i32 0, i32 87} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2744 = metadata !{i32 444, i32 0, metadata !1073, null}
!2745 = metadata !{i32 442, i32 0, metadata !2743, null}
!2746 = metadata !{i32 449, i32 0, metadata !2747, null}
!2747 = metadata !{i32 786443, metadata !898, metadata !1076, i32 449, i32 0, i32 89} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2748 = metadata !{i32 452, i32 0, metadata !2749, null}
!2749 = metadata !{i32 786443, metadata !898, metadata !2750, i32 452, i32 0, i32 91} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2750 = metadata !{i32 786443, metadata !898, metadata !2747, i32 451, i32 0, i32 90} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2751 = metadata !{metadata !2601, metadata !2539, i64 776}
!2752 = metadata !{i32 453, i32 0, metadata !2749, null}
!2753 = metadata !{i32 455, i32 0, metadata !2754, null}
!2754 = metadata !{i32 786443, metadata !898, metadata !2755, i32 455, i32 0, i32 93} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2755 = metadata !{i32 786443, metadata !898, metadata !2749, i32 454, i32 0, i32 92} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2756 = metadata !{i32 456, i32 0, metadata !2754, null}
!2757 = metadata !{i32 460, i32 0, metadata !2758, null}
!2758 = metadata !{i32 786443, metadata !898, metadata !1076, i32 460, i32 0, i32 94} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2759 = metadata !{i32 461, i32 0, metadata !2758, null}
!2760 = metadata !{i32 463, i32 0, metadata !2761, null}
!2761 = metadata !{i32 786443, metadata !898, metadata !1076, i32 463, i32 0, i32 95} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2762 = metadata !{i32 464, i32 0, metadata !2761, null}
!2763 = metadata !{i32 466, i32 0, metadata !2764, null}
!2764 = metadata !{i32 786443, metadata !898, metadata !1076, i32 466, i32 0, i32 96} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2765 = metadata !{metadata !2559, metadata !2543, i64 16}
!2766 = metadata !{i32 467, i32 0, metadata !2764, null}
!2767 = metadata !{metadata !2559, metadata !2539, i64 24}
!2768 = metadata !{i32 469, i32 0, metadata !1076, null}
!2769 = metadata !{i32 470, i32 0, metadata !1076, null}
!2770 = metadata !{i32 472, i32 0, metadata !1064, null}
!2771 = metadata !{i32 46, i32 0, metadata !1539, metadata !2772}
!2772 = metadata !{i32 533, i32 0, metadata !1086, null}
!2773 = metadata !{i32 47, i32 0, metadata !1537, metadata !2772}
!2774 = metadata !{i32 48, i32 0, metadata !1536, metadata !2772}
!2775 = metadata !{i32 49, i32 0, metadata !2564, metadata !2772}
!2776 = metadata !{i32 534, i32 0, metadata !2777, null}
!2777 = metadata !{i32 786443, metadata !898, metadata !1086, i32 534, i32 0, i32 112} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2778 = metadata !{i32 535, i32 0, metadata !2779, null}
!2779 = metadata !{i32 786443, metadata !898, metadata !2777, i32 534, i32 0, i32 113} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2780 = metadata !{i32 536, i32 0, metadata !2779, null}
!2781 = metadata !{i32 1417, i32 0, metadata !1494, metadata !2782}
!2782 = metadata !{i32 1429, i32 0, metadata !1475, metadata !2783}
!2783 = metadata !{i32 541, i32 0, metadata !1094, null}
!2784 = metadata !{i32 1418, i32 0, metadata !1494, metadata !2782}
!2785 = metadata !{i32 1432, i32 0, metadata !1484, metadata !2783}
!2786 = metadata !{i32 1433, i32 0, metadata !1483, metadata !2783}
!2787 = metadata !{i32 1434, i32 0, metadata !1487, metadata !2783}
!2788 = metadata !{i32 1435, i32 0, metadata !2611, metadata !2783}
!2789 = metadata !{i32 1436, i32 0, metadata !2614, metadata !2783}
!2790 = metadata !{i32 1437, i32 0, metadata !2614, metadata !2783}
!2791 = metadata !{i32 1439, i32 0, metadata !2617, metadata !2783}
!2792 = metadata !{i32 1440, i32 0, metadata !2617, metadata !2783}
!2793 = metadata !{i32 1442, i32 0, metadata !1486, metadata !2783}
!2794 = metadata !{i32 1443, i32 0, metadata !1486, metadata !2783}
!2795 = metadata !{i32 1444, i32 0, metadata !1486, metadata !2783}
!2796 = metadata !{i32 1445, i32 0, metadata !2624, metadata !2783}
!2797 = metadata !{i32 545, i32 0, metadata !2798, null}
!2798 = metadata !{i32 786443, metadata !898, metadata !1094, i32 545, i32 0, i32 115} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2799 = metadata !{i32 546, i32 0, metadata !2798, null}
!2800 = metadata !{i32 64, i32 0, metadata !1520, metadata !2801}
!2801 = metadata !{i32 759, i32 0, metadata !1201, null}
!2802 = metadata !{i32 65, i32 0, metadata !1519, metadata !2801}
!2803 = metadata !{i32 66, i32 0, metadata !2657, metadata !2801}
!2804 = metadata !{i32 761, i32 0, metadata !2805, null}
!2805 = metadata !{i32 786443, metadata !898, metadata !1201, i32 761, i32 0, i32 167} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2806 = metadata !{i32 762, i32 0, metadata !2807, null}
!2807 = metadata !{i32 786443, metadata !898, metadata !2805, i32 761, i32 0, i32 168} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2808 = metadata !{i32 763, i32 0, metadata !2807, null}
!2809 = metadata !{i32 766, i32 0, metadata !1210, null}
!2810 = metadata !{i32 768, i32 0, metadata !1209, null}
!2811 = metadata !{i32 772, i32 0, metadata !2812, null}
!2812 = metadata !{i32 786443, metadata !898, metadata !1209, i32 772, i32 0, i32 171} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2813 = metadata !{i32 773, i32 0, metadata !2812, null}
!2814 = metadata !{i32 777, i32 0, metadata !1201, null}
!2815 = metadata !{i32 778, i32 0, metadata !1201, null}
!2816 = metadata !{i32 779, i32 0, metadata !1201, null}
!2817 = metadata !{i32 64, i32 0, metadata !1520, metadata !2818}
!2818 = metadata !{i32 902, i32 0, metadata !1257, null}
!2819 = metadata !{i32 65, i32 0, metadata !1519, metadata !2818}
!2820 = metadata !{i32 66, i32 0, metadata !2657, metadata !2818}
!2821 = metadata !{i32 910, i32 0, metadata !2822, null}
!2822 = metadata !{i32 786443, metadata !898, metadata !1257, i32 910, i32 0, i32 196} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2823 = metadata !{i32 911, i32 0, metadata !2824, null}
!2824 = metadata !{i32 786443, metadata !898, metadata !2822, i32 910, i32 0, i32 197} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2825 = metadata !{i32 912, i32 0, metadata !2824, null}
!2826 = metadata !{i32 915, i32 0, metadata !1257, null}
!2827 = metadata !{i32 916, i32 0, metadata !1257, null}
!2828 = metadata !{i32 917, i32 0, metadata !1257, null}
!2829 = metadata !{i32 919, i32 0, metadata !1279, null}
!2830 = metadata !{i32 920, i32 0, metadata !1278, null}
!2831 = metadata !{i32 926, i32 0, metadata !1281, null}
!2832 = metadata !{i32 929, i32 0, metadata !2833, null}
!2833 = metadata !{i32 786443, metadata !898, metadata !1281, i32 929, i32 0, i32 202} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2834 = metadata !{metadata !2835, metadata !2539, i64 24}
!2835 = metadata !{metadata !"stat", metadata !2542, i64 0, metadata !2542, i64 8, metadata !2542, i64 16, metadata !2539, i64 24, metadata !2539, i64 28, metadata !2539, i64 32, metadata !2539, i64 36, metadata !2542, i64 40, metadata !2542, i64 48, met
!2836 = metadata !{i32 932, i32 0, metadata !2837, null}
!2837 = metadata !{i32 786443, metadata !898, metadata !2833, i32 929, i32 0, i32 203} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2838 = metadata !{metadata !2839, metadata !2539, i64 0}
!2839 = metadata !{metadata !"termios", metadata !2539, i64 0, metadata !2539, i64 4, metadata !2539, i64 8, metadata !2539, i64 12, metadata !2540, i64 16, metadata !2540, i64 17, metadata !2539, i64 52, metadata !2539, i64 56}
!2840 = metadata !{i32 933, i32 0, metadata !2837, null}
!2841 = metadata !{metadata !2839, metadata !2539, i64 4}
!2842 = metadata !{i32 934, i32 0, metadata !2837, null}
!2843 = metadata !{metadata !2839, metadata !2539, i64 8}
!2844 = metadata !{i32 935, i32 0, metadata !2837, null}
!2845 = metadata !{metadata !2839, metadata !2539, i64 12}
!2846 = metadata !{i32 936, i32 0, metadata !2837, null}
!2847 = metadata !{metadata !2839, metadata !2540, i64 16}
!2848 = metadata !{i32 937, i32 0, metadata !2837, null}
!2849 = metadata !{i32 938, i32 0, metadata !2837, null}
!2850 = metadata !{i32 939, i32 0, metadata !2837, null}
!2851 = metadata !{i32 940, i32 0, metadata !2837, null}
!2852 = metadata !{i32 941, i32 0, metadata !2837, null}
!2853 = metadata !{i32 942, i32 0, metadata !2837, null}
!2854 = metadata !{i32 943, i32 0, metadata !2837, null}
!2855 = metadata !{i32 944, i32 0, metadata !2837, null}
!2856 = metadata !{i32 945, i32 0, metadata !2837, null}
!2857 = metadata !{i32 946, i32 0, metadata !2837, null}
!2858 = metadata !{i32 947, i32 0, metadata !2837, null}
!2859 = metadata !{i32 948, i32 0, metadata !2837, null}
!2860 = metadata !{i32 949, i32 0, metadata !2837, null}
!2861 = metadata !{i32 950, i32 0, metadata !2837, null}
!2862 = metadata !{i32 951, i32 0, metadata !2837, null}
!2863 = metadata !{i32 952, i32 0, metadata !2837, null}
!2864 = metadata !{i32 953, i32 0, metadata !2837, null}
!2865 = metadata !{i32 954, i32 0, metadata !2837, null}
!2866 = metadata !{i32 955, i32 0, metadata !2837, null}
!2867 = metadata !{i32 956, i32 0, metadata !2837, null}
!2868 = metadata !{i32 958, i32 0, metadata !2869, null}
!2869 = metadata !{i32 786443, metadata !898, metadata !2833, i32 957, i32 0, i32 204} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2870 = metadata !{i32 959, i32 0, metadata !2869, null}
!2871 = metadata !{i32 1041, i32 0, metadata !1312, null}
!2872 = metadata !{i32 1042, i32 0, metadata !2873, null}
!2873 = metadata !{i32 786443, metadata !898, metadata !1312, i32 1042, i32 0, i32 234} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2874 = metadata !{i32 1043, i32 0, metadata !2873, null}
!2875 = metadata !{i32 1046, i32 0, metadata !1257, null}
!2876 = metadata !{i32 64, i32 0, metadata !1520, metadata !2877}
!2877 = metadata !{i32 1049, i32 0, metadata !1313, null}
!2878 = metadata !{i32 65, i32 0, metadata !1519, metadata !2877}
!2879 = metadata !{i32 66, i32 0, metadata !2657, metadata !2877}
!2880 = metadata !{i32 1053, i32 0, metadata !2881, null}
!2881 = metadata !{i32 786443, metadata !898, metadata !1313, i32 1053, i32 0, i32 235} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2882 = metadata !{i32 1054, i32 0, metadata !2883, null}
!2883 = metadata !{i32 786443, metadata !898, metadata !2881, i32 1053, i32 0, i32 236} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2884 = metadata !{i32 1055, i32 0, metadata !2883, null}
!2885 = metadata !{i32 1067, i32 0, metadata !1326, null}
!2886 = metadata !{i32 1071, i32 0, metadata !2887, null}
!2887 = metadata !{i32 786443, metadata !898, metadata !1323, i32 1071, i32 0, i32 244} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2888 = metadata !{i32 1073, i32 0, metadata !1323, null}
!2889 = metadata !{i32 1096, i32 0, metadata !1328, null}
!2890 = metadata !{i32 1097, i32 0, metadata !2891, null}
!2891 = metadata !{i32 786443, metadata !898, metadata !1328, i32 1097, i32 0, i32 249} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd.c]
!2892 = metadata !{i32 1098, i32 0, metadata !2891, null}
!2893 = metadata !{i32 1101, i32 0, metadata !1313, null}
!2894 = metadata !{i32 68, i32 0, metadata !1561, null}
!2895 = metadata !{i32 71, i32 0, metadata !1560, null}
!2896 = metadata !{i32 72, i32 0, metadata !1560, null}
!2897 = metadata !{i32 73, i32 0, metadata !1560, null}
!2898 = metadata !{i32 74, i32 0, metadata !1560, null}
!2899 = metadata !{i32 76, i32 0, metadata !1551, null}
!2900 = metadata !{i32 133, i32 0, metadata !1669, null}
!2901 = metadata !{i32 134, i32 0, metadata !1669, null}
!2902 = metadata !{i32 42, i32 0, metadata !1751, metadata !2903}
!2903 = metadata !{i32 135, i32 0, metadata !1669, null}
!2904 = metadata !{metadata !2542, metadata !2542, i64 0}
!2905 = metadata !{i32 44, i32 0, metadata !1751, metadata !2903}
!2906 = metadata !{i32 45, i32 0, metadata !1751, metadata !2903}
!2907 = metadata !{metadata !2568, metadata !2542, i64 16}
!2908 = metadata !{metadata !2835, metadata !2542, i64 16}
!2909 = metadata !{i32 46, i32 0, metadata !1751, metadata !2903}
!2910 = metadata !{metadata !2835, metadata !2539, i64 28}
!2911 = metadata !{i32 47, i32 0, metadata !1751, metadata !2903}
!2912 = metadata !{metadata !2568, metadata !2539, i64 32}
!2913 = metadata !{metadata !2835, metadata !2539, i64 32}
!2914 = metadata !{i32 48, i32 0, metadata !1751, metadata !2903}
!2915 = metadata !{i32 50, i32 0, metadata !1751, metadata !2903}
!2916 = metadata !{metadata !2568, metadata !2542, i64 72}
!2917 = metadata !{metadata !2835, metadata !2542, i64 72}
!2918 = metadata !{i32 51, i32 0, metadata !1751, metadata !2903}
!2919 = metadata !{metadata !2568, metadata !2542, i64 88}
!2920 = metadata !{metadata !2835, metadata !2542, i64 88}
!2921 = metadata !{i32 52, i32 0, metadata !1751, metadata !2903}
!2922 = metadata !{metadata !2568, metadata !2542, i64 104}
!2923 = metadata !{metadata !2835, metadata !2542, i64 104}
!2924 = metadata !{i32 53, i32 0, metadata !1751, metadata !2903}
!2925 = metadata !{i32 56, i32 0, metadata !1751, metadata !2903}
!2926 = metadata !{metadata !2568, metadata !2542, i64 80}
!2927 = metadata !{metadata !2835, metadata !2542, i64 80}
!2928 = metadata !{i32 57, i32 0, metadata !1751, metadata !2903}
!2929 = metadata !{metadata !2568, metadata !2542, i64 96}
!2930 = metadata !{metadata !2835, metadata !2542, i64 96}
!2931 = metadata !{i32 58, i32 0, metadata !1751, metadata !2903} ; [ DW_TAG_imported_module ]
!2932 = metadata !{metadata !2568, metadata !2542, i64 112}
!2933 = metadata !{metadata !2835, metadata !2542, i64 112}
!2934 = metadata !{i32 137, i32 0, metadata !1669, null}
!2935 = metadata !{i32 78, i32 0, metadata !1801, null}
!2936 = metadata !{i32 114, i32 0, metadata !1910, null}
!2937 = metadata !{i32 115, i32 0, metadata !1910, null}
!2938 = metadata !{i32 504, i32 0, metadata !2939, metadata !2940}
!2939 = metadata !{i32 786443, metadata !1977, metadata !1976} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//usr/include/x86_64-linux-gnu/sys/stat.h]
!2940 = metadata !{i32 117, i32 0, metadata !1910, null}
!2941 = metadata !{i32 119, i32 0, metadata !1910, null}
!2942 = metadata !{i32 120, i32 0, metadata !1910, null}
!2943 = metadata !{i32 121, i32 0, metadata !2944, null}
!2944 = metadata !{i32 786443, metadata !1908, metadata !1910, i32 121, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd_init.c]
!2945 = metadata !{i32 122, i32 0, metadata !2946, null}
!2946 = metadata !{i32 786443, metadata !1908, metadata !2944, i32 121, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd_init.c]
!2947 = metadata !{i32 123, i32 0, metadata !2946, null}
!2948 = metadata !{i32 127, i32 0, metadata !2949, null}
!2949 = metadata !{i32 786443, metadata !1908, metadata !1910, i32 127, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd_init.c]
!2950 = metadata !{i32 128, i32 0, metadata !2951, null}
!2951 = metadata !{i32 786443, metadata !1908, metadata !2949, i32 127, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd_init.c]
!2952 = metadata !{metadata !2559, metadata !2543, i64 8}
!2953 = metadata !{i32 129, i32 0, metadata !2951, null}
!2954 = metadata !{i32 130, i32 0, metadata !2951, null}
!2955 = metadata !{i32 131, i32 0, metadata !2951, null}
!2956 = metadata !{i32 132, i32 0, metadata !2949, null}
!2957 = metadata !{i32 134, i32 0, metadata !1910, null}
!2958 = metadata !{i32 135, i32 0, metadata !2959, null}
!2959 = metadata !{i32 786443, metadata !1908, metadata !1910, i32 135, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd_init.c]
!2960 = metadata !{i32 136, i32 0, metadata !2961, null}
!2961 = metadata !{i32 786443, metadata !1908, metadata !2959, i32 135, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd_init.c]
!2962 = metadata !{i32 137, i32 0, metadata !2961, null}
!2963 = metadata !{i32 138, i32 0, metadata !2961, null}
!2964 = metadata !{metadata !2559, metadata !2543, i64 64}
!2965 = metadata !{i32 139, i32 0, metadata !2961, null}
!2966 = metadata !{metadata !2559, metadata !2543, i64 72}
!2967 = metadata !{i32 140, i32 0, metadata !2961, null}
!2968 = metadata !{metadata !2559, metadata !2543, i64 80}
!2969 = metadata !{i32 142, i32 0, metadata !2961, null}
!2970 = metadata !{i32 143, i32 0, metadata !2961, null}
!2971 = metadata !{i32 144, i32 0, metadata !2961, null}
!2972 = metadata !{i32 145, i32 0, metadata !2961, null}
!2973 = metadata !{i32 146, i32 0, metadata !2961, null}
!2974 = metadata !{i32 147, i32 0, metadata !2961, null}
!2975 = metadata !{i32 150, i32 0, metadata !2976, null}
!2976 = metadata !{i32 786443, metadata !1908, metadata !1910, i32 150, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd_init.c]
!2977 = metadata !{i32 151, i32 0, metadata !2978, null}
!2978 = metadata !{i32 786443, metadata !1908, metadata !2976, i32 150, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd_init.c]
!2979 = metadata !{i32 152, i32 0, metadata !2978, null}
!2980 = metadata !{i32 153, i32 0, metadata !2978, null}
!2981 = metadata !{i32 154, i32 0, metadata !2978, null}
!2982 = metadata !{i32 155, i32 0, metadata !2978, null}
!2983 = metadata !{i32 156, i32 0, metadata !2976, null}
!2984 = metadata !{i32 158, i32 0, metadata !1910, null}
!2985 = metadata !{i32 97, i32 0, metadata !1948, metadata !2986}
!2986 = metadata !{i32 159, i32 0, metadata !1910, null}
!2987 = metadata !{i32 99, i32 0, metadata !1948, metadata !2986}
!2988 = metadata !{i32 100, i32 0, metadata !1948, metadata !2986}
!2989 = metadata !{metadata !2601, metadata !2539, i64 772}
!2990 = metadata !{i32 160, i32 0, metadata !1910, null}
!2991 = metadata !{i32 161, i32 0, metadata !1910, null}
!2992 = metadata !{i32 48, i32 0, metadata !1954, null}
!2993 = metadata !{i32 50, i32 0, metadata !1954, null}
!2994 = metadata !{i32 51, i32 0, metadata !2995, null}
!2995 = metadata !{i32 786443, metadata !1908, metadata !1954, i32 51, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd_init.c]
!2996 = metadata !{i32 53, i32 0, metadata !1954, null}
!2997 = metadata !{i32 52, i32 0, metadata !2995, null}
!2998 = metadata !{i32 55, i32 0, metadata !1954, null}
!2999 = metadata !{i32 57, i32 0, metadata !1954, null}
!3000 = metadata !{i32 58, i32 0, metadata !1954, null} ; [ DW_TAG_imported_module ]
!3001 = metadata !{i32 59, i32 0, metadata !1954, null}
!3002 = metadata !{i32 61, i32 0, metadata !1954, null}
!3003 = metadata !{i32 64, i32 0, metadata !3004, null}
!3004 = metadata !{i32 786443, metadata !1908, metadata !1954, i32 64, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/fd_init.c]
!3005 = metadata !{i32 66, i32 0, metadata !3004, null}
!3006 = metadata !{i32 71, i32 0, metadata !1954, null}
!3007 = metadata !{i32 75, i32 0, metadata !1954, null}
!3008 = metadata !{metadata !2568, metadata !2542, i64 56}
!3009 = metadata !{i32 77, i32 0, metadata !1954, null}
!3010 = metadata !{i32 78, i32 0, metadata !1954, null}
!3011 = metadata !{metadata !2568, metadata !2542, i64 0}
!3012 = metadata !{i32 79, i32 0, metadata !1954, null}
!3013 = metadata !{metadata !2568, metadata !2542, i64 40}
!3014 = metadata !{i32 80, i32 0, metadata !1954, null}
!3015 = metadata !{i32 81, i32 0, metadata !1954, null}
!3016 = metadata !{i32 82, i32 0, metadata !1954, null}
!3017 = metadata !{i32 83, i32 0, metadata !1954, null}
!3018 = metadata !{i32 84, i32 0, metadata !1954, null}
!3019 = metadata !{i32 85, i32 0, metadata !1954, null}
!3020 = metadata !{metadata !2568, metadata !2539, i64 28}
!3021 = metadata !{i32 86, i32 0, metadata !1954, null}
!3022 = metadata !{i32 87, i32 0, metadata !1954, null}
!3023 = metadata !{i32 88, i32 0, metadata !1954, null}
!3024 = metadata !{i32 89, i32 0, metadata !1954, null}
!3025 = metadata !{i32 90, i32 0, metadata !1954, null}
!3026 = metadata !{i32 92, i32 0, metadata !1954, null}
!3027 = metadata !{metadata !2568, metadata !2542, i64 48}
!3028 = metadata !{i32 93, i32 0, metadata !1954, null}
!3029 = metadata !{metadata !2568, metadata !2542, i64 64}
!3030 = metadata !{i32 94, i32 0, metadata !1954, null}
!3031 = metadata !{i32 95, i32 0, metadata !1954, null}
!3032 = metadata !{i32 86, i32 0, metadata !2022, null}
!3033 = metadata !{i32 87, i32 0, metadata !2022, null}
!3034 = metadata !{metadata !2543, metadata !2543, i64 0}
!3035 = metadata !{i32 90, i32 0, metadata !2022, null}
!3036 = metadata !{i32 98, i32 0, metadata !2022, null}
!3037 = metadata !{i32 102, i32 0, metadata !2022, null}
!3038 = metadata !{i32 105, i32 0, metadata !3039, null}
!3039 = metadata !{i32 786443, metadata !2020, metadata !2022, i32 105, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3040 = metadata !{i32 54, i32 0, metadata !2108, metadata !3038}
!3041 = metadata !{i32 55, i32 0, metadata !3042, metadata !3038}
!3042 = metadata !{i32 786443, metadata !2020, metadata !3043, i32 55, i32 0, i32 39} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3043 = metadata !{i32 786443, metadata !2020, metadata !2108, i32 54, i32 0, i32 38} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3044 = metadata !{i32 57, i32 0, metadata !3043, metadata !3038}
!3045 = metadata !{i32 58, i32 0, metadata !3043, metadata !3038} ; [ DW_TAG_imported_module ]
!3046 = metadata !{i32 123, i32 0, metadata !2022, null}
!3047 = metadata !{i32 130, i32 0, metadata !2056, null}
!3048 = metadata !{i32 106, i32 0, metadata !3049, null}
!3049 = metadata !{i32 786443, metadata !2020, metadata !3039, i32 105, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3050 = metadata !{i32 124, i32 0, metadata !2057, null}
!3051 = metadata !{i32 54, i32 0, metadata !2108, metadata !3050}
!3052 = metadata !{i32 55, i32 0, metadata !3042, metadata !3050}
!3053 = metadata !{i32 57, i32 0, metadata !3043, metadata !3050}
!3054 = metadata !{i32 58, i32 0, metadata !3043, metadata !3050} ; [ DW_TAG_imported_module ]
!3055 = metadata !{i32 126, i32 0, metadata !3056, null}
!3056 = metadata !{i32 786443, metadata !2020, metadata !2056, i32 126, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3057 = metadata !{i32 127, i32 0, metadata !3056, null}
!3058 = metadata !{i32 129, i32 0, metadata !2056, null}
!3059 = metadata !{i32 34, i32 0, metadata !3060, metadata !3058}
!3060 = metadata !{i32 786443, metadata !2020, metadata !2095, i32 34, i32 0, i32 31} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3061 = metadata !{i32 36, i32 0, metadata !2095, metadata !3058}
!3062 = metadata !{i32 39, i32 0, metadata !3063, metadata !3058}
!3063 = metadata !{i32 786443, metadata !2020, metadata !3064, i32 39, i32 0, i32 35} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3064 = metadata !{i32 786443, metadata !2020, metadata !3065, i32 37, i32 0, i32 33} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3065 = metadata !{i32 786443, metadata !2020, metadata !2095, i32 36, i32 0, i32 32} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3066 = metadata !{i32 37, i32 0, metadata !3064, metadata !3058}
!3067 = metadata !{i32 40, i32 0, metadata !3068, metadata !3058}
!3068 = metadata !{i32 786443, metadata !2020, metadata !3063, i32 39, i32 0, i32 36} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3069 = metadata !{i32 42, i32 0, metadata !3070, metadata !3058}
!3070 = metadata !{i32 786443, metadata !2020, metadata !3063, i32 41, i32 0, i32 37} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3071 = metadata !{i32 132, i32 0, metadata !2056, null}
!3072 = metadata !{i32 77, i32 0, metadata !3073, metadata !3074}
!3073 = metadata !{i32 786443, metadata !2020, metadata !2087, i32 77, i32 0, i32 28} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3074 = metadata !{i32 131, i32 0, metadata !2056, null}
!3075 = metadata !{i32 78, i32 0, metadata !3076, metadata !3074}
!3076 = metadata !{i32 786443, metadata !2020, metadata !3073, i32 77, i32 0, i32 29} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3077 = metadata !{i32 80, i32 0, metadata !3078, metadata !3074}
!3078 = metadata !{i32 786443, metadata !2020, metadata !3073, i32 79, i32 0, i32 30} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3079 = metadata !{i32 81, i32 0, metadata !3078, metadata !3074}
!3080 = metadata !{i32 134, i32 0, metadata !2056, null}
!3081 = metadata !{i32 55, i32 0, metadata !3042, metadata !3082}
!3082 = metadata !{i32 135, i32 0, metadata !2061, null}
!3083 = metadata !{i32 57, i32 0, metadata !3043, metadata !3082}
!3084 = metadata !{i32 58, i32 0, metadata !3043, metadata !3082} ; [ DW_TAG_imported_module ]
!3085 = metadata !{i32 54, i32 0, metadata !2108, metadata !3082}
!3086 = metadata !{i32 139, i32 0, metadata !3087, null}
!3087 = metadata !{i32 786443, metadata !2020, metadata !2060, i32 139, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3088 = metadata !{i32 140, i32 0, metadata !3087, null}
!3089 = metadata !{i32 142, i32 0, metadata !2060, null}
!3090 = metadata !{i32 143, i32 0, metadata !2060, null}
!3091 = metadata !{i32 34, i32 0, metadata !3060, metadata !3090}
!3092 = metadata !{i32 36, i32 0, metadata !2095, metadata !3090}
!3093 = metadata !{i32 39, i32 0, metadata !3063, metadata !3090}
!3094 = metadata !{i32 37, i32 0, metadata !3064, metadata !3090}
!3095 = metadata !{i32 40, i32 0, metadata !3068, metadata !3090}
!3096 = metadata !{i32 42, i32 0, metadata !3070, metadata !3090}
!3097 = metadata !{i32 144, i32 0, metadata !2060, null}
!3098 = metadata !{i32 34, i32 0, metadata !3060, metadata !3097}
!3099 = metadata !{i32 36, i32 0, metadata !2095, metadata !3097}
!3100 = metadata !{i32 39, i32 0, metadata !3063, metadata !3097}
!3101 = metadata !{i32 37, i32 0, metadata !3064, metadata !3097}
!3102 = metadata !{i32 40, i32 0, metadata !3068, metadata !3097}
!3103 = metadata !{i32 42, i32 0, metadata !3070, metadata !3097}
!3104 = metadata !{i32 145, i32 0, metadata !2060, null}
!3105 = metadata !{i32 34, i32 0, metadata !3060, metadata !3104}
!3106 = metadata !{i32 36, i32 0, metadata !2095, metadata !3104}
!3107 = metadata !{i32 39, i32 0, metadata !3063, metadata !3104}
!3108 = metadata !{i32 37, i32 0, metadata !3064, metadata !3104}
!3109 = metadata !{i32 40, i32 0, metadata !3068, metadata !3104}
!3110 = metadata !{i32 42, i32 0, metadata !3070, metadata !3104}
!3111 = metadata !{i32 147, i32 0, metadata !2060, null}
!3112 = metadata !{i32 148, i32 0, metadata !3113, null}
!3113 = metadata !{i32 786443, metadata !2020, metadata !2060, i32 148, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3114 = metadata !{i32 149, i32 0, metadata !3115, null}
!3115 = metadata !{i32 786443, metadata !2020, metadata !3113, i32 148, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3116 = metadata !{i32 151, i32 0, metadata !3115, null}
!3117 = metadata !{i32 77, i32 0, metadata !3073, metadata !3118}
!3118 = metadata !{i32 150, i32 0, metadata !3115, null}
!3119 = metadata !{i32 78, i32 0, metadata !3076, metadata !3118}
!3120 = metadata !{i32 80, i32 0, metadata !3078, metadata !3118}
!3121 = metadata !{i32 81, i32 0, metadata !3078, metadata !3118}
!3122 = metadata !{i32 55, i32 0, metadata !3042, metadata !3123}
!3123 = metadata !{i32 155, i32 0, metadata !2064, null}
!3124 = metadata !{i32 57, i32 0, metadata !3043, metadata !3123}
!3125 = metadata !{i32 58, i32 0, metadata !3043, metadata !3123} ; [ DW_TAG_imported_module ]
!3126 = metadata !{i32 54, i32 0, metadata !2108, metadata !3123}
!3127 = metadata !{i32 158, i32 0, metadata !3128, null}
!3128 = metadata !{i32 786443, metadata !2020, metadata !2063, i32 158, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3129 = metadata !{i32 159, i32 0, metadata !3128, null}
!3130 = metadata !{i32 161, i32 0, metadata !2063, null}
!3131 = metadata !{i32 162, i32 0, metadata !2063, null}
!3132 = metadata !{i32 34, i32 0, metadata !3060, metadata !3131}
!3133 = metadata !{i32 36, i32 0, metadata !2095, metadata !3131}
!3134 = metadata !{i32 39, i32 0, metadata !3063, metadata !3131}
!3135 = metadata !{i32 37, i32 0, metadata !3064, metadata !3131}
!3136 = metadata !{i32 40, i32 0, metadata !3068, metadata !3131}
!3137 = metadata !{i32 42, i32 0, metadata !3070, metadata !3131}
!3138 = metadata !{i32 163, i32 0, metadata !2063, null}
!3139 = metadata !{i32 34, i32 0, metadata !3060, metadata !3138}
!3140 = metadata !{i32 36, i32 0, metadata !2095, metadata !3138}
!3141 = metadata !{i32 39, i32 0, metadata !3063, metadata !3138}
!3142 = metadata !{i32 37, i32 0, metadata !3064, metadata !3138}
!3143 = metadata !{i32 40, i32 0, metadata !3068, metadata !3138}
!3144 = metadata !{i32 42, i32 0, metadata !3070, metadata !3138}
!3145 = metadata !{i32 165, i32 0, metadata !2063, null}
!3146 = metadata !{i32 55, i32 0, metadata !3042, metadata !3147}
!3147 = metadata !{i32 165, i32 0, metadata !2067, null}
!3148 = metadata !{i32 57, i32 0, metadata !3043, metadata !3147}
!3149 = metadata !{i32 58, i32 0, metadata !3043, metadata !3147} ; [ DW_TAG_imported_module ]
!3150 = metadata !{i32 54, i32 0, metadata !2108, metadata !3147}
!3151 = metadata !{i32 55, i32 0, metadata !3042, metadata !3152}
!3152 = metadata !{i32 166, i32 0, metadata !2067, null}
!3153 = metadata !{i32 57, i32 0, metadata !3043, metadata !3152}
!3154 = metadata !{i32 58, i32 0, metadata !3043, metadata !3152} ; [ DW_TAG_imported_module ]
!3155 = metadata !{i32 54, i32 0, metadata !2108, metadata !3152}
!3156 = metadata !{i32 170, i32 0, metadata !3157, null}
!3157 = metadata !{i32 786443, metadata !2020, metadata !2066, i32 170, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3158 = metadata !{i32 171, i32 0, metadata !3157, null}
!3159 = metadata !{i32 173, i32 0, metadata !2066, null}
!3160 = metadata !{i32 34, i32 0, metadata !3060, metadata !3159}
!3161 = metadata !{i32 36, i32 0, metadata !2095, metadata !3159}
!3162 = metadata !{i32 39, i32 0, metadata !3063, metadata !3159}
!3163 = metadata !{i32 37, i32 0, metadata !3064, metadata !3159}
!3164 = metadata !{i32 40, i32 0, metadata !3068, metadata !3159}
!3165 = metadata !{i32 42, i32 0, metadata !3070, metadata !3159}
!3166 = metadata !{i32 174, i32 0, metadata !2066, null}
!3167 = metadata !{i32 55, i32 0, metadata !3042, metadata !3168}
!3168 = metadata !{i32 174, i32 0, metadata !2073, null}
!3169 = metadata !{i32 57, i32 0, metadata !3043, metadata !3168}
!3170 = metadata !{i32 58, i32 0, metadata !3043, metadata !3168} ; [ DW_TAG_imported_module ]
!3171 = metadata !{i32 54, i32 0, metadata !2108, metadata !3168}
!3172 = metadata !{i32 55, i32 0, metadata !3042, metadata !3173}
!3173 = metadata !{i32 175, i32 0, metadata !2073, null}
!3174 = metadata !{i32 57, i32 0, metadata !3043, metadata !3173}
!3175 = metadata !{i32 58, i32 0, metadata !3043, metadata !3173} ; [ DW_TAG_imported_module ]
!3176 = metadata !{i32 54, i32 0, metadata !2108, metadata !3173}
!3177 = metadata !{i32 177, i32 0, metadata !3178, null}
!3178 = metadata !{i32 786443, metadata !2020, metadata !2073, i32 175, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3179 = metadata !{i32 178, i32 0, metadata !3178, null}
!3180 = metadata !{i32 55, i32 0, metadata !3042, metadata !3181}
!3181 = metadata !{i32 179, i32 0, metadata !2072, null}
!3182 = metadata !{i32 57, i32 0, metadata !3043, metadata !3181}
!3183 = metadata !{i32 58, i32 0, metadata !3043, metadata !3181} ; [ DW_TAG_imported_module ]
!3184 = metadata !{i32 54, i32 0, metadata !2108, metadata !3181}
!3185 = metadata !{i32 181, i32 0, metadata !3186, null}
!3186 = metadata !{i32 786443, metadata !2020, metadata !2072, i32 179, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3187 = metadata !{i32 182, i32 0, metadata !3186, null}
!3188 = metadata !{i32 55, i32 0, metadata !3042, metadata !3189}
!3189 = metadata !{i32 183, i32 0, metadata !2071, null}
!3190 = metadata !{i32 57, i32 0, metadata !3043, metadata !3189}
!3191 = metadata !{i32 58, i32 0, metadata !3043, metadata !3189} ; [ DW_TAG_imported_module ]
!3192 = metadata !{i32 54, i32 0, metadata !2108, metadata !3189}
!3193 = metadata !{i32 185, i32 0, metadata !3194, null}
!3194 = metadata !{i32 786443, metadata !2020, metadata !2071, i32 183, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3195 = metadata !{i32 186, i32 0, metadata !3194, null}
!3196 = metadata !{i32 55, i32 0, metadata !3042, metadata !3197}
!3197 = metadata !{i32 187, i32 0, metadata !2070, null}
!3198 = metadata !{i32 57, i32 0, metadata !3043, metadata !3197}
!3199 = metadata !{i32 58, i32 0, metadata !3043, metadata !3197} ; [ DW_TAG_imported_module ]
!3200 = metadata !{i32 54, i32 0, metadata !2108, metadata !3197}
!3201 = metadata !{i32 189, i32 0, metadata !3202, null}
!3202 = metadata !{i32 786443, metadata !2020, metadata !2069, i32 189, i32 0, i32 25} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3203 = metadata !{i32 190, i32 0, metadata !3202, null}
!3204 = metadata !{i32 192, i32 0, metadata !2069, null}
!3205 = metadata !{i32 34, i32 0, metadata !3060, metadata !3204}
!3206 = metadata !{i32 36, i32 0, metadata !2095, metadata !3204}
!3207 = metadata !{i32 39, i32 0, metadata !3063, metadata !3204}
!3208 = metadata !{i32 37, i32 0, metadata !3064, metadata !3204}
!3209 = metadata !{i32 40, i32 0, metadata !3068, metadata !3204}
!3210 = metadata !{i32 42, i32 0, metadata !3070, metadata !3204}
!3211 = metadata !{i32 193, i32 0, metadata !2069, null}
!3212 = metadata !{i32 77, i32 0, metadata !3073, metadata !3213}
!3213 = metadata !{i32 196, i32 0, metadata !3214, null}
!3214 = metadata !{i32 786443, metadata !2020, metadata !2070, i32 194, i32 0, i32 26} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3215 = metadata !{i32 78, i32 0, metadata !3076, metadata !3213}
!3216 = metadata !{i32 80, i32 0, metadata !3078, metadata !3213}
!3217 = metadata !{i32 81, i32 0, metadata !3078, metadata !3213}
!3218 = metadata !{i32 200, i32 0, metadata !2022, null}
!3219 = metadata !{i32 201, i32 0, metadata !2022, null}
!3220 = metadata !{i32 202, i32 0, metadata !2022, null}
!3221 = metadata !{i32 203, i32 0, metadata !2022, null}
!3222 = metadata !{i32 205, i32 0, metadata !2022, null}
!3223 = metadata !{i32 206, i32 0, metadata !2022, null}
!3224 = metadata !{i32 208, i32 0, metadata !2022, null}
!3225 = metadata !{i32 210, i32 0, metadata !2022, null}
!3226 = metadata !{i32 24, i32 0, metadata !2103, null}
!3227 = metadata !{i32 65, i32 0, metadata !2074, null}
!3228 = metadata !{i32 66, i32 0, metadata !2074, null}
!3229 = metadata !{i32 67, i32 0, metadata !2074, null}
!3230 = metadata !{i32 69, i32 0, metadata !3231, null}
!3231 = metadata !{i32 786443, metadata !2020, metadata !2074, i32 69, i32 0, i32 27} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/POSIX//home/klee/klee_src/runtime/POSIX/klee_init_env.c]
!3232 = metadata !{i32 70, i32 0, metadata !3231, null}
!3233 = metadata !{i32 50, i32 0, metadata !2082, metadata !3232}
!3234 = metadata !{i32 72, i32 0, metadata !2074, null}
!3235 = metadata !{i32 73, i32 0, metadata !2074, null}
!3236 = metadata !{i32 13, i32 0, metadata !3237, null}
!3237 = metadata !{i32 786443, metadata !2113, metadata !2115, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_div_zero_check.c]
!3238 = metadata !{i32 14, i32 0, metadata !3237, null}
!3239 = metadata !{i32 15, i32 0, metadata !2115, null}
!3240 = metadata !{i32 15, i32 0, metadata !2125, null}
!3241 = metadata !{i32 16, i32 0, metadata !2125, null}
!3242 = metadata !{i32 21, i32 0, metadata !3243, null}
!3243 = metadata !{i32 786443, metadata !2131, metadata !2133, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_overshift_check.c]
!3244 = metadata !{i32 27, i32 0, metadata !3245, null}
!3245 = metadata !{i32 786443, metadata !2131, metadata !3243, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_overshift_check.c]
!3246 = metadata !{i32 29, i32 0, metadata !2133, null}
!3247 = metadata !{i32 16, i32 0, metadata !3248, null}
!3248 = metadata !{i32 786443, metadata !2141, metadata !2143, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!3249 = metadata !{i32 17, i32 0, metadata !3248, null}
!3250 = metadata !{i32 19, i32 0, metadata !3251, null}
!3251 = metadata !{i32 786443, metadata !2141, metadata !2143, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!3252 = metadata !{i32 22, i32 0, metadata !3253, null}
!3253 = metadata !{i32 786443, metadata !2141, metadata !3251, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!3254 = metadata !{i32 25, i32 0, metadata !3255, null}
!3255 = metadata !{i32 786443, metadata !2141, metadata !3253, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!3256 = metadata !{i32 26, i32 0, metadata !3257, null}
!3257 = metadata !{i32 786443, metadata !2141, metadata !3255, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!3258 = metadata !{i32 27, i32 0, metadata !3257, null}
!3259 = metadata !{i32 28, i32 0, metadata !3260, null}
!3260 = metadata !{i32 786443, metadata !2141, metadata !3255, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/klee_range.c]
!3261 = metadata !{i32 29, i32 0, metadata !3260, null}
!3262 = metadata !{i32 32, i32 0, metadata !3253, null}
!3263 = metadata !{i32 34, i32 0, metadata !2143, null}
!3264 = metadata !{i32 16, i32 0, metadata !2155, null}
!3265 = metadata !{i32 17, i32 0, metadata !2155, null}
!3266 = metadata !{metadata !3266, metadata !3267, metadata !3268}
!3267 = metadata !{metadata !"llvm.vectorizer.width", i32 1}
!3268 = metadata !{metadata !"llvm.vectorizer.unroll", i32 1}
!3269 = metadata !{metadata !3269, metadata !3267, metadata !3268}
!3270 = metadata !{i32 18, i32 0, metadata !2155, null}
!3271 = metadata !{i32 16, i32 0, metadata !3272, null}
!3272 = metadata !{i32 786443, metadata !2167, metadata !2169, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!3273 = metadata !{i32 19, i32 0, metadata !3274, null}
!3274 = metadata !{i32 786443, metadata !2167, metadata !2169, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!3275 = metadata !{i32 20, i32 0, metadata !3276, null}
!3276 = metadata !{i32 786443, metadata !2167, metadata !3274, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!3277 = metadata !{metadata !3277, metadata !3267, metadata !3268}
!3278 = metadata !{metadata !3278, metadata !3267, metadata !3268}
!3279 = metadata !{i32 22, i32 0, metadata !3280, null}
!3280 = metadata !{i32 786443, metadata !2167, metadata !3274, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/klee/klee_build/klee/runtime/Intrinsic//home/klee/klee_src/runtime/Intrinsic/memmove.c]
!3281 = metadata !{i32 24, i32 0, metadata !3280, null}
!3282 = metadata !{i32 23, i32 0, metadata !3280, null}
!3283 = metadata !{metadata !3283, metadata !3267, metadata !3268}
!3284 = metadata !{metadata !3284, metadata !3267, metadata !3268}
!3285 = metadata !{i32 28, i32 0, metadata !2169, null}
!3286 = metadata !{i32 15, i32 0, metadata !2183, null}
!3287 = metadata !{i32 16, i32 0, metadata !2183, null}
!3288 = metadata !{metadata !3288, metadata !3267, metadata !3268}
!3289 = metadata !{metadata !3289, metadata !3267, metadata !3268}
!3290 = metadata !{i32 17, i32 0, metadata !2183, null}
!3291 = metadata !{i32 13, i32 0, metadata !2197, null}
!3292 = metadata !{i32 14, i32 0, metadata !2197, null}
!3293 = metadata !{i32 15, i32 0, metadata !2197, null}
