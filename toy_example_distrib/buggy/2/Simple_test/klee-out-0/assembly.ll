...
define internal fastcc i32 @__user_main(i32 %argc, i8** %argv) #0 {
  ...
  %4 = getelementptr inbounds i8** %newArgv, i64 2, !dbg !2026
  %5 = load i8** %4, align 8, !dbg !2026
  %6 = load i8* %5, align 1, !dbg !2026
  %7 = sext i8 %6 to i32, !dbg !2026
  %8 = icmp sgt i8 %3, 10, !dbg !2027
  br i1 %8, label %9, label %13, !dbg !2027

; <label>:9                                       ; preds = %0
  %10 = sext i8 %3 to i32, !dbg !2025
  %int_cast_to_i64 = zext i32 %7 to i64
  tail call void @klee_div_zero_check(i64 %int_cast_to_i64) #10, !dbg !2029
  %11 = sdiv i32 %10, %7, !dbg !2029
  %12 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([7 x i8]* @.str, i64 0, i64 0), i32 %11) #10, !dbg !2029
